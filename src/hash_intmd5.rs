...
pub unsafe extern "C" fn MD5Init(mut mdContext: *mut MD5_CTX) {
    ...
    (*mdContext).i[0 as libc::c_int as usize] = (*mdContext).i[1 as libc::c_int as usize];
    /* Load magic initialization constants.
     */
    (*mdContext).buf[0 as libc::c_int as usize] = 0x67452301 as libc::c_int as UINT4;
    ...
    (*mdContext).buf[3 as libc::c_int as usize] = 0x10325476 as libc::c_int as UINT4;
}
...
pub unsafe extern "C" fn MD5Update(
    ...
    mdi = ((*mdContext).i[0 as libc::c_int as usize] >> 3 as libc::c_int
        & 0x3f as libc::c_int as libc::c_uint) as libc::c_int;
    /* update number of bits */
    if (*mdContext).i[0 as libc::c_int as usize].wrapping_add(inLen << 3 as libc::c_int)
    ...
    (*mdContext).i[0 as libc::c_int as usize] =
        ((*mdContext).i[0 as libc::c_int as usize] as libc::c_uint)
            .wrapping_add(inLen << 3 as libc::c_int) as UINT4 as UINT4;
    (*mdContext).i[1 as libc::c_int as usize] =
        ((*mdContext).i[1 as libc::c_int as usize] as libc::c_uint)
            .wrapping_add(inLen >> 29 as libc::c_int) as UINT4 as UINT4;
    loop {
        let fresh0 = inLen;
        ...
        if mdi == 0x40 as libc::c_int {
            ...
            while i < 16 as libc::c_int as libc::c_uint {
                in_0[i as usize] = ((*mdContext).in_0
                    [ii.wrapping_add(3 as libc::c_int as libc::c_uint) as usize]
                    as UINT4)
                    << 24 as libc::c_int
                    | ((*mdContext).in_0[ii.wrapping_add(2 as libc::c_int as libc::c_uint) as usize]
                        as UINT4)
                        << 16 as libc::c_int
                    | ((*mdContext).in_0[ii.wrapping_add(1 as libc::c_int as libc::c_uint) as usize]
                        as UINT4)
                        << 8 as libc::c_int
...
pub unsafe extern "C" fn MD5Final(mut mdContext: *mut MD5_CTX) {
    ...
    /* save number of bits */
    in_0[14 as libc::c_int as usize] = (*mdContext).i[0 as libc::c_int as usize];
    in_0[15 as libc::c_int as usize] = (*mdContext).i[1 as libc::c_int as usize];
    /* compute number of bytes mod 64 */
    mdi = ((*mdContext).i[0 as libc::c_int as usize] >> 3 as libc::c_int
        & 0x3f as libc::c_int as libc::c_uint) as libc::c_int;
    /* pad out to 56 mod 64 */
    padLen = if mdi < 56 as libc::c_int {
        (56 as libc::c_int) - mdi
    } else {
        (120 as libc::c_int) - mdi
    } as libc::c_uint;
    ...
    while i < 4 as libc::c_int as libc::c_uint {
        (*mdContext).digest[ii as usize] =
            ((*mdContext).buf[i as usize] & 0xff as libc::c_int as libc::c_uint) as libc::c_uchar;
        (*mdContext).digest[ii.wrapping_add(1 as libc::c_int as libc::c_uint) as usize] =
            ((*mdContext).buf[i as usize] >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
                as libc::c_uchar;
        (*mdContext).digest[ii.wrapping_add(2 as libc::c_int as libc::c_uint) as usize] =
            ((*mdContext).buf[i as usize] >> 16 as libc::c_int
                & 0xff as libc::c_int as libc::c_uint) as libc::c_uchar;
        (*mdContext).digest[ii.wrapping_add(3 as libc::c_int as libc::c_uint) as usize] =
 ...
 */
static mut ctx: MD5_CTX = MD5_CTX {
    i: [0; 2],
    buf: [0; 4],
    in_0: [0; 64],
    digest: [0; 16],
...
#[no_mangle]
pub unsafe extern "C" fn HSH_GetHashId(mut name: *const libc::c_char) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn HSH_Hash(
    mut id: libc::c_int,
    ...
    if !in2.is_null() {
        MD5Update(&mut ctx, in2, in2_len);
    }
    MD5Final(&mut ctx);
    out_len = if out_len < 16 as libc::c_int as libc::c_uint {
        out_len
    } else {
