...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn CPS_ParseNTPSourceAdd(
    ...
    while *line != 0 {
        ...
        line = CPS_SplitWord(line);
        n = 0 as libc::c_int;
        if strcasecmp(cmd, b"auto_offline\x00" as *const u8 as *const libc::c_char) == 0 {
            (*src).params.auto_offline = 1 as libc::c_int
        } else if strcasecmp(cmd, b"burst\x00" as *const u8 as *const libc::c_char) == 0 {
            (*src).params.burst = 1 as libc::c_int
        } else if strcasecmp(cmd, b"iburst\x00" as *const u8 as *const libc::c_char) == 0 {
            (*src).params.iburst = 1 as libc::c_int
        } else if strcasecmp(cmd, b"offline\x00" as *const u8 as *const libc::c_char) == 0 {
        ...
        } else if strcasecmp(cmd, b"key\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%u%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"asymmetry\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
        ...
        } else if strcasecmp(cmd, b"maxdelay\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%lf%n\x00" as *const u8 as *const libc::c_char,
        ...
        ) == 0
        {
            if sscanf(
                line,
                b"%lf%n\x00" as *const u8 as *const libc::c_char,
                &mut (*src).params.max_delay_ratio as *mut libc::c_double,
                &mut n as *mut libc::c_int,
            ) != 1 as libc::c_int
            {
                return 0 as libc::c_int;
            ...
            cmd,
            b"maxdelaydevratio\x00" as *const u8 as *const libc::c_char,
        ) == 0
        {
            if sscanf(
                line,
                b"%lf%n\x00" as *const u8 as *const libc::c_char,
                &mut (*src).params.max_delay_dev_ratio as *mut libc::c_double,
                &mut n as *mut libc::c_int,
            ) != 1 as libc::c_int
            {
                return 0 as libc::c_int;
            }
        } else if strcasecmp(cmd, b"maxpoll\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%d%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"maxsources\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%d%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"mindelay\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%lf%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"minpoll\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%d%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"minstratum\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%d%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"port\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%hu%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"polltarget\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%d%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"presend\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%d%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"version\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%d%n\x00" as *const u8 as *const libc::c_char,
        ...
        } else if strcasecmp(cmd, b"xleave\x00" as *const u8 as *const libc::c_char) == 0 {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn CPS_ParseLocal(
    mut line: *mut libc::c_char,
    ...
    *orphan = 0 as libc::c_int;
    while *line != 0 {
        cmd = line;
        line = CPS_SplitWord(line);
        if strcasecmp(cmd, b"stratum\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%d%n\x00" as *const u8 as *const libc::c_char,
                stratum,
        ...
        } else if strcasecmp(cmd, b"orphan\x00" as *const u8 as *const libc::c_char) == 0 {
            *orphan = 1 as libc::c_int;
            n = 0 as libc::c_int
        } else if strcasecmp(cmd, b"distance\x00" as *const u8 as *const libc::c_char) == 0 {
            if sscanf(
                line,
                b"%lf%n\x00" as *const u8 as *const libc::c_char,
                distance,
...
pub unsafe extern "C" fn CPS_NormalizeLine(mut line: *mut libc::c_char) {
    ...
    if q > line && *q.offset(-(1 as libc::c_int) as isize) as libc::c_int == ' ' as i32 {
        q = q.offset(-1)
    }
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn CPS_SplitWord(mut line: *mut libc::c_char) -> *mut libc::c_char {
    let mut p: *mut libc::c_char = line;
    let mut q: *mut libc::c_char = line;
    /* Skip white-space before the word */
    while *q as libc::c_int != 0
        && *(*__ctype_b_loc()).offset(*q as libc::c_uchar as libc::c_int as isize) as libc::c_int
            & _ISspace as libc::c_int as libc::c_ushort as libc::c_int
            != 0
    {
        q = q.offset(1)
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn CPS_ParseKey(
    mut line: *mut libc::c_char,
    mut id: *mut uint32_t,
    ...
    if *s2 == 0 || *s4 as libc::c_int != 0 {
        return 0 as libc::c_int;
    }
    if sscanf(s1, b"%u\x00" as *const u8 as *const libc::c_char, id) != 1 as libc::c_int {
        return 0 as libc::c_int;
    }
    if *s3 != 0 {
        *type_0 = s2;
