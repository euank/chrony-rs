...
extern "C" {
    ...
    #[no_mangle]
    fn getrandom(__buffer: *mut libc::c_void, __length: size_t, __flags: libc::c_uint) -> ssize_t;
    #[no_mangle]
    fn __assert_fail(
    ...
    **********************************************************************
    ...
    fn HSH_Hash(
        id: libc::c_int,
        in1: *const libc::c_uchar,
        in1_len: libc::c_uint,
        in2: *const libc::c_uchar,
        in2_len: libc::c_uint,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_IsZeroTimespec(mut ts: *mut timespec) -> libc::c_int {
    return ((*ts).tv_sec == 0 && (*ts).tv_nsec == 0) as libc::c_int;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_TimevalToTimespec(mut tv: *mut timeval, mut ts: *mut timespec) {
    (*ts).tv_sec = (*tv).tv_sec;
    (*ts).tv_nsec = 1000 as libc::c_int as libc::c_long * (*tv).tv_usec;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_TimespecToTimeval(mut ts: *mut timespec, mut tv: *mut timeval) {
    (*tv).tv_sec = (*ts).tv_sec;
    (*tv).tv_usec = (*ts).tv_nsec / 1000 as libc::c_int as libc::c_long;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_TimespecToDouble(mut ts: *mut timespec) -> libc::c_double {
    return (*ts).tv_sec as libc::c_double + 1.0e-9f64 * (*ts).tv_nsec as libc::c_double;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_DoubleToTimespec(mut d: libc::c_double, mut ts: *mut timespec) {
    (*ts).tv_sec = d as __time_t;
    (*ts).tv_nsec = (1.0e9f64 * (d - (*ts).tv_sec as libc::c_double)) as __syscall_slong_t;
...
pub unsafe extern "C" fn UTI_NormaliseTimespec(mut ts: *mut timespec) {
    ...
    {
        (*ts).tv_sec += (*ts).tv_nsec / 1000000000 as libc::c_int as libc::c_long;
        (*ts).tv_nsec = (*ts).tv_nsec % 1000000000 as libc::c_int as libc::c_long;
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_TimevalToDouble(mut tv: *mut timeval) -> libc::c_double {
    return (*tv).tv_sec as libc::c_double + 1.0e-6f64 * (*tv).tv_usec as libc::c_double;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_DoubleToTimeval(mut a: libc::c_double, mut b: *mut timeval) {
    let mut frac_part: libc::c_double = 0.;
    (*b).tv_sec = a as __time_t;
    frac_part = 1.0e6f64 * (a - (*b).tv_sec as libc::c_double);
    (*b).tv_usec = if frac_part > 0 as libc::c_int as libc::c_double {
        (frac_part) + 0.5f64
    } else {
        (frac_part) - 0.5f64
    } as __suseconds_t;
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_CompareTimespecs(
    mut a: *mut timespec,
    mut b: *mut timespec,
) -> libc::c_int {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_DiffTimespecs(
...
#[no_mangle]
pub unsafe extern "C" fn UTI_DiffTimespecsToDouble(
    mut a: *mut timespec,
    mut b: *mut timespec,
) -> libc::c_double {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_AddDoubleToTimespec(
    ...
    (*end).tv_nsec = ((*start).tv_nsec as libc::c_double
        + 1.0e9f64 * (increment - int_part as libc::c_double))
...
#[no_mangle]
pub unsafe extern "C" fn UTI_AverageDiffTimespecs(
    mut earlier: *mut timespec,
    mut later: *mut timespec,
    mut average: *mut timespec,
    mut diff: *mut libc::c_double,
) {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_AddDiffToTimespec(
    mut a: *mut timespec,
    mut b: *mut timespec,
    mut c: *mut timespec,
    mut result: *mut timespec,
...
#[no_mangle]
pub unsafe extern "C" fn UTI_TimespecToString(mut ts: *mut timespec) -> *mut libc::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn UTI_Ntp64ToString(mut ntp_ts: *mut NTP_int64) -> *mut libc::c_char {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_RefidToString(mut ref_id: uint32_t) -> *mut libc::c_char {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_IPToString(mut addr: *mut IPAddr) -> *mut libc::c_char {
    ...
    match (*addr).family as libc::c_int {
        ...
        1 => {
            ...
            a = ip >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_ulong;
            b = ip >> 16 as libc::c_int & 0xff as libc::c_int as libc::c_ulong;
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_StringToIP(
    ...
    ) > 0 as libc::c_int
    {
        ...
        (*ip)._pad = 0 as libc::c_int as uint16_t;
        memcpy(
            (*ip).addr.in6.as_mut_ptr() as *mut libc::c_void,
    ...
    match (*ip).family as libc::c_int {
        ...
        2 => {
            if MD5_hash < 0 as libc::c_int {
                MD5_hash = HSH_GetHashId(b"MD5\x00" as *const u8 as *const libc::c_char)
            }
            if MD5_hash < 0 as libc::c_int
                || HSH_Hash(
                    MD5_hash,
                    (*ip).addr.in6.as_mut_ptr() as *const libc::c_uchar,
                    ::std::mem::size_of::<[uint8_t; 16]>() as libc::c_ulong as libc::c_uint,
                    0 as *const libc::c_uchar,
                    0 as libc::c_int as libc::c_uint,
                    buf.as_mut_ptr(),
                    ::std::mem::size_of::<[libc::c_uchar; 16]>() as libc::c_ulong as libc::c_uint,
                ) as libc::c_ulong
                    != ::std::mem::size_of::<[libc::c_uchar; 16]>() as libc::c_ulong
            {
                LOG_Message(
                    LOGS_FATAL,
                    b"Could not get MD5\x00" as *const u8 as *const libc::c_char,
                );
                exit(1 as libc::c_int);
            }
            return (buf[0 as libc::c_int as usize] as uint32_t) << 24 as libc::c_int
                | ((buf[1 as libc::c_int as usize] as libc::c_int) << 16 as libc::c_int)
                    as libc::c_uint
...
pub unsafe extern "C" fn UTI_IPToHash(mut ip: *mut IPAddr) -> uint32_t {
    ...
    match (*ip).family as libc::c_int {
        1 => {
            ...
            len = ::std::mem::size_of::<uint32_t>() as libc::c_ulong as libc::c_uint
        }
        2 => {
            addr = (*ip).addr.in6.as_mut_ptr();
            len = ::std::mem::size_of::<[uint8_t; 16]>() as libc::c_ulong as libc::c_uint
        }
    ...
    while seed == 0 {
        UTI_GetRandomBytes(
            &mut seed as *mut uint32_t as *mut libc::c_void,
    ...
    hash = seed;
    while i < len {
        hash = (71 as libc::c_int as libc::c_uint)
            .wrapping_mul(hash)
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_IPHostToNetwork(mut src: *mut IPAddr, mut dest: *mut IPAddr) {
    ...
    match (*src).family as libc::c_int {
        ...
        2 => {
            memcpy(
                (*dest).addr.in6.as_mut_ptr() as *mut libc::c_void,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_IPNetworkToHost(mut src: *mut IPAddr, mut dest: *mut IPAddr) {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_CompareIPs(
    mut a: *mut IPAddr,
    mut b: *mut IPAddr,
    mut mask: *mut IPAddr,
) -> libc::c_int {
    ...
    if !mask.is_null() && (*mask).family as libc::c_int != (*b).family as libc::c_int {
    ...
    match (*a).family as libc::c_int {
        ...
        1 => {
            if !mask.is_null() {
                return ((*a).addr.in4 & (*mask).addr.in4)
                    .wrapping_sub((*b).addr.in4 & (*mask).addr.in4)
                    as libc::c_int;
            } else {
                return (*a).addr.in4.wrapping_sub((*b).addr.in4) as libc::c_int;
            }
        }
        2 => {
            i = 0 as libc::c_int;
            ...
            while d == 0 && i < 16 as libc::c_int {
                if !mask.is_null() {
                    d = ((*a).addr.in6[i as usize] as libc::c_int
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_IPSockAddrToString(mut sa: *mut IPSockAddr) -> *mut libc::c_char {
    let mut result: *mut libc::c_char = 0 as *mut libc::c_char;
    pool_ptr = (pool_ptr + 1 as libc::c_int) % 16 as libc::c_int;
    result = buffer_pool[pool_ptr as usize].as_mut_ptr();
    snprintf(
        ...
        UTI_IPToString(&mut (*sa).ip_addr),
        (*sa).port as libc::c_int,
    );
    return result;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_TimeToLogForm(mut t: time_t) -> *mut libc::c_char {
    ...
    if !stm.is_null() {
        ...
        snprintf(
            result,
            64 as libc::c_int as libc::c_ulong,
            b"INVALID    INVALID \x00" as *const u8 as *const libc::c_char,
        );
    }
    return result;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_AdjustTimespec(
    mut old_ts: *mut timespec,
    mut when: *mut timespec,
    mut new_ts: *mut timespec,
    mut delta_time: *mut libc::c_double,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_GetNtp64Fuzz(mut ts: *mut NTP_int64, mut precision: libc::c_int) {
    let mut start: libc::c_int = 0;
    let mut bits: libc::c_int = 0;
    if precision >= -(32 as libc::c_int) && precision <= 32 as libc::c_int {
    } else {
        __assert_fail(
            b"precision >= -32 && precision <= 32\x00" as *const u8 as *const libc::c_char,
            b"util.c\x00" as *const u8 as *const libc::c_char,
            547 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<&[u8; 40], &[libc::c_char; 40]>(
                b"void UTI_GetNtp64Fuzz(NTP_int64 *, int)\x00",
            ))
            .as_ptr(),
        );
    }
    if ::std::mem::size_of::<NTP_int64>() as libc::c_ulong == 8 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"sizeof (*ts) == 8\x00" as *const u8 as *const libc::c_char,
            b"util.c\x00" as *const u8 as *const libc::c_char,
    ...
    start = (::std::mem::size_of::<NTP_int64>() as libc::c_ulong).wrapping_sub(
        ((precision + 32 as libc::c_int + 7 as libc::c_int) / 8 as libc::c_int) as libc::c_ulong,
    ) as libc::c_int;
    (*ts).lo = 0 as libc::c_int as uint32_t;
    (*ts).hi = (*ts).lo;
    UTI_GetRandomBytes(
        (ts as *mut libc::c_uchar).offset(start as isize) as *mut libc::c_void,
        (::std::mem::size_of::<NTP_int64>() as libc::c_ulong).wrapping_sub(start as libc::c_ulong)
            as libc::c_uint,
    );
    bits = (precision + 32 as libc::c_int) % 8 as libc::c_int;
    if bits != 0 {
        let ref mut fresh1 = *(ts as *mut libc::c_uchar).offset(start as isize);
        *fresh1 = (*fresh1 as libc::c_uint).wrapping_rem((1 as libc::c_uint) << bits)
            as libc::c_uchar as libc::c_uchar
    };
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_Ntp32ToDouble(mut x: NTP_int32) -> libc::c_double {
    return ntohl(x) as libc::c_double / 65536.0f64;
}
#[no_mangle]
pub unsafe extern "C" fn UTI_DoubleToNtp32(mut x: libc::c_double) -> NTP_int32 {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_IsZeroNtp64(mut ts: *mut NTP_int64) -> libc::c_int {
    return ((*ts).hi == 0 && (*ts).lo == 0) as libc::c_int;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_CompareNtp64(
    mut a: *mut NTP_int64,
    mut b: *mut NTP_int64,
) -> libc::c_int {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_IsEqualAnyNtp64(
    mut a: *mut NTP_int64,
...
#[no_mangle]
pub unsafe extern "C" fn UTI_TimespecToNtp64(
    mut src: *mut timespec,
    ...
    if nsec == 0 && sec == 0 {
        ...
        hi = htonl((sec as libc::c_ulong).wrapping_add(0x83aa7e80 as libc::c_ulong) as uint32_t);
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_Ntp64ToTimespec(mut src: *mut NTP_int64, mut dest: *mut timespec) {
    let mut ntp_sec: uint32_t = 0;
    let mut ntp_frac: uint32_t = 0;
    /* Zero is a special value */
    if UTI_IsZeroNtp64(src) != 0 {
        UTI_ZeroTimespec(dest);
        return;
    }
    ntp_sec = ntohl((*src).hi);
    ntp_frac = ntohl((*src).lo);
    (*dest).tv_sec = ntp_sec.wrapping_sub(
        ((1581921726 as libc::c_longlong
            - (18250 as libc::c_int * 24 as libc::c_int * 3600 as libc::c_int) as libc::c_longlong)
            as libc::c_ulonglong)
            .wrapping_add(0x83aa7e80 as libc::c_ulong as libc::c_ulonglong) as uint32_t,
    ) as libc::c_long
        + (1581921726 as libc::c_longlong
            - (18250 as libc::c_int * 24 as libc::c_int * 3600 as libc::c_int) as libc::c_longlong)
            as time_t;
    (*dest).tv_nsec = (ntp_frac as libc::c_double / 4.294967296f64) as __syscall_slong_t;
}
/* Minimum allowed distance from maximum 32-bit time_t */
#[no_mangle]
pub unsafe extern "C" fn UTI_IsTimeOffsetSane(
    mut ts: *mut timespec,
    ...
    if t < (1581921726 as libc::c_longlong
        - (18250 as libc::c_int * 24 as libc::c_int * 3600 as libc::c_int) as libc::c_longlong)
        as libc::c_double
        || t > (1581921726 as libc::c_longlong
            - (18250 as libc::c_int * 24 as libc::c_int * 3600 as libc::c_int) as libc::c_longlong
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_Log2ToDouble(mut l: libc::c_int) -> libc::c_double {
    if l >= 0 as libc::c_int {
        if l > 31 as libc::c_int {
            l = 31 as libc::c_int
        }
        ...
        return 1.0f64 / ((1 as libc::c_int as uint32_t) << -l) as libc::c_double;
    };
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_TimespecNetworkToHost(
    mut src: *mut Timespec,
    ...
    (*dest).tv_sec =
        ((sec_high as uint64_t) << 32 as libc::c_int | sec_low as libc::c_ulong) as __time_t;
    nsec = ntohl((*src).tv_nsec);
    (*dest).tv_nsec = if nsec < 999999999 as libc::c_uint {
        nsec
    } else {
        999999999 as libc::c_uint
    } as __syscall_slong_t;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_TimespecHostToNetwork(
    mut src: *mut timespec,
    mut dest: *mut Timespec,
) {
    (*dest).tv_nsec = htonl((*src).tv_nsec as uint32_t);
    (*dest).tv_sec_high = htonl(((*src).tv_sec as uint64_t >> 32 as libc::c_int) as uint32_t);
    (*dest).tv_sec_low = htonl((*src).tv_sec as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn UTI_FloatNetworkToHost(mut f: Float) -> libc::c_double {
    let mut exp: int32_t = 0;
    let mut coef: int32_t = 0;
    let mut x: uint32_t = 0;
    x = ntohl(f.f as uint32_t);
    exp = (x
        >> ::std::mem::size_of::<int32_t>() as libc::c_ulong as libc::c_int * 8 as libc::c_int
            - 7 as libc::c_int) as int32_t;
    if exp >= (1 as libc::c_int) << 7 as libc::c_int - 1 as libc::c_int {
        exp -= (1 as libc::c_int) << 7 as libc::c_int
    }
    exp -= ::std::mem::size_of::<int32_t>() as libc::c_ulong as libc::c_int * 8 as libc::c_int
        - 7 as libc::c_int;
    coef = x.wrapping_rem(
        (1 as libc::c_uint)
            << ::std::mem::size_of::<int32_t>() as libc::c_ulong as libc::c_int * 8 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn UTI_FloatHostToNetwork(mut x: libc::c_double) -> Float {
    let mut exp: int32_t = 0;
    let mut coef: int32_t = 0;
    ...
    if x < 1.0e-100f64 {
        ...
        exp = --((1 as libc::c_int) << 7 as libc::c_int - 1 as libc::c_int) - 1 as libc::c_int;
        coef = --((1 as libc::c_int)
            << ::std::mem::size_of::<int32_t>() as libc::c_ulong as libc::c_int * 8 as libc::c_int
                - 7 as libc::c_int
                - 1 as libc::c_int)
        ...
        exp = (log(x) / log(2 as libc::c_int as libc::c_double)
        ...
        if coef > 0 as libc::c_int {
            ...
            __assert_fail(
                b"coef > 0\x00" as *const u8 as *const libc::c_char,
                b"util.c\x00" as *const u8 as *const libc::c_char,
                852 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 37], &[libc::c_char; 37]>(
                    b"Float UTI_FloatHostToNetwork(double)\x00",
                ))
                .as_ptr(),
            );
        }
        ...
        if exp > --((1 as libc::c_int) << 7 as libc::c_int - 1 as libc::c_int) - 1 as libc::c_int {
            /* overflow */
            exp = --((1 as libc::c_int) << 7 as libc::c_int - 1 as libc::c_int) - 1 as libc::c_int;
            coef = --((1 as libc::c_int)
                << ::std::mem::size_of::<int32_t>() as libc::c_ulong as libc::c_int
                ...
                - 1 as libc::c_int
                + neg
        } else if exp < -((1 as libc::c_int) << 7 as libc::c_int - 1 as libc::c_int) {
            /* underflow */
            if exp
                + (::std::mem::size_of::<int32_t>() as libc::c_ulong as libc::c_int
                    * 8 as libc::c_int
            ...
            {
                coef >>= -((1 as libc::c_int) << 7 as libc::c_int - 1 as libc::c_int) - exp;
                exp = -((1 as libc::c_int) << 7 as libc::c_int - 1 as libc::c_int)
            } else {
                coef = 0 as libc::c_int;
                exp = coef
            }
    ...
    /* negate back */
    if neg != 0 {
        coef = ((-coef as uint32_t) << 7 as libc::c_int >> 7 as libc::c_int) as int32_t
    }
    f.f = htonl(
        (exp as uint32_t)
            << ::std::mem::size_of::<int32_t>() as libc::c_ulong as libc::c_int * 8 as libc::c_int
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_FdSetCloexec(mut fd: libc::c_int) -> libc::c_int {
    ...
    if flags == -(1 as libc::c_int) {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"fcntl() failed : %s\x00" as *const u8 as *const libc::c_char,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_SetQuitSignalsHandler(
    mut handler: Option<unsafe extern "C" fn(_: libc::c_int) -> ()>,
    mut ignore_sigpipe: libc::c_int,
) {
    ...
    if sigemptyset(&mut sa.sa_mask) < 0 as libc::c_int {
        LOG_Message(
            LOGS_FATAL,
            b"sigemptyset() failed\x00" as *const u8 as *const libc::c_char,
        );
        exit(1 as libc::c_int);
    }
    if sigaction(2 as libc::c_int, &mut sa, 0 as *mut sigaction) < 0 as libc::c_int {
        LOG_Message(
            LOGS_FATAL,
            b"sigaction(%d) failed\x00" as *const u8 as *const libc::c_char,
            2 as libc::c_int,
        );
        exit(1 as libc::c_int);
    }
    if sigaction(15 as libc::c_int, &mut sa, 0 as *mut sigaction) < 0 as libc::c_int {
        LOG_Message(
            LOGS_FATAL,
            b"sigaction(%d) failed\x00" as *const u8 as *const libc::c_char,
            15 as libc::c_int,
    ...
    if sigaction(3 as libc::c_int, &mut sa, 0 as *mut sigaction) < 0 as libc::c_int {
        LOG_Message(
            LOGS_FATAL,
            b"sigaction(%d) failed\x00" as *const u8 as *const libc::c_char,
            3 as libc::c_int,
    ...
    if sigaction(1 as libc::c_int, &mut sa, 0 as *mut sigaction) < 0 as libc::c_int {
        LOG_Message(
            LOGS_FATAL,
            b"sigaction(%d) failed\x00" as *const u8 as *const libc::c_char,
            1 as libc::c_int,
    ...
    if sigaction(13 as libc::c_int, &mut sa, 0 as *mut sigaction) < 0 as libc::c_int {
        LOG_Message(
            LOGS_FATAL,
            b"sigaction(%d) failed\x00" as *const u8 as *const libc::c_char,
            13 as libc::c_int,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_PathToDir(mut path: *const libc::c_char) -> *mut libc::c_char {
    ...
    dir = Malloc(
        (slash.wrapping_offset_from(path) as libc::c_long + 1 as libc::c_int as libc::c_long)
            as size_t,
    ) as *mut libc::c_char;
    snprintf(
        dir,
...
unsafe extern "C" fn create_dir(
    ...
    if status < 0 as libc::c_int {
        if *__errno_location() != 2 as libc::c_int {
            LOG_Message(
                LOGS_ERR,
                b"Could not access %s : %s\x00" as *const u8 as *const libc::c_char,
                p,
                strerror(*__errno_location()),
            );
            return 0 as libc::c_int;
        ...
        LOG_Message(
            LOGS_ERR,
            b"%s is not directory\x00" as *const u8 as *const libc::c_char,
            p,
        );
        return 0 as libc::c_int;
    }
    ...
    if mkdir(p, mode) < 0 as libc::c_int {
        LOG_Message(
            LOGS_ERR,
            b"Could not create directory %s : %s\x00" as *const u8 as *const libc::c_char,
            p,
            strerror(*__errno_location()),
        );
        return 0 as libc::c_int;
    ...
    if chown(p, uid, gid) < 0 as libc::c_int {
        LOG_Message(
            LOGS_ERR,
            b"Could not change ownership of %s : %s\x00" as *const u8 as *const libc::c_char,
            p,
            strerror(*__errno_location()),
        );
...
already existed) */
#[no_mangle]
pub unsafe extern "C" fn UTI_CreateDirAndParents(
    ...
    p = Malloc((1 as libc::c_int as libc::c_ulong).wrapping_add(strlen(path))) as *mut libc::c_char;
    k = 0 as libc::c_int;
    i = k;
    loop {
        let fresh2 = k;
        ...
        *p.offset(fresh3 as isize) = *path.offset(fresh2 as isize);
        if *path.offset(k as isize) as libc::c_int == '/' as i32 || *path.offset(k as isize) == 0 {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_CheckDirPermissions(
    mut path: *const libc::c_char,
    mut perm: mode_t,
    mut uid: uid_t,
    mut gid: gid_t,
    ...
    if buf.st_mode & 0o777 as libc::c_int as libc::c_uint & !perm != 0 {
        LOG_Message(
            LOGS_ERR,
            b"Wrong permissions on %s\x00" as *const u8 as *const libc::c_char,
            path,
        );
        return 0 as libc::c_int;
    }
    if buf.st_uid != uid {
        LOG_Message(
            LOGS_ERR,
            b"Wrong owner of %s (%s != %u)\x00" as *const u8 as *const libc::c_char,
            path,
...
unsafe extern "C" fn join_path(
        ...
        >= length
    {
        LOG_Message(
            severity,
            b"File path %s%s%s%s too long\x00" as *const u8 as *const libc::c_char,
            basedir,
            sep,
            name,
            suffix,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_OpenFile(
    mut basedir: *const libc::c_char,
    mut name: *const libc::c_char,
    mut suffix: *const libc::c_char,
    ...
    severity = if mode as libc::c_int >= 'A' as i32 && mode as libc::c_int <= 'Z' as i32 {
    ...
    match mode as libc::c_int {
        ...
        119 | 87 => {
            flags = 0o1 as libc::c_int | 0o100 as libc::c_int | 0o200 as libc::c_int;
            file_mode = b"w\x00" as *const u8 as *const libc::c_char
        }
        97 | 65 => {
            flags = 0o1 as libc::c_int | 0o100 as libc::c_int | 0o2000 as libc::c_int;
        ...
        if fd < 0 as libc::c_int {
            if *__errno_location() == 17 as libc::c_int {
                if unlink(path.as_mut_ptr()) < 0 as libc::c_int {
                    LOG_Message(
                        severity,
                        b"Could not remove %s : %s\x00" as *const u8 as *const libc::c_char,
                        path.as_mut_ptr(),
                        strerror(*__errno_location()),
                    );
                    return 0 as *mut FILE;
            ...
            if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
            {
                LOG_Message(
                    LOGS_DEBUG,
                    b"Opened %s fd=%d mode=%c\x00" as *const u8 as *const libc::c_char,
                    path.as_mut_ptr(),
                    fd,
                    mode as libc::c_int,
                );
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_RenameTempFile(
    mut basedir: *const libc::c_char,
    mut name: *const libc::c_char,
    mut old_suffix: *const libc::c_char,
    mut new_suffix: *const libc::c_char,
) -> libc::c_int {
    ...
    {
        if rename(old_path.as_mut_ptr(), new_path.as_mut_ptr()) < 0 as libc::c_int {
            LOG_Message(
                LOGS_ERR,
                b"Could not replace %s with %s : %s\x00" as *const u8 as *const libc::c_char,
                new_path.as_mut_ptr(),
                old_path.as_mut_ptr(),
                strerror(*__errno_location()),
            );
            ...
            if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
            {
                LOG_Message(
                    LOGS_DEBUG,
                    b"Renamed %s to %s\x00" as *const u8 as *const libc::c_char,
                    old_path.as_mut_ptr(),
                    new_path.as_mut_ptr(),
                );
            }
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_RemoveFile(
    mut basedir: *const libc::c_char,
    mut name: *const libc::c_char,
    mut suffix: *const libc::c_char,
) -> libc::c_int {
...
pub fn drop_root(uid: u32, gid: u32) -> Result<(), anyhow::Error> {
    nix::unistd::setgroups(&[nix::unistd::Gid::from_raw(0)]).context("setgroups() failed")?;
...
#[no_mangle]
pub unsafe extern "C" fn UTI_GetRandomBytesUrandom(
...
/* ================================================== */
unsafe extern "C" fn get_random_bytes_getrandom(mut buf: *mut libc::c_char, mut len: libc::c_uint) {
    ...
    while i < len {
        if available == 0 {
                ...
                != ::std::mem::size_of::<[libc::c_char; 256]>() as libc::c_ulong
            {
                ...
                available =
                    ::std::mem::size_of::<[libc::c_char; 256]>() as libc::c_ulong as libc::c_uint
            }
        }
    ...
    if i < len {
        UTI_GetRandomBytesUrandom(buf as *mut libc::c_void, len);
    };
}
/*
 chronyd/chronyc - Programs for keeping computer clocks accurate.
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn UTI_GetRandomBytes(mut buf: *mut libc::c_void, mut len: libc::c_uint) {
