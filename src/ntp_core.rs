...
extern "C" {
    ...
    **********************************************************************
    ...
    time. */
    #[no_mangle]
    fn SST_GetFrequencyRange(inst: SST_Stats, lo: *mut libc::c_double, hi: *mut libc::c_double);
    /* Predict the offset of the local clock relative to a given source at
    a given local cooked time. Positive indicates local clock is FAST
    relative to reference. */
    #[no_mangle]
    fn SST_PredictOffset(inst: SST_Stats, when: *mut timespec) -> libc::c_double;
    ...
    #[no_mangle]
    fn SRC_SetRefid(instance: SRC_Instance, ref_id: uint32_t, addr: *mut IPAddr);
    ...
    #[no_mangle]
    fn NIO_OpenClientSocket(remote_addr: *mut NTP_Remote_Address) -> libc::c_int;
    /* Function to obtain a socket for sending server/peer packets */
    #[no_mangle]
    fn NIO_OpenServerSocket(remote_addr: *mut NTP_Remote_Address) -> libc::c_int;
    ...
    #[no_mangle]
    fn NIO_IsServerConnectable(remote_addr: *mut NTP_Remote_Address) -> libc::c_int;
    /* Function to transmit a packet */
    #[no_mangle]
    fn NIO_SendPacket(
        packet: *mut NTP_Packet,
        remote_addr: *mut NTP_Remote_Address,
        local_addr: *mut NTP_Local_Address,
        length: libc::c_int,
        process_tx: libc::c_int,
    ) -> libc::c_int;
    ...
    **********************************************************************
    ...
    #[no_mangle]
    fn UTI_AverageDiffTimespecs(
        earlier: *mut timespec,
        later: *mut timespec,
    ...
    #[no_mangle]
    fn UTI_TimespecToNtp64(src: *mut timespec, dest: *mut NTP_int64, fuzz: *mut NTP_int64);
    ...
    #[no_mangle]
    fn ADF_IsAnyAllowed(table: ADF_AuthTable, family: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn CLG_GetClientIndex(client: *mut IPAddr) -> libc::c_int;
    #[no_mangle]
    fn CLG_LogNTPAccess(client: *mut IPAddr, now: *mut timespec) -> libc::c_int;
    #[no_mangle]
    fn CLG_LimitNTPResponseRate(index: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn CLG_GetNtpTimestamps(
        index: libc::c_int,
        rx_ts: *mut *mut NTP_int64,
...
unsafe extern "C" fn do_size_checks() {
    ...
    if ::std::mem::size_of::<NTP_int32>() as libc::c_ulong == 4 as libc::c_int as libc::c_ulong {
    } else {
        __assert_fail(
            b"sizeof(NTP_int32) == 4\x00" as *const u8 as *const libc::c_char,
    ...
    if ::std::mem::size_of::<NTP_int64>() as libc::c_ulong == 8 as libc::c_int as libc::c_ulong {
    } else {
        __assert_fail(
            b"sizeof(NTP_int64) == 8\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 0 as libc::c_ulong == 0 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, lvm) == 0\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 1 as libc::c_ulong == 1 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, stratum) == 1\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 2 as libc::c_ulong == 2 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, poll) == 2\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 3 as libc::c_ulong == 3 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, precision) == 3\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 4 as libc::c_ulong == 4 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, root_delay) == 4\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 8 as libc::c_ulong == 8 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, root_dispersion) == 8\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 12 as libc::c_ulong == 12 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, reference_id) == 12\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 16 as libc::c_ulong == 16 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, reference_ts) == 16\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 24 as libc::c_ulong == 24 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, originate_ts) == 24\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 32 as libc::c_ulong == 32 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, receive_ts) == 32\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 40 as libc::c_ulong == 40 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(
            b"offsetof(NTP_Packet, transmit_ts) == 40\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn do_time_checks() {
    ...
    let mut warning_advance: time_t =
        (3600 as libc::c_int * 24 as libc::c_int * 365 as libc::c_int * 10 as libc::c_int)
            as time_t;
    /* Check that time before NTP_ERA_SPLIT underflows correctly */
    let mut ts1: timespec = {
        let mut init = timespec {
            tv_sec: (1581921726 as libc::c_longlong
                - (18250 as libc::c_int * 24 as libc::c_int * 3600 as libc::c_int)
                    as libc::c_longlong) as __time_t,
    ...
    let mut ts2: timespec = {
        let mut init = timespec {
            tv_sec: (1581921726 as libc::c_longlong
                - (18250 as libc::c_int * 24 as libc::c_int * 3600 as libc::c_int)
                    as libc::c_longlong
                - 1 as libc::c_int as libc::c_longlong) as __time_t,
            tv_nsec: 1 as libc::c_int as __syscall_slong_t,
        };
        init
    };
    ...
    r = (ts1.tv_sec as libc::c_longlong
        == 1581921726 as libc::c_longlong
            - (18250 as libc::c_int * 24 as libc::c_int * 3600 as libc::c_int) as libc::c_longlong
        && (ts1.tv_sec as libc::c_ulonglong)
    ...
    if r != 0 {
        ...
        __assert_fail(
            ...
            (*::std::mem::transmute::<&[u8; 26], &[libc::c_char; 26]>(
                b"void do_time_checks(void)\x00",
            ))
            .as_ptr(),
        );
    }
    ...
    if ts2.tv_sec - now.tv_sec < warning_advance {
        LOG_Message(
            LOGS_WARN,
            b"Assumed NTP time ends at %s!\x00" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn NCR_Initialise() {
    do_size_checks();
    do_time_checks();
    logfileid = if CNF_GetLogMeasurements(&mut log_raw_measurements) != 0 {
    ...
    broadcasts = ARR_CreateInstance(
        ::std::mem::size_of::<BroadcastDestination>() as libc::c_ulong as libc::c_uint,
    );
...
pub unsafe extern "C" fn NCR_Finalise() {
    ...
    while i < ARR_GetSize(broadcasts) {
        NIO_CloseServerSocket(
            (*(ARR_GetElement(broadcasts, i) as *mut BroadcastDestination))
                .local_addr
                .sock_fd,
        );
        i = i.wrapping_add(1)
...
/* ================================================== */
unsafe extern "C" fn restart_timeout(mut inst: NCR_Instance, mut delay: libc::c_double) {
    /* Check if we can transmit */
    if (*inst).tx_suspended != 0 {
        if (*inst).tx_timeout_id == 0 {
        } else {
            __assert_fail(
                b"!inst->tx_timeout_id\x00" as *const u8 as *const libc::c_char,
                b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
                432 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 43], &[libc::c_char; 43]>(
                    b"void restart_timeout(NCR_Instance, double)\x00",
                ))
                .as_ptr(),
            );
        }
    ...
    (*inst).tx_timeout_id = SCH_AddTimeoutInClass(
        delay,
        get_separation((*inst).local_poll),
        0.02f64,
        if (*inst).mode as libc::c_uint == MODE_CLIENT as libc::c_int as libc::c_uint {
            SCH_NtpClientClass as libc::c_int
        } else {
            SCH_NtpPeerClass as libc::c_int
        } as SCH_TimeoutClass,
        Some(transmit_timeout as unsafe extern "C" fn(_: *mut libc::c_void) -> ()),
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_GetInstance(
    ...
    result = Malloc(::std::mem::size_of::<NCR_Instance_Record>() as libc::c_ulong)
    ...
    if (*result).presend_minpoll <= 24 as libc::c_int
        && (*result).mode as libc::c_uint != MODE_CLIENT as libc::c_int as libc::c_uint
    {
        (*result).presend_minpoll = 24 as libc::c_int + 1 as libc::c_int
    }
    (*result).max_delay = if 0.0f64
    ...
    (*result).max_delay_ratio = if 0.0f64
    ...
    (*result).max_delay_dev_ratio = if 0.0f64
    ...
    if (*params).authkey == 0 as libc::c_int as libc::c_uint {
        ...
        if KEY_KeyKnown((*result).auth_key_id) == 0 {
            LOG_Message(
                LOGS_WARN,
                b"Key %u used by source %s is %s\x00" as *const u8 as *const libc::c_char,
                (*result).auth_key_id,
    ...
    if (*params).version != 0 {
        (*result).version = if 1 as libc::c_int
    ...
    (*result).source = SRC_CreateNewInstance(
        UTI_IPToRefid(&mut (*remote_addr).ip_addr),
        SRC_NTP,
        (*params).sel_options,
    ...
    if (*params).filter_length >= 1 as libc::c_int {
        (*result).filter = SPF_CreateInstance(
        ...
        (*result).filter = 0 as SPF_Instance
    }
    ...
    (*result).opmode = if (*params).connectivity as libc::c_uint
        == SRC_ONLINE as libc::c_int as libc::c_uint
        || (*params).connectivity as libc::c_uint == SRC_MAYBE_ONLINE as libc::c_int as libc::c_uint
            && NIO_IsServerConnectable(remote_addr) != 0
    {
        MD_ONLINE as libc::c_int
    } else {
        MD_OFFLINE as libc::c_int
    } as OperatingMode;
    ...
    memset(
        &mut (*result).report as *mut RPT_NTPReport as *mut libc::c_void,
        0 as libc::c_int,
...
pub unsafe extern "C" fn NCR_DestroyInstance(mut instance: NCR_Instance) {
    if (*instance).opmode as libc::c_uint != MD_OFFLINE as libc::c_int as libc::c_uint {
        take_offline(instance);
    }
    if (*instance).mode as libc::c_uint == MODE_ACTIVE as libc::c_int as libc::c_uint {
...
pub unsafe extern "C" fn NCR_ResetPoll(mut instance: NCR_Instance) {
    if (*instance).local_poll != (*instance).minpoll {
        ...
        if (*instance).tx_timeout_id != 0 {
            restart_timeout(
                instance,
                get_transmit_delay(instance, 0 as libc::c_int, 0.0f64),
            );
        }
    };
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ChangeRemoteAddress(
    mut inst: NCR_Instance,
    mut remote_addr: *mut NTP_Remote_Address,
) {
    memset(
        &mut (*inst).report as *mut RPT_NTPReport as *mut libc::c_void,
        0 as libc::c_int,
        ::std::mem::size_of::<RPT_NTPReport>() as libc::c_ulong,
    );
    NCR_ResetInstance(inst);
...
/* ================================================== */
unsafe extern "C" fn adjust_poll(mut inst: NCR_Instance, mut adj: libc::c_double) {
    (*inst).poll_score += adj;
    if (*inst).poll_score >= 1.0f64 {
        (*inst).local_poll += (*inst).poll_score as libc::c_int;
        (*inst).poll_score -= (*inst).poll_score as libc::c_int as libc::c_double
    }
    if (*inst).poll_score < 0.0f64 {
        (*inst).local_poll += ((*inst).poll_score - 1.0f64) as libc::c_int;
        (*inst).poll_score -= ((*inst).poll_score - 1.0f64) as libc::c_int as libc::c_double
    }
    ...
    if (*inst).local_poll < 0 as libc::c_int
        && (SRC_IsReachable((*inst).source) == 0
            || SST_MinRoundTripDelay(SRC_GetSourcestats((*inst).source)) > 0.01f64)
    {
        (*inst).local_poll = 0 as libc::c_int
    };
}
/* ================================================== */
unsafe extern "C" fn get_poll_adj(
    mut inst: NCR_Instance,
    ...
    if error_in_estimate > peer_distance {
        ...
        poll_adj = (samples as libc::c_double / (*inst).poll_target as libc::c_double - 1.0f64)
            / (*inst).poll_target as libc::c_double;
...
/* ================================================== */
unsafe extern "C" fn get_transmit_poll(mut inst: NCR_Instance) -> libc::c_int {
    ...
    if (*inst).mode as libc::c_uint == MODE_ACTIVE as libc::c_int as libc::c_uint
        && poll > (*inst).remote_poll
        && SRC_IsReachable((*inst).source) != 0
    {
        poll = if (*inst).remote_poll > (*inst).minpoll {
            (*inst).remote_poll
        } else {
            (*inst).minpoll
        }
...
/* ================================================== */
unsafe extern "C" fn get_transmit_delay(
    mut inst: NCR_Instance,
    ...
    match (*inst).opmode as libc::c_uint {
        0 => {
            __assert_fail(
                ...
                (*::std::mem::transmute::<&[u8; 53], &[libc::c_char; 53]>(
                    b"double get_transmit_delay(NCR_Instance, int, double)\x00",
                ))
                .as_ptr(),
            );
        }
        1 => {
            match (*inst).mode as libc::c_uint {
                ...
                1 => {
                    ...
                    if stratum_diff > 0 as libc::c_int && last_tx * 1.1f64 < delay_time
                        || on_tx == 0 && stratum_diff == 0 && last_tx / delay_time > 1.1f64 - 0.5f64
                    {
                        delay_time *= 1.1f64
                    }
        ...
        3 | 2 => {
            /* Burst modes */
            delay_time = if 2.0f64 < 0.25f64 * delay_time {
                2.0f64
            } else {
                (0.25f64) * delay_time
            }
...
unsafe extern "C" fn get_separation(mut poll: libc::c_int) -> libc::c_double {
    ...
    if poll >= -(6 as libc::c_int) && poll <= 24 as libc::c_int {
        ...
        __assert_fail(
            b"poll >= MIN_POLL && poll <= MAX_POLL\x00" as *const u8 as *const libc::c_char,
            b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
            899 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<&[u8; 27], &[libc::c_char; 27]>(
                b"double get_separation(int)\x00",
            ))
            .as_ptr(),
        );
    }
    ...
    return if 0.002f64
        > (if separation < 0.2f64 {
            separation
        } else {
            0.2f64
        }) {
        0.002f64
    } else if separation < 0.2f64 {
        separation
    } else {
        0.2f64
    };
...
unsafe extern "C" fn receive_timeout(mut arg: *mut libc::c_void) {
    ...
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"Receive timeout for %s\x00" as *const u8 as *const libc::c_char,
...
/* From what address to send it */ {
    let mut message: NTP_Packet = NTP_Packet {
        lvm: 0,
        stratum: 0,
        poll: 0,
        precision: 0,
    ...
    let mut local_receive: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    let mut local_transmit: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    ...
    let mut our_ref_time: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    ...
    if my_mode as libc::c_uint == MODE_CLIENT as libc::c_int as libc::c_uint {
        ...
        REF_GetReferenceParams(
            &mut local_transmit,
            &mut are_we_synchronised,
            &mut leap_status,
            &mut our_stratum,
            &mut our_ref_id,
            &mut our_ref_time,
            &mut our_root_delay,
            &mut our_root_dispersion,
        );
        /* Get current smoothing offset when sending packet to a client */
        if SMT_IsEnabled() != 0
            && (my_mode as libc::c_uint == MODE_SERVER as libc::c_int as libc::c_uint
                || my_mode as libc::c_uint == MODE_BROADCAST as libc::c_int as libc::c_uint)
        {
            smooth_offset = SMT_GetOffset(&mut local_transmit);
            smooth_time = (fabs(smooth_offset) > LCL_GetSysPrecisionAsQuantum()) as libc::c_int;
            /* Suppress leap second when smoothing and slew mode are enabled */
            if REF_GetLeapMode() as libc::c_uint == REF_LeapModeSlew as libc::c_int as libc::c_uint
                && (leap_status as libc::c_uint == LEAP_InsertSecond as libc::c_int as libc::c_uint
    ...
    if smooth_time != 0 && UTI_IsZeroTimespec(&mut (*local_rx).ts) == 0 {
        ...
        UTI_AddDoubleToTimespec(&mut our_ref_time, smooth_offset, &mut our_ref_time);
        UTI_AddDoubleToTimespec(&mut (*local_rx).ts, smooth_offset, &mut local_receive);
    } else {
        local_receive = (*local_rx).ts
    }
    /* Generate transmit packet */
    message.lvm =
        ((leap_status as libc::c_uint) << 6 as libc::c_int & 0xc0 as libc::c_int as libc::c_uint
            | (version << 3 as libc::c_int & 0x38 as libc::c_int) as libc::c_uint
            | my_mode as libc::c_uint & 0x7 as libc::c_int as libc::c_uint) as uint8_t;
    /* Stratum 16 and larger are invalid */
    if our_stratum < 16 as libc::c_int {
        message.stratum = our_stratum as uint8_t
    } else {
        message.stratum = 0 as libc::c_int as uint8_t
    }
    ...
    UTI_TimespecToNtp64(
        &mut our_ref_time,
        &mut message.reference_ts,
        0 as *mut NTP_int64,
    );
    /* Don't reveal timestamps which are not necessary for the protocol */
    if my_mode as libc::c_uint != MODE_CLIENT as libc::c_int as libc::c_uint || interleaved != 0 {
        /* Originate - this comes from the last packet the source sent us */
        message.originate_ts = if interleaved != 0 {
            *remote_ntp_rx
        } else {
            *remote_ntp_tx
        };
        loop {
            ...
            UTI_TimespecToNtp64(&mut local_receive, &mut message.receive_ts, &mut ts_fuzz);
    ...
    loop {
        ...
        if smooth_time != 0 {
            UTI_AddDoubleToTimespec(&mut local_transmit, smooth_offset, &mut local_transmit);
        }
        length = 48 as libc::c_ulong as libc::c_int;
        if auth_mode == AUTH_SYMMETRIC as libc::c_int || auth_mode == AUTH_MSSNTP as libc::c_int {
            ...
            local_transmit.tv_nsec += if auth_mode == AUTH_SYMMETRIC as libc::c_int {
            ...
            if auth_mode == AUTH_SYMMETRIC as libc::c_int {
                ...
                max_auth_len = if version == 4 as libc::c_int {
                    (4 as libc::c_int + 20 as libc::c_int - 4 as libc::c_int) as libc::c_ulong
                } else {
                    ::std::mem::size_of::<[uint8_t; 64]>() as libc::c_ulong
                } as libc::c_int;
                auth_len = KEY_GenerateAuth(
                    key_id,
                    &mut message as *mut NTP_Packet as *mut libc::c_uchar,
                    48 as libc::c_ulong as libc::c_int,
                    &mut message.auth_data as *mut [uint8_t; 64] as *mut libc::c_uchar,
                    max_auth_len,
                );
                if auth_len == 0 {
                        ...
                        && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
                    {
                        LOG_Message(
                            LOGS_DEBUG,
                            b"Could not generate auth data with key %u\x00" as *const u8
                ...
                length = (length as libc::c_ulong).wrapping_add(
                    (::std::mem::size_of::<NTP_int32>() as libc::c_ulong)
                        .wrapping_add(auth_len as libc::c_ulong),
                ) as libc::c_int as libc::c_int
            } else if auth_mode == AUTH_MSSNTP as libc::c_int {
                /* MS-SNTP packets are signed (asynchronously) by ntp_signd */
                return NSD_SignAndSendPacket(key_id, &mut message, where_to, from, length);
            }
        } else {
            UTI_TimespecToNtp64(
                if interleaved != 0 {
    ...
    ret = NIO_SendPacket(
        ...
        from,
        length,
        (local_tx != 0 as *mut libc::c_void as *mut NTP_Local_Timestamp) as libc::c_int,
    );
    if !local_tx.is_null() {
...
unsafe extern "C" fn transmit_timeout(mut arg: *mut libc::c_void) {
    let mut inst: NCR_Instance = arg as NCR_Instance;
    let mut local_addr: NTP_Local_Address = NTP_Local_Address {
        ip_addr: IPAddr {
        ...
        1 => {
            ...
            if (*inst).auto_burst != 0 && (*inst).local_poll > (*inst).minpoll {
                NCR_InitiateSampleBurst(
                    inst,
                    1 as libc::c_int,
                    if (1 as libc::c_int) << (*inst).local_poll - (*inst).minpoll < 4 as libc::c_int
                    {
                        (1 as libc::c_int) << (*inst).local_poll - (*inst).minpoll
                    } else {
                        4 as libc::c_int
                    },
                );
    ...
    if (*inst).opmode as libc::c_uint == MD_OFFLINE as libc::c_int as libc::c_uint {
        return;
    }
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"Transmit timeout for %s\x00" as *const u8 as *const libc::c_char,
            UTI_IPSockAddrToString(&mut (*inst).remote_addr),
        );
    }
    ...
    if (*inst).mode as libc::c_uint == MODE_CLIENT as libc::c_int as libc::c_uint {
        ...
        if (*inst).local_addr.sock_fd == -(2 as libc::c_int) {
            ...
            __assert_fail(
                b"inst->local_addr.sock_fd == INVALID_SOCK_FD\x00" as *const u8
                    as *const libc::c_char,
                b"ntp_core.c\x00" as *const u8 as *const libc::c_char,
                1179 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 30], &[libc::c_char; 30]>(
                    b"void transmit_timeout(void *)\x00",
                ))
                .as_ptr(),
            );
        }
        (*inst).local_addr.sock_fd = NIO_OpenClientSocket(&mut (*inst).remote_addr)
    }
    ...
    interleaved = ((*inst).interleaved != 0
        && ((*inst).mode as libc::c_uint == MODE_CLIENT as libc::c_int as libc::c_uint
            && (*inst).tx_count < 4 as libc::c_int as libc::c_uint
            || (*inst).mode as libc::c_uint == MODE_ACTIVE as libc::c_int as libc::c_uint
                && (*inst).prev_tx_count == 1 as libc::c_int as libc::c_uint
    ...
    initial = ((*inst).mode as libc::c_uint == MODE_ACTIVE as libc::c_int as libc::c_uint
        && (*inst).valid_rx == 0
        && UTI_IsZeroNtp64(&mut (*inst).init_remote_ntp_tx) == 0) as libc::c_int;
    /* Prepare for the response */
    (*inst).valid_rx = 0 as libc::c_int;
    (*inst).updated_init_timestamps = 0 as libc::c_int;
    if initial != 0 {
        (*inst).valid_timestamps = 0 as libc::c_int
    }
    ...
    if (*inst).presend_minpoll <= (*inst).local_poll
        && (*inst).presend_done == 0
        && (*inst).burst_total_samples_to_go == 0
    {
        (*inst).presend_done = if interleaved != 0 {
            2 as libc::c_int
        } else {
            1 as libc::c_int
        }
    ...
    sent = transmit_packet(
        (*inst).mode,
        interleaved,
        (*inst).local_poll,
        (*inst).version,
        (*inst).auth_mode as libc::c_int,
        (*inst).auth_key_id,
        if initial != 0 {
            0 as *mut NTP_int64
        } else {
            &mut (*inst).remote_ntp_rx
        },
        if initial != 0 {
            &mut (*inst).init_remote_ntp_tx
        } else {
            &mut (*inst).remote_ntp_tx
        },
        if initial != 0 {
        ...
        &mut (*inst).local_tx,
        &mut (*inst).local_ntp_rx,
        &mut (*inst).local_ntp_tx,
        &mut (*inst).remote_addr,
        &mut local_addr,
    );
    (*inst).tx_count = (*inst).tx_count.wrapping_add(1);
    if sent != 0 {
        (*inst).report.total_tx_count = (*inst).report.total_tx_count.wrapping_add(1)
    }
    ...
    match (*inst).opmode as libc::c_uint {
        3 => {
            ...
            if sent == 0 && SRC_IsReachable((*inst).source) == 0 {
                ...
                current_block_48 = 14029589282636423400;
            }
        }
        2 => {
            current_block_48 = 14029589282636423400;
    ...
    if (*inst).mode as libc::c_uint == MODE_CLIENT as libc::c_int as libc::c_uint {
        (*inst).rx_timeout_id = SCH_AddTimeoutByDelay(
            (*inst).max_delay + 4.0f64,
            Some(receive_timeout as unsafe extern "C" fn(_: *mut libc::c_void) -> ()),
            inst as *mut libc::c_void,
        )
    };
}
/* ================================================== */
unsafe extern "C" fn check_packet_format(
    mut message: *mut NTP_Packet,
    mut length: libc::c_int,
) -> libc::c_int {
    let mut version: libc::c_int = 0;
    /* Check version and length */
    version = (*message).lvm as libc::c_int >> 3 as libc::c_int & 0x7 as libc::c_int;
    if version < 1 as libc::c_int || version > 4 as libc::c_int {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"NTP packet has invalid version %d\x00" as *const u8 as *const libc::c_char,
                version,
            );
        }
        return 0 as libc::c_int;
    ...
    if length < 48 as libc::c_ulong as libc::c_int
        || (length as libc::c_uint).wrapping_rem(4 as libc::c_int as libc::c_uint) != 0
    {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"NTP packet has invalid length %d\x00" as *const u8 as *const libc::c_char,
                length,
            );
        }
        return 0 as libc::c_int;
...
/* ================================================== */
unsafe extern "C" fn is_zero_data(
...
/* ================================================== */
unsafe extern "C" fn check_packet_auth(
    mut pkt: *mut NTP_Packet,
    mut length: libc::c_int,
    ...
    version = (*pkt).lvm as libc::c_int >> 3 as libc::c_int & 0x7 as libc::c_int;
    ...
    loop {
        ...
        max_mac_length =
            if version == 4 as libc::c_int && remainder <= 4 as libc::c_int + 20 as libc::c_int {
                (4 as libc::c_int) + 20 as libc::c_int
            } else {
                (4 as libc::c_int) + 64 as libc::c_int
            };
        if remainder >= 4 as libc::c_int + 16 as libc::c_int && remainder <= max_mac_length {
            id = ntohl(*(data.offset(i as isize) as *mut uint32_t));
            if KEY_CheckAuth(
                id,
                pkt as *mut libc::c_void as *const libc::c_uchar,
                i,
                data.offset(i as isize).offset(4 as libc::c_int as isize) as *mut libc::c_void
                    as *const libc::c_uchar,
                remainder - 4 as libc::c_int,
                max_mac_length - 4 as libc::c_int,
            ) != 0
            {
                ...
                *key_id = id;
                ...
                if version == 4 as libc::c_int
                    && 48 as libc::c_ulong as libc::c_int + remainder == length
                    && remainder > 4 as libc::c_int + 20 as libc::c_int
                {
                    (*pkt).lvm = (((*pkt).lvm as libc::c_int >> 6 as libc::c_int
                        & 0x3 as libc::c_int)
                        << 6 as libc::c_int
                        & 0xc0 as libc::c_int
                        | (3 as libc::c_int) << 3 as libc::c_int & 0x38 as libc::c_int
                        | (*pkt).lvm as libc::c_int & 0x7 as libc::c_int & 0x7 as libc::c_int)
                        as uint8_t
                }
                return 1 as libc::c_int;
            }
        ...
        ext_length =
            ntohs(*(data.offset(i as isize).offset(2 as libc::c_int as isize) as *mut uint16_t))
                as libc::c_int;
        if !(ext_length >= 16 as libc::c_int
            && ext_length <= remainder
    ...
    if remainder >= 4 as libc::c_int + 16 as libc::c_int {
        ...
        *auth_mode = AUTH_NONE;
        *key_id = 0 as libc::c_int as uint32_t
    }
    return 0 as libc::c_int;
}
/* ================================================== */
unsafe extern "C" fn check_delay_ratio(
    mut inst: NCR_Instance,
    mut stats: SST_Stats,
    ...
    max_delay =
        min_delay * (*inst).max_delay_ratio + last_sample_ago * (skew + LCL_GetMaxClockError());
    if delay <= max_delay {
        return 1 as libc::c_int;
    }
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"maxdelayratio: delay=%e max_delay=%e\x00" as *const u8 as *const libc::c_char,
            delay,
            max_delay,
        );
    }
...
/* ================================================== */
unsafe extern "C" fn check_delay_dev_ratio(
    mut inst: NCR_Instance,
    mut stats: SST_Stats,
    mut sample_time: *mut timespec,
    ...
    max_delta =
        std_dev * (*inst).max_delay_dev_ratio + last_sample_ago * (skew + LCL_GetMaxClockError());
    ...
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"maxdelaydevratio: error=%e delay=%e delta=%e max_delta=%e\x00" as *const u8
                as *const libc::c_char,
            error_in_estimate,
            delay,
            delta,
...
/* ================================================== */
unsafe extern "C" fn check_sync_loop(
    mut inst: NCR_Instance,
    mut message: *mut NTP_Packet,
    ...
    if (*message).stratum as libc::c_int > 1 as libc::c_int
        && (*message).reference_id == htonl(UTI_IPToRefid(&mut (*local_addr).ip_addr))
    {
        return 0 as libc::c_int;
    }
        ...
        && UTI_IsZeroNtp64(&mut (*message).reference_ts) == 0
    {
        ...
        UTI_TimespecToNtp64(&mut our_ref_time, &mut ntp_ref_time, 0 as *mut NTP_int64);
        if UTI_CompareNtp64(&mut (*message).reference_ts, &mut ntp_ref_time) == 0 as libc::c_int {
            if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
            {
                LOG_Message(
                    LOGS_DEBUG,
                    b"Source %s is me\x00" as *const u8 as *const libc::c_char,
...
/* ================================================== */
unsafe extern "C" fn process_sample(mut inst: NCR_Instance, mut sample: *mut NTP_Sample) {
    let mut estimated_offset: libc::c_double = 0.;
    let mut error_in_estimate: libc::c_double = 0.;
    let mut filtered_sample_ago: libc::c_double = 0.;
    let mut filtered_sample: NTP_Sample = NTP_Sample {
        time: timespec {
            tv_sec: 0,
            tv_nsec: 0,
        },
    ...
    if !(*inst).filter.is_null() {
        ...
        filtered_sample_ago =
            UTI_DiffTimespecsToDouble(&mut (*sample).time, &mut filtered_sample.time);
        if filtered_sample_ago
            > (8 as libc::c_int / 2 as libc::c_int * filtered_samples) as libc::c_double
                * UTI_Log2ToDouble((*inst).local_poll)
        {
            if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
            {
                LOG_Message(
                    LOGS_DEBUG,
                    b"filtered sample dropped ago=%f poll=%d\x00" as *const u8
                        as *const libc::c_char,
                    filtered_sample_ago,
                    (*inst).local_poll,
                );
    ...
    estimated_offset = SST_PredictOffset(SRC_GetSourcestats((*inst).source), &mut (*sample).time);
    ...
    adjust_poll(
        ...
        get_poll_adj(
            inst,
            error_in_estimate,
            (*sample).peer_dispersion + 0.5f64 * (*sample).peer_delay,
        ),
    );
}
/* ================================================== */
unsafe extern "C" fn receive_packet(
    ...
    let mut local_receive: NTP_Local_Timestamp = NTP_Local_Timestamp {
        ts: timespec {
            tv_sec: 0,
            tv_nsec: 0,
        },
    ...
    let mut local_transmit: NTP_Local_Timestamp = NTP_Local_Timestamp {
        ts: timespec {
            tv_sec: 0,
            tv_nsec: 0,
        },
    ...
    (*inst).report.total_rx_count = (*inst).report.total_rx_count.wrapping_add(1);
    pkt_leap = (*message).lvm as libc::c_int >> 6 as libc::c_int & 0x3 as libc::c_int;
    pkt_version = (*message).lvm as libc::c_int >> 3 as libc::c_int & 0x7 as libc::c_int;
    ...
    test1 = (UTI_CompareNtp64(&mut (*message).receive_ts, &mut (*inst).remote_ntp_rx) != 0
        || UTI_CompareNtp64(&mut (*message).transmit_ts, &mut (*inst).remote_ntp_tx) != 0)
        as libc::c_int;
    ...
    test2n = (UTI_CompareNtp64(&mut (*message).originate_ts, &mut (*inst).local_ntp_tx) == 0)
        as libc::c_int;
    test2i = ((*inst).interleaved != 0
        && UTI_CompareNtp64(&mut (*message).originate_ts, &mut (*inst).local_ntp_rx) == 0)
        as libc::c_int;
    ...
    test3 = (UTI_IsZeroNtp64(&mut (*message).originate_ts) == 0
        && UTI_IsZeroNtp64(&mut (*message).receive_ts) == 0
        && UTI_IsZeroNtp64(&mut (*message).transmit_ts) == 0) as libc::c_int;
    ...
    the test. */
    test5 = ((*inst).auth_mode as libc::c_uint == AUTH_NONE as libc::c_int as libc::c_uint
        || check_packet_auth(message, length, &mut pkt_auth_mode, &mut pkt_key_id) != 0
            && pkt_auth_mode as libc::c_uint == (*inst).auth_mode as libc::c_uint
            && pkt_key_id == (*inst).auth_key_id) as libc::c_int;
    /* Test 6 checks for unsynchronised server */
    test6 = (pkt_leap != LEAP_Unsynchronised as libc::c_int
        && ((*message).stratum as libc::c_int) < 16 as libc::c_int
        && (*message).stratum as libc::c_int != 0 as libc::c_int) as libc::c_int;
    /* Test 7 checks for bad data.  The root distance must be smaller than a
    defined maximum. */
    test7 = (pkt_root_delay / 2.0f64 + pkt_root_dispersion < 16.0f64) as libc::c_int;
    ...
    valid_packet = (test1 != 0 && test2 != 0 && test3 != 0 && test5 != 0) as libc::c_int;
    synced_packet = (valid_packet != 0 && test6 != 0 && test7 != 0) as libc::c_int;
    ...
    if synced_packet != 0 && (interleaved_packet == 0 || (*inst).valid_timestamps != 0) {
        /* These are the timespec equivalents of the remote and local epochs */
        let mut remote_receive: timespec = timespec {
            tv_sec: 0,
            tv_nsec: 0,
        };
        let mut remote_transmit: timespec = timespec {
            tv_sec: 0,
            tv_nsec: 0,
        };
        let mut remote_request_receive: timespec = timespec {
            tv_sec: 0,
            tv_nsec: 0,
        };
        let mut local_average: timespec = timespec {
            tv_sec: 0,
            tv_nsec: 0,
        };
        let mut remote_average: timespec = timespec {
            tv_sec: 0,
            tv_nsec: 0,
        };
        let mut prev_remote_transmit: timespec = timespec {
            tv_sec: 0,
            tv_nsec: 0,
        };
        ...
        if interleaved_packet != 0 {
            ...
            if UTI_IsZeroTimespec(&mut (*inst).prev_local_tx.ts) == 0
                && 0.1f64
                    * UTI_DiffTimespecsToDouble(&mut (*inst).local_tx.ts, &mut (*inst).local_rx.ts)
                    > UTI_DiffTimespecsToDouble(
                        &mut (*inst).local_rx.ts,
                        &mut (*inst).prev_local_tx.ts,
                    )
            {
                UTI_Ntp64ToTimespec(&mut (*inst).remote_ntp_rx, &mut remote_receive);
                remote_request_receive = remote_receive;
                local_transmit = (*inst).prev_local_tx
            } else {
                UTI_Ntp64ToTimespec(&mut (*message).receive_ts, &mut remote_receive);
                UTI_Ntp64ToTimespec(&mut (*inst).remote_ntp_rx, &mut remote_request_receive);
                local_transmit = (*inst).local_tx
            }
            UTI_Ntp64ToTimespec(&mut (*message).transmit_ts, &mut remote_transmit);
            UTI_Ntp64ToTimespec(&mut (*inst).remote_ntp_tx, &mut prev_remote_transmit);
        ...
        UTI_AverageDiffTimespecs(
            &mut local_transmit.ts,
            &mut local_receive.ts,
            &mut local_average,
            &mut local_interval,
        );
        response_time = fabs(UTI_DiffTimespecsToDouble(
            &mut remote_transmit,
            &mut remote_request_receive,
        ));
        precision =
            LCL_GetSysPrecisionAsQuantum() + UTI_Log2ToDouble((*message).precision as libc::c_int);
        /* Calculate delay */
        ...
        sample.offset = UTI_DiffTimespecsToDouble(&mut remote_average, &mut local_average);
        ...
        SST_GetFrequencyRange(stats, &mut source_freq_lo, &mut source_freq_hi);
        /* Calculate skew */
        skew = (source_freq_hi - source_freq_lo) / 2.0f64;
        /* and then calculate peer dispersion */
        sample.peer_dispersion = (if precision
        ...
        testA = (sample.peer_delay - sample.peer_dispersion <= (*inst).max_delay
            ...
            && !((*inst).mode as libc::c_uint == MODE_ACTIVE as libc::c_int as libc::c_uint
                ...
                && (sample.peer_delay > 0.5f64 * prev_remote_poll_interval
                    || UTI_CompareNtp64(&mut (*message).receive_ts, &mut (*message).transmit_ts)
                        <= 0 as libc::c_int
                    || (*inst).remote_poll <= (*inst).prev_local_poll
                        && UTI_DiffTimespecsToDouble(
                            &mut remote_transmit,
                            &mut prev_remote_transmit,
                        ) > 1.5f64 * prev_remote_poll_interval))) as libc::c_int;
        ...
        testB = check_delay_ratio(inst, stats, &mut sample.time, sample.peer_delay);
    ...
    good_packet = (testA != 0 && testB != 0 && testC != 0 && testD != 0) as libc::c_int;
    sample.root_delay = pkt_root_delay + sample.peer_delay;
    sample.root_dispersion = pkt_root_dispersion + sample.peer_dispersion;
    sample.stratum = if (*message).stratum as libc::c_int > (*inst).min_stratum {
    ...
    if (*inst).mode as libc::c_uint == MODE_CLIENT as libc::c_int as libc::c_uint
        ...
        || (*inst).mode as libc::c_uint == MODE_ACTIVE as libc::c_int as libc::c_uint
            && valid_packet != 0
            && ((*inst).valid_rx == 0
                || UTI_CompareNtp64(&mut (*inst).remote_ntp_tx, &mut (*message).transmit_ts)
                    < 0 as libc::c_int)
    {
        ...
        if interleaved_packet != 0 {
            ...
            zero_local_timestamp(&mut (*inst).prev_local_tx);
        }
    } else if (*inst).mode as libc::c_uint == MODE_ACTIVE as libc::c_int as libc::c_uint
        && test1 != 0
        && UTI_IsZeroNtp64(&mut (*message).transmit_ts) == 0
        && test5 != 0
        && ((*inst).updated_init_timestamps == 0
            || UTI_CompareNtp64(&mut (*inst).init_remote_ntp_tx, &mut (*message).transmit_ts)
                < 0 as libc::c_int)
    {
        ...
        updated_timestamps = 0 as libc::c_int
    }
    ...
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"reference=%s origin=%s receive=%s transmit=%s\x00" as *const u8
                as *const libc::c_char,
    ...
    if valid_packet != 0 {
        ...
        (*inst).remote_stratum = if (*message).stratum as libc::c_int != 0 as libc::c_int {
            (*message).stratum as libc::c_int
        } else {
            16 as libc::c_int
        };
        ...
        if (*inst).opmode as libc::c_uint != MD_OFFLINE as libc::c_int as libc::c_uint {
            delay_time = get_transmit_delay(
                inst,
                0 as libc::c_int,
                UTI_DiffTimespecsToDouble(&mut (*inst).local_rx.ts, &mut (*inst).local_tx.ts),
            );
            if kod_rate != 0 {
                LOG_Message(
                    LOGS_WARN,
                    b"Received KoD RATE from %s\x00" as *const u8 as *const libc::c_char,
                    UTI_IPToString(&mut (*inst).remote_addr.ip_addr),
                );
                /* Back off for a while and stop ongoing burst */
                delay_time +=
                    4 as libc::c_int as libc::c_double * UTI_Log2ToDouble((*inst).local_poll);
                if (*inst).opmode as libc::c_uint
        ...
        (*inst).report.mode = ((*message).lvm as libc::c_int & 0x7 as libc::c_int) as uint8_t;
        ...
        UTI_Ntp64ToTimespec(&mut (*message).reference_ts, &mut (*inst).report.ref_time);
        ...
        (*inst).report.tests =
            (((((((((test1 << 1 as libc::c_int | test2) << 1 as libc::c_int | test3)
                << 1 as libc::c_int
                | test5)
                << 1 as libc::c_int
                | test6)
        ...
        (*inst).report.authenticated = ((*inst).auth_mode as libc::c_uint
            != AUTH_NONE as libc::c_int as libc::c_uint)
            as libc::c_int;
        (*inst).report.tx_tss_char = tss_chars[local_transmit.source as usize];
        (*inst).report.rx_tss_char = tss_chars[local_receive.source as usize];
        (*inst).report.total_valid_count = (*inst).report.total_valid_count.wrapping_add(1)
    }
    /* Do measurement logging */
    if logfileid != -(1 as libc::c_int) && (log_raw_measurements != 0 || synced_packet != 0) {
...
#[no_mangle]
pub unsafe extern "C" fn NCR_ProcessRxKnown(
    mut inst: NCR_Instance,
    mut local_addr: *mut NTP_Local_Address,
    mut rx_ts: *mut NTP_Local_Timestamp,
    mut message: *mut NTP_Packet,
    ...
    if check_packet_format(message, length) == 0 {
        return 0 as libc::c_int;
    }
    ...
    if proc_packet != 0 {
        ...
        if (*local_addr).sock_fd != (*inst).local_addr.sock_fd {
            if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
            {
                LOG_Message(
                    LOGS_DEBUG,
                    b"Packet received by wrong socket %d (expected %d)\x00" as *const u8
                        as *const libc::c_char,
                    (*local_addr).sock_fd,
            ...
            || (*inst).tx_suspended != 0
        {
            if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
            {
                LOG_Message(
                    LOGS_DEBUG,
                    b"Packet from offline source\x00" as *const u8 as *const libc::c_char,
                );
            }
            return 0 as libc::c_int;
        }
        ...
        NCR_ProcessRxUnknown(&mut (*inst).remote_addr, local_addr, rx_ts, message, length);
        ...
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"NTP packet discarded pkt_mode=%d our_mode=%u\x00" as *const u8
                    as *const libc::c_char,
                pkt_mode,
...
#[no_mangle]
pub unsafe extern "C" fn NCR_ProcessRxUnknown(
    mut remote_addr: *mut NTP_Remote_Address,
    mut local_addr: *mut NTP_Local_Address,
    mut rx_ts: *mut NTP_Local_Timestamp,
    mut message: *mut NTP_Packet,
    ...
    let mut local_tx: NTP_Local_Timestamp = NTP_Local_Timestamp {
        ts: timespec {
            tv_sec: 0,
            tv_nsec: 0,
        },
    ...
    if NIO_IsServerSocket((*local_addr).sock_fd) == 0 {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"NTP request packet received by client socket %d\x00" as *const u8
                    as *const libc::c_char,
                (*local_addr).sock_fd,
            );
        }
    ...
    if ADF_IsAllowed(access_auth_table, &mut (*remote_addr).ip_addr) == 0 {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"NTP packet received from unauthorised host %s\x00" as *const u8
                    as *const libc::c_char,
    ...
    pkt_mode = ((*message).lvm as libc::c_int & 0x7 as libc::c_int) as NTP_Mode;
    pkt_version = (*message).lvm as libc::c_int >> 3 as libc::c_int & 0x7 as libc::c_int;
    ...
    match pkt_mode as libc::c_uint {
        ...
        0 => {
                ...
                && (*remote_addr).port as libc::c_int != 123 as libc::c_int
            {
                ...
                current_block_25 = 12820755034573918988;
            }
        }
        _ => {
            current_block_25 = 12820755034573918988;
    ...
    match current_block_25 {
        ...
        /* Discard */
        {
            if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
            {
                LOG_Message(
                    LOGS_DEBUG,
                    b"NTP packet discarded pkt_mode=%u\x00" as *const u8 as *const libc::c_char,
    ...
    log_index = CLG_LogNTPAccess(&mut (*remote_addr).ip_addr, &mut (*rx_ts).ts);
    /* Don't reply to all requests if the rate is excessive */
    if log_index >= 0 as libc::c_int && CLG_LimitNTPResponseRate(log_index) != 0 {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"NTP packet discarded to limit response rate\x00" as *const u8
                    as *const libc::c_char,
            );
        }
        return;
    ...
    valid_auth = check_packet_auth(message, length, &mut auth_mode, &mut key_id);
        ...
        match auth_mode as libc::c_uint {
            ...
            _ => {
                    ...
                    && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
                {
                    LOG_Message(
                        LOGS_DEBUG,
                        b"NTP packet discarded auth_mode=%u\x00" as *const u8
                            as *const libc::c_char,
    ...
    if log_index >= 0 as libc::c_int {
        ...
        interleaved = (UTI_IsZeroNtp64(local_ntp_rx) == 0
            && UTI_CompareNtp64(&mut (*message).originate_ts, local_ntp_rx) == 0
            && UTI_CompareNtp64(&mut (*message).receive_ts, &mut (*message).transmit_ts) != 0)
            as libc::c_int;
        if interleaved != 0 {
    ...
    poll = if poll > (*message).poll as libc::c_int {
        poll
    } else {
        (*message).poll as libc::c_int
    };
    ...
    if !tx_ts.is_null() {
        UTI_TimespecToNtp64(&mut (*tx_ts).ts, local_ntp_tx, 0 as *mut NTP_int64);
    };
}
/* ================================================== */
unsafe extern "C" fn update_tx_timestamp(
    mut tx_ts: *mut NTP_Local_Timestamp,
    mut new_tx_ts: *mut NTP_Local_Timestamp,
    mut local_ntp_rx: *mut NTP_int64,
    mut local_ntp_tx: *mut NTP_int64,
    mut message: *mut NTP_Packet,
) {
    ...
    if UTI_IsZeroTimespec(&mut (*tx_ts).ts) != 0 {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"Unexpected TX update\x00" as *const u8 as *const libc::c_char,
            );
        }
        return;
    }
    /* Check if this is the last packet that was sent */
    if !local_ntp_rx.is_null() && UTI_CompareNtp64(&mut (*message).receive_ts, local_ntp_rx) != 0
        || !local_ntp_tx.is_null()
            && UTI_CompareNtp64(&mut (*message).transmit_ts, local_ntp_tx) != 0
    {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"RX/TX timestamp mismatch\x00" as *const u8 as *const libc::c_char,
            );
        }
        return;
    }
    ...
    if delay < 0.0f64 || delay > 1.0f64 {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"Unacceptable TX delay %.9f\x00" as *const u8 as *const libc::c_char,
                delay,
            );
        }
        return;
    ...
    *tx_ts = *new_tx_ts;
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"Updated TX timestamp delay=%.9f\x00" as *const u8 as *const libc::c_char,
            delay,
        );
    };
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ProcessTxKnown(
    mut inst: NCR_Instance,
    mut local_addr: *mut NTP_Local_Address,
    mut tx_ts: *mut NTP_Local_Timestamp,
    mut message: *mut NTP_Packet,
    ...
    if pkt_mode as libc::c_uint != MODE_CLIENT as libc::c_int as libc::c_uint
        && pkt_mode as libc::c_uint != MODE_ACTIVE as libc::c_int as libc::c_uint
    {
        NCR_ProcessTxUnknown(&mut (*inst).remote_addr, local_addr, tx_ts, message, length);
        return;
    }
    update_tx_timestamp(
        &mut (*inst).local_tx,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ProcessTxUnknown(
    mut remote_addr: *mut NTP_Remote_Address,
    mut local_addr: *mut NTP_Local_Address,
    mut tx_ts: *mut NTP_Local_Timestamp,
    mut message: *mut NTP_Packet,
    ...
    if (*message).lvm as libc::c_int & 0x7 as libc::c_int == MODE_BROADCAST as libc::c_int {
        return;
    }
    ...
    if SMT_IsEnabled() != 0
        && (*message).lvm as libc::c_int & 0x7 as libc::c_int == MODE_SERVER as libc::c_int
    {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_SlewTimes(
    mut inst: NCR_Instance,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_SetConnectivity(
    mut inst: NCR_Instance,
    mut connectivity: SRC_Connectivity,
) {
    let mut s: *mut libc::c_char = 0 as *mut libc::c_char;
    s = UTI_IPToString(&mut (*inst).remote_addr.ip_addr);
    if connectivity as libc::c_uint == SRC_MAYBE_ONLINE as libc::c_int as libc::c_uint {
        connectivity = if NIO_IsServerConnectable(&mut (*inst).remote_addr) != 0 {
    ...
    match connectivity as libc::c_uint {
        1 => match (*inst).opmode as libc::c_uint {
            1 => {}
            0 => {
                LOG_Message(
                    LOGS_INFO,
                    b"Source %s online\x00" as *const u8 as *const libc::c_char,
                    s,
                );
                (*inst).opmode = MD_ONLINE;
                NCR_ResetInstance(inst);
            ...
            _ => {
                __assert_fail(
                    ...
                    (*::std::mem::transmute::<&[u8; 57], &[libc::c_char; 57]>(
                        b"void NCR_SetConnectivity(NCR_Instance, SRC_Connectivity)\x00",
                    ))
                    .as_ptr(),
                );
            }
        },
        0 => match (*inst).opmode as libc::c_uint {
            1 => {
                LOG_Message(
                    LOGS_INFO,
                    b"Source %s offline\x00" as *const u8 as *const libc::c_char,
                    s,
                );
                take_offline(inst);
            }
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ModifyMinpoll(mut inst: NCR_Instance, mut new_minpoll: libc::c_int) {
    ...
    LOG_Message(
        LOGS_INFO,
        b"Source %s new minpoll %d\x00" as *const u8 as *const libc::c_char,
        UTI_IPToString(&mut (*inst).remote_addr.ip_addr),
        new_minpoll,
    );
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ModifyMaxpoll(mut inst: NCR_Instance, mut new_maxpoll: libc::c_int) {
    ...
    LOG_Message(
        LOGS_INFO,
        b"Source %s new maxpoll %d\x00" as *const u8 as *const libc::c_char,
        UTI_IPToString(&mut (*inst).remote_addr.ip_addr),
        new_maxpoll,
    );
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ModifyMaxdelay(
    mut inst: NCR_Instance,
    mut new_max_delay: libc::c_double,
) {
    (*inst).max_delay = if 0.0f64
    ...
    LOG_Message(
        LOGS_INFO,
        b"Source %s new maxdelay %f\x00" as *const u8 as *const libc::c_char,
        UTI_IPToString(&mut (*inst).remote_addr.ip_addr),
        (*inst).max_delay,
    );
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ModifyMaxdelayratio(
    mut inst: NCR_Instance,
    mut new_max_delay_ratio: libc::c_double,
) {
    (*inst).max_delay_ratio = if 0.0f64
    ...
    LOG_Message(
        LOGS_INFO,
        b"Source %s new maxdelayratio %f\x00" as *const u8 as *const libc::c_char,
        UTI_IPToString(&mut (*inst).remote_addr.ip_addr),
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ModifyMaxdelaydevratio(
    mut inst: NCR_Instance,
    mut new_max_delay_dev_ratio: libc::c_double,
) {
    (*inst).max_delay_dev_ratio = if 0.0f64
    ...
    LOG_Message(
        LOGS_INFO,
        b"Source %s new maxdelaydevratio %f\x00" as *const u8 as *const libc::c_char,
        UTI_IPToString(&mut (*inst).remote_addr.ip_addr),
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ModifyMinstratum(
    mut inst: NCR_Instance,
    ...
    LOG_Message(
        LOGS_INFO,
        b"Source %s new minstratum %d\x00" as *const u8 as *const libc::c_char,
        UTI_IPToString(&mut (*inst).remote_addr.ip_addr),
        new_min_stratum,
    );
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ModifyPolltarget(
    mut inst: NCR_Instance,
    ...
    LOG_Message(
        LOGS_INFO,
        b"Source %s new polltarget %d\x00" as *const u8 as *const libc::c_char,
        UTI_IPToString(&mut (*inst).remote_addr.ip_addr),
        new_poll_target,
    );
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_InitiateSampleBurst(
    mut inst: NCR_Instance,
    ...
    if (*inst).mode as libc::c_uint == MODE_CLIENT as libc::c_int as libc::c_uint {
        ...
        match (*inst).opmode as libc::c_uint {
            ...
            1 | 0 => {
                (*inst).opmode =
                    if (*inst).opmode as libc::c_uint == MD_ONLINE as libc::c_int as libc::c_uint {
                        MD_BURST_WAS_ONLINE as libc::c_int
                    } else {
                        MD_BURST_WAS_OFFLINE as libc::c_int
                    } as OperatingMode;
            ...
            _ => {
                __assert_fail(
                    ...
                    (*::std::mem::transmute::<&[u8; 53], &[libc::c_char; 53]>(
                        b"void NCR_InitiateSampleBurst(NCR_Instance, int, int)\x00",
                    ))
                    .as_ptr(),
                );
            }
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_ReportSource(
    mut inst: NCR_Instance,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_GetNTPReport(mut inst: NCR_Instance, mut report: *mut RPT_NTPReport) {
    *report = (*inst).report;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_AddAccessRestriction(
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_CheckAccessRestriction(mut ip_addr: *mut IPAddr) -> libc::c_int {
    return ADF_IsAllowed(access_auth_table, ip_addr);
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_IncrementActivityCounters(
    mut inst: NCR_Instance,
    mut online: *mut libc::c_int,
    mut offline: *mut libc::c_int,
    mut burst_online: *mut libc::c_int,
    mut burst_offline: *mut libc::c_int,
) {
    match (*inst).opmode as libc::c_uint {
        2 => *burst_offline += 1,
        3 => *burst_online += 1,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_GetRemoteAddress(mut inst: NCR_Instance) -> *mut NTP_Remote_Address {
    return &mut (*inst).remote_addr;
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_GetLocalRefid(mut inst: NCR_Instance) -> uint32_t {
    return UTI_IPToRefid(&mut (*inst).local_addr.ip_addr);
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_IsSyncPeer(mut inst: NCR_Instance) -> libc::c_int {
    return SRC_IsSyncPeer((*inst).source);
}
/* ================================================== */
unsafe extern "C" fn broadcast_timeout(mut arg: *mut libc::c_void) {
    let mut destination: *mut BroadcastDestination = 0 as *mut BroadcastDestination;
    let mut orig_ts: NTP_int64 = NTP_int64 { hi: 0, lo: 0 };
    let mut recv_ts: NTP_Local_Timestamp = NTP_Local_Timestamp {
        ts: timespec {
            tv_sec: 0,
            tv_nsec: 0,
        },
    ...
    let mut poll: libc::c_int = 0;
    destination = ARR_GetElement(broadcasts, arg as libc::c_long as libc::c_uint)
        as *mut BroadcastDestination;
    poll = (log((*destination).interval as libc::c_double) / log(2.0f64) + 0.5f64) as libc::c_int;
    ...
    SCH_AddTimeoutInClass(
        (*destination).interval as libc::c_double,
        get_separation(poll),
        0.02f64,
        SCH_NtpBroadcastClass,
        Some(broadcast_timeout as unsafe extern "C" fn(_: *mut libc::c_void) -> ()),
        arg,
    );
}
/*
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NCR_AddBroadcastDestination(
    mut addr: *mut IPAddr,
    ...
    (*destination).local_addr.sock_fd = NIO_OpenServerSocket(&mut (*destination).addr);
    (*destination).interval = if 1 as libc::c_int
    ...
    SCH_AddTimeoutInClass(
        ...
        SCH_NtpBroadcastClass,
        Some(broadcast_timeout as unsafe extern "C" fn(_: *mut libc::c_void) -> ()),
        ARR_GetSize(broadcasts).wrapping_sub(1 as libc::c_int as libc::c_uint) as libc::c_long
            as *mut libc::c_void,
    );
}
