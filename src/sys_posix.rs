...
pub unsafe extern "C" fn SYS_Posix_SetScheduler(mut priority: libc::c_int) {
    ...
    if priority < 1 as libc::c_int || priority > 99 as libc::c_int {
        LOG_Message(
            LOGS_FATAL,
            b"Bad scheduler priority: %d\x00" as *const u8 as *const libc::c_char,
            priority,
        );
    ...
    if pthread_setschedparam(pthread_self(), 1 as libc::c_int, &mut sched) < 0 as libc::c_int {
        LOG_Message(
            LOGS_ERR,
            b"pthread_setschedparam() failed\x00" as *const u8 as *const libc::c_char,
        );
    } else if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
    {
        LOG_Message(
            LOGS_DEBUG,
            b"Enabled SCHED_FIFO with priority %d\x00" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn SYS_Posix_MemLockAll() {
    ...
    if setrlimit(__RLIMIT_MEMLOCK, &mut rlim) < 0 as libc::c_int {
        LOG_Message(
            LOGS_ERR,
            b"setrlimit() failed\x00" as *const u8 as *const libc::c_char,
        );
        return;
    }
    if mlockall(1 as libc::c_int | 2 as libc::c_int) < 0 as libc::c_int {
        LOG_Message(
            LOGS_ERR,
            b"mlockall() failed\x00" as *const u8 as *const libc::c_char,
        );
    } else if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
    {
        LOG_Message(
            LOGS_DEBUG,
            b"Successfully locked into RAM\x00" as *const u8 as *const libc::c_char,
        );
    };
}
/* HAVE_MLOCKALL */
