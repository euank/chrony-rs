...
extern "C" {
    ...
    #[no_mangle]
    fn CNF_GetHwTsInterface(index: libc::c_uint, iface: *mut *mut CNF_HwTsInterface)
        -> libc::c_int;
    /* Create a new HW clock instance */
    #[no_mangle]
    fn HCL_CreateInstance(
        min_samples: libc::c_int,
        max_samples: libc::c_int,
        min_separation: libc::c_double,
    ) -> HCL_Instance;
    ...
    #[no_mangle]
    fn HCL_NeedsNewSample(clock: HCL_Instance, now: *mut timespec) -> libc::c_int;
    /* Accumulate a new sample */
    #[no_mangle]
    fn HCL_AccumulateSample(
        clock: HCL_Instance,
        hw_ts: *mut timespec,
        local_ts: *mut timespec,
        err: libc::c_double,
    );
    ...
    #[no_mangle]
    fn SCH_SetFileHandlerEvent(fd: libc::c_int, event: libc::c_int, enable: libc::c_int);
    ...
    #[no_mangle]
    fn SYS_Linux_CheckKernelVersion(req_major: libc::c_int, req_minor: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn SYS_Linux_OpenPHC(path: *const libc::c_char, phc_index: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn SYS_Linux_GetPHCSample(
        fd: libc::c_int,
        nocrossts: libc::c_int,
...
unsafe extern "C" fn ethtool_cmd_speed(mut ep: *const ethtool_cmd) -> __u32 {
    return (((*ep).speed_hi as libc::c_int) << 16 as libc::c_int | (*ep).speed as libc::c_int)
        as __u32;
}
/* Array of Interfaces */
static mut interfaces: ARR_Instance = 0 as *const ARR_Instance_Record as *mut ARR_Instance_Record;
...
/* ================================================== */
unsafe extern "C" fn add_interface(mut conf_iface: *mut CNF_HwTsInterface) -> libc::c_int {
    let mut ts_info: ethtool_ts_info = ethtool_ts_info {
        cmd: 0,
        so_timestamping: 0,
        phc_index: 0,
        tx_types: 0,
    ...
    let mut ts_config: hwtstamp_config = hwtstamp_config {
        flags: 0,
        tx_type: 0,
        rx_filter: 0,
    };
    ...
    while i < ARR_GetSize(interfaces) {
        if strcmp(
            (*conf_iface).name,
            (*(ARR_GetElement(interfaces, i) as *mut Interface))
                .name
                .as_mut_ptr(),
        ) == 0
        {
    ...
    sock_fd = SCK_OpenUdpSocket(0 as *mut IPSockAddr, 0 as *mut IPSockAddr, 0 as libc::c_int);
    ...
    memset(
        &mut ts_info as *mut ethtool_ts_info as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if ioctl(
        sock_fd,
        0x8933 as libc::c_int as libc::c_ulong,
    ...
    req.ifr_ifru.ifru_data = &mut ts_info as *mut ethtool_ts_info as *mut libc::c_char;
    if ioctl(
        sock_fd,
        0x8946 as libc::c_int as libc::c_ulong,
        &mut req as *mut ifreq,
    ) != 0
    {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"ioctl(%s) failed : %s\x00" as *const u8 as *const libc::c_char,
                b"SIOCETHTOOL\x00" as *const u8 as *const libc::c_char,
                strerror(*__errno_location()),
            );
        }
        SCK_CloseSocket(sock_fd);
    ...
    req_hwts_flags = SOF_TIMESTAMPING_RX_HARDWARE as libc::c_int
        | SOF_TIMESTAMPING_TX_HARDWARE as libc::c_int
        | SOF_TIMESTAMPING_RAW_HARDWARE as libc::c_int;
    if ts_info.so_timestamping & req_hwts_flags as libc::c_uint != req_hwts_flags as libc::c_uint {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"HW timestamping not supported on %s\x00" as *const u8 as *const libc::c_char,
                req.ifr_ifrn.ifrn_name.as_mut_ptr(),
            );
        }
        SCK_CloseSocket(sock_fd);
    ...
    if ts_info.phc_index < 0 as libc::c_int {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"PHC missing on %s\x00" as *const u8 as *const libc::c_char,
                req.ifr_ifrn.ifrn_name.as_mut_ptr(),
            );
        }
        SCK_CloseSocket(sock_fd);
    ...
    match (*conf_iface).rxfilter as libc::c_uint {
        0 => {
            if ts_info.rx_filters
                & ((1 as libc::c_int) << HWTSTAMP_FILTER_NTP_ALL as libc::c_int) as libc::c_uint
                != 0
            {
                rx_filter = HWTSTAMP_FILTER_NTP_ALL as libc::c_int
            } else if ts_info.rx_filters
                & ((1 as libc::c_int) << HWTSTAMP_FILTER_ALL as libc::c_int) as libc::c_uint
                != 0
            {
                rx_filter = HWTSTAMP_FILTER_ALL as libc::c_int
            } else {
                rx_filter = HWTSTAMP_FILTER_NONE as libc::c_int
            }
        }
    ...
    req.ifr_ifru.ifru_data = &mut ts_config as *mut hwtstamp_config as *mut libc::c_char;
    if ioctl(
        sock_fd,
        0x89b0 as libc::c_int as libc::c_ulong,
        &mut req as *mut ifreq,
    ) != 0
    {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"ioctl(%s) failed : %s\x00" as *const u8 as *const libc::c_char,
                b"SIOCSHWTSTAMP\x00" as *const u8 as *const libc::c_char,
                strerror(*__errno_location()),
            );
        }
        ...
        if ioctl(
            sock_fd,
            0x89b1 as libc::c_int as libc::c_ulong,
            &mut req as *mut ifreq,
        ) != 0
            || ts_config.tx_type != HWTSTAMP_TX_ON as libc::c_int
            || ts_config.rx_filter != rx_filter
    ...
    (*iface).clock = HCL_CreateInstance(
        (*conf_iface).min_samples,
        (*conf_iface).max_samples,
        UTI_Log2ToDouble(if (*conf_iface).minpoll > -(6 as libc::c_int) {
            (*conf_iface).minpoll
        } else {
            -(6 as libc::c_int)
        }),
    ...
    LOG_Message(
        LOGS_INFO,
        b"Enabled HW timestamping %son %s\x00" as *const u8 as *const libc::c_char,
...
/* ================================================== */
unsafe extern "C" fn add_all_interfaces(mut conf_iface_all: *mut CNF_HwTsInterface) -> libc::c_int {
    let mut conf_iface: CNF_HwTsInterface = CNF_HwTsInterface {
    ...
    if getifaddrs(&mut ifaddr) != 0 {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"getifaddrs() failed : %s\x00" as *const u8 as *const libc::c_char,
                strerror(*__errno_location()),
            );
        }
        return 0 as libc::c_int;
    ...
    while !ifa.is_null() {
        ...
        if add_interface(&mut conf_iface) != 0 {
            r = 1 as libc::c_int
        }
        ifa = (*ifa).ifa_next
    }
...
unsafe extern "C" fn update_interface_speed(mut iface: *mut Interface) {
    let mut cmd: ethtool_cmd = ethtool_cmd {
        cmd: 0,
        supported: 0,
        advertising: 0,
        speed: 0,
    ...
    memset(
        &mut cmd as *mut ethtool_cmd as *mut libc::c_void,
        0 as libc::c_int,
    ...
    req.ifr_ifru.ifru_data = &mut cmd as *mut ethtool_cmd as *mut libc::c_char;
    if ioctl(
        sock_fd,
        0x8946 as libc::c_int as libc::c_ulong,
        &mut req as *mut ifreq,
    ...
    if (*iface).link_speed != link_speed {
        ...
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"Updated speed of %s to %d Mb/s\x00" as *const u8 as *const libc::c_char,
                (*iface).name.as_mut_ptr(),
                link_speed,
            );
        }
...
/* ================================================== */
unsafe extern "C" fn check_timestamping_option(mut option: libc::c_int) -> libc::c_int {
    let mut sock_fd: libc::c_int = 0;
    sock_fd = SCK_OpenUdpSocket(0 as *mut IPSockAddr, 0 as *mut IPSockAddr, 0 as libc::c_int);
    if sock_fd < 0 as libc::c_int {
        return 0 as libc::c_int;
    }
    if SCK_SetIntOption(sock_fd, 1 as libc::c_int, 37 as libc::c_int, option) == 0 {
        SCK_CloseSocket(sock_fd);
        return 0 as libc::c_int;
    }
    SCK_CloseSocket(sock_fd);
...
unsafe extern "C" fn open_dummy_socket() -> libc::c_int {
    ...
    if NIO_Linux_SetTimestampSocketOptions(sock_fd, 1 as libc::c_int, &mut events) == 0 {
        SCK_CloseSocket(sock_fd);
        return -(3 as libc::c_int);
    }
    return sock_fd;
...
pub unsafe extern "C" fn NIO_Linux_Initialise() {
    ...
    interfaces =
        ARR_CreateInstance(::std::mem::size_of::<Interface>() as libc::c_ulong as libc::c_uint);
    ...
    while CNF_GetHwTsInterface(i, &mut conf_iface) != 0 {
        ...
        ) == 0)
        {
            if add_interface(conf_iface) == 0 {
                LOG_Message(
                    LOGS_FATAL,
                    b"Could not enable HW timestamping on %s\x00" as *const u8
    ...
    while CNF_GetHwTsInterface(i, &mut conf_iface) != 0 {
        ...
        ) != 0
        {
            ...
            if add_all_interfaces(conf_iface) != 0 {
                hwts = 1 as libc::c_int
            }
            break;
        }
    ...
    ts_flags =
        SOF_TIMESTAMPING_SOFTWARE as libc::c_int | SOF_TIMESTAMPING_RX_SOFTWARE as libc::c_int;
    ts_tx_flags = SOF_TIMESTAMPING_TX_SOFTWARE as libc::c_int;
    if hwts != 0 {
        ts_flags |= SOF_TIMESTAMPING_RAW_HARDWARE as libc::c_int
            | SOF_TIMESTAMPING_RX_HARDWARE as libc::c_int;
        ts_tx_flags |= SOF_TIMESTAMPING_TX_HARDWARE as libc::c_int;
        if check_timestamping_option(SOF_TIMESTAMPING_OPT_PKTINFO as libc::c_int) != 0 {
            ts_flags |= SOF_TIMESTAMPING_OPT_PKTINFO as libc::c_int
        }
        if check_timestamping_option(SOF_TIMESTAMPING_OPT_TX_SWHW as libc::c_int) != 0 {
    ...
    permanent_ts_options =
        (SYS_Linux_CheckKernelVersion(4 as libc::c_int, 7 as libc::c_int) == 0) as libc::c_int;
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NIO_Linux_SetTimestampSocketOptions(
    mut sock_fd: libc::c_int,
    mut client_only: libc::c_int,
    mut events: *mut libc::c_int,
) -> libc::c_int {
    ...
    val = 1 as libc::c_int;
    flags = ts_flags;
    if client_only != 0 || permanent_ts_options != 0 {
        flags |= ts_tx_flags
    }
    if SCK_SetIntOption(sock_fd, 1 as libc::c_int, 45 as libc::c_int, val) == 0 {
        ts_flags = 0 as libc::c_int;
        return 0 as libc::c_int;
    }
    if SCK_SetIntOption(sock_fd, 1 as libc::c_int, 37 as libc::c_int, flags) == 0 {
        ts_flags = 0 as libc::c_int;
        return 0 as libc::c_int;
    }
...
unsafe extern "C" fn resume_socket(mut sock_fd: libc::c_int) {
    ...
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"Resumed RX processing %s timeout fd=%d\x00" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn suspend_socket(mut sock_fd: libc::c_int) {
    ...
    SCH_SetFileHandlerEvent(suspended_socket, 1 as libc::c_int, 0 as libc::c_int);
    resume_timeout_id = SCH_AddTimeoutByDelay(
        200.0e-6f64,
        Some(resume_timeout as unsafe extern "C" fn(_: *mut libc::c_void) -> ()),
        0 as *mut libc::c_void,
    );
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"Suspended RX processing fd=%d\x00" as *const u8 as *const libc::c_char,
            sock_fd,
        );
    };
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NIO_Linux_ProcessEvent(
    mut sock_fd: libc::c_int,
...
/* ================================================== */
unsafe extern "C" fn get_interface(mut if_index: libc::c_int) -> *mut Interface {
    let mut iface: *mut Interface = 0 as *mut Interface;
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < ARR_GetSize(interfaces) {
...
/* ================================================== */
unsafe extern "C" fn process_hw_timestamp(
    mut iface: *mut Interface,
    mut hw_ts: *mut timespec,
    mut local_ts: *mut NTP_Local_Timestamp,
    mut rx_ntp_length: libc::c_int,
    mut family: libc::c_int,
    mut l2_length: libc::c_int,
) {
    let mut sample_phc_ts: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    let mut sample_sys_ts: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    let mut sample_local_ts: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    ...
    if HCL_NeedsNewSample((*iface).clock, &mut (*local_ts).ts) != 0 {
        ...
        LCL_CookTime(&mut sample_sys_ts, &mut sample_local_ts, &mut local_err);
    ...
    if rx_ntp_length != 0 && (*iface).link_speed != 0 {
        if l2_length == 0 {
            l2_length = (if family == 1 as libc::c_int {
        ...
        rx_correction = l2_length as libc::c_double
    ...
    if fabs(ts_delay) > 1.0f64 {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"Unacceptable timestamp delay %.9f\x00" as *const u8 as *const libc::c_char,
                ts_delay,
            );
        }
        return;
...
unsafe extern "C" fn extract_udp_data(
    ...
    while len >= 4 as libc::c_int
        && *msg.offset(0 as libc::c_int as isize) as libc::c_int == 0x81 as libc::c_int
        && *msg.offset(1 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int
    {
        len -= 4 as libc::c_int;
    ...
    if len < 2 as libc::c_int
        || !(*msg.offset(0 as libc::c_int as isize) as libc::c_int == 0x8 as libc::c_int
            && *msg.offset(1 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int
            || *msg.offset(0 as libc::c_int as isize) as libc::c_int == 0x86 as libc::c_int
                && *msg.offset(1 as libc::c_int as isize) as libc::c_int == 0xdd as libc::c_int)
    {
        return 0 as libc::c_int;
    }
    len -= 2 as libc::c_int;
    ...
    if len >= 20 as libc::c_int
        && *msg.offset(0 as libc::c_int as isize) as libc::c_int >> 4 as libc::c_int
            == 4 as libc::c_int
    {
        let mut ihl: libc::c_int = (*msg.offset(0 as libc::c_int as isize) as libc::c_int
            & 0xf as libc::c_int)
            * 4 as libc::c_int;
        let mut addr: uint32_t = 0;
        if len < ihl + 8 as libc::c_int
            || *msg.offset(9 as libc::c_int as isize) as libc::c_int != 17 as libc::c_int
        {
            return 0 as libc::c_int;
        }
        memcpy(
            &mut addr as *mut uint32_t as *mut libc::c_void,
            msg.offset(16 as libc::c_int as isize) as *const libc::c_void,
            ::std::mem::size_of::<uint32_t>() as libc::c_ulong,
        );
        (*remote_addr).ip_addr.addr.in4 = ntohl(addr);
        (*remote_addr).port =
            ntohs(*(msg.offset(ihl as isize).offset(2 as libc::c_int as isize) as *mut uint16_t));
            ...
            == 6 as libc::c_int
    {
        ...
        let mut next_header: libc::c_int = *msg.offset(6 as libc::c_int as isize) as libc::c_int;
        memcpy(
            &mut (*remote_addr).ip_addr.addr.in6 as *mut [uint8_t; 16] as *mut libc::c_void,
        ...
        while next_header != 17 as libc::c_int {
            ...
            match next_header {
                44 => {
                    ...
                    if ntohs(*(msg.offset(2 as libc::c_int as isize) as *mut uint16_t))
                        as libc::c_int
                        >> 3 as libc::c_int
                        != 0 as libc::c_int
                    {
            ...
            match current_block_25 {
                ...
                {
                    eh_len = 8 as libc::c_int
                        * (*msg.offset(1 as libc::c_int as isize) as libc::c_int + 1 as libc::c_int)
                }
                _ => {}
            }
            ...
            next_header = *msg.offset(0 as libc::c_int as isize) as libc::c_int;
            len -= eh_len;
            msg = msg.offset(eh_len as isize)
        }
        (*remote_addr).port = ntohs(*(msg.offset(2 as libc::c_int as isize) as *mut uint16_t));
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NIO_Linux_ProcessMessage(
    ...
    if UTI_IsZeroTimespec(&mut (*message).timestamp.hw) == 0 {
        ...
        if !iface.is_null() {
            process_hw_timestamp(
                ...
                (*message).remote_addr.ip.ip_addr.family as libc::c_int,
                l2_length,
            );
            ...
            && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int
        {
            LOG_Message(
                LOGS_DEBUG,
                b"HW clock not found for interface %d\x00" as *const u8 as *const libc::c_char,
                ts_if_index,
            );
        }
    ...
    if (*local_ts).source as libc::c_uint == NTP_TS_DAEMON as libc::c_int as libc::c_uint
        && UTI_IsZeroTimespec(&mut (*message).timestamp.kernel) == 0
        && (is_tx == 0 || UTI_IsZeroTimespec(&mut (*message).timestamp.hw) != 0)
    {
        LCL_CookTime(
            &mut (*message).timestamp.kernel,
            &mut (*local_ts).ts,
            &mut (*local_ts).err,
        );
    ...
    if is_tx == 0
        && (*local_ts).source as libc::c_uint == NTP_TS_DAEMON as libc::c_int as libc::c_uint
        && ts_flags != 0
    {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"Missing kernel RX timestamp\x00" as *const u8 as *const libc::c_char,
            );
        }
        if dummy_rxts_socket == -(3 as libc::c_int) {
    ...
    (*message).length = extract_udp_data(
        (*message).data as *mut libc::c_uchar,
    ...
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"Extracted message for %s fd=%d len=%u\x00" as *const u8 as *const libc::c_char,
    ...
    if !iface.is_null() && (*message).length != 0 {
        if (*message).remote_addr.ip.ip_addr.family as libc::c_int == 1 as libc::c_int {
            (*iface).l2_udp4_ntp_start =
                (l2_length as libc::c_uint).wrapping_sub((*message).length) as libc::c_int
        } else if (*message).remote_addr.ip.ip_addr.family as libc::c_int == 2 as libc::c_int {
            (*iface).l2_udp6_ntp_start =
                (l2_length as libc::c_uint).wrapping_sub((*message).length) as libc::c_int
        }
    }
    ...
    if (*local_ts).source as libc::c_uint == NTP_TS_DAEMON as libc::c_int as libc::c_uint {
        if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(
                LOGS_DEBUG,
                b"Missing TX timestamp\x00" as *const u8 as *const libc::c_char,
            );
        }
        return 1 as libc::c_int;
    }
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NIO_Linux_RequestTxTimestamp(
    mut message: *mut SCK_Message,
    mut sock_fd: libc::c_int,
) {
    if ts_flags == 0 {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn NIO_Linux_NotifySocketClosing(mut sock_fd: libc::c_int) {
