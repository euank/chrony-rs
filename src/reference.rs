  ...
  */
   ...
   safe to use if start and end are the same */
    ...
    fn UTI_OpenFile(basedir: *const libc::c_char, name: *const libc::c_char,
                    suffix: *const libc::c_char, mode_0: libc::c_char,
                    perm: mode_t) -> *mut FILE;
    #[no_mangle]
    fn UTI_RenameTempFile(basedir: *const libc::c_char,
                          name: *const libc::c_char,
                          old_suffix: *const libc::c_char,
                          new_suffix: *const libc::c_char) -> libc::c_int;
   ...
   generating long-term keys */
    ...
    #[no_mangle]
    fn CNF_GetMakeStep(limit: *mut libc::c_int,
                       threshold: *mut libc::c_double);
    #[no_mangle]
    fn CNF_GetMaxChange(delay: *mut libc::c_int, ignore: *mut libc::c_int,
                        offset: *mut libc::c_double);
    #[no_mangle]
    fn CNF_GetLogChange() -> libc::c_double;
    #[no_mangle]
    fn CNF_GetMailOnChange(enabled: *mut libc::c_int,
                           threshold: *mut libc::c_double,
    ...
    #[no_mangle]
    fn CNF_AllowLocalReference(stratum: *mut libc::c_int,
                               orphan: *mut libc::c_int,
                               distance: *mut libc::c_double) -> libc::c_int;
    #[no_mangle]
 ...
 **********************************************************************
  ...
  */
   ...
   (i.e. 'cooked' - 'raw') (in seconds). */
    #[no_mangle]
    fn LCL_GetOffsetCorrection(raw: *mut timespec,
   ...
   a slew, in one easy step */
    #[no_mangle]
    fn LCL_AccumulateFrequencyAndOffset(dfreq: libc::c_double,
   ...
   applications to know if the system clock is synchronised and error bounds */
    #[no_mangle]
    fn LCL_SetSyncStatus(synchronised: libc::c_int, est_error: libc::c_double,
...
static mut local_ref_time: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
...
static mut our_ref_ip: IPAddr =
    IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
static mut our_ref_time: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
...
static mut mail_change_user: *mut libc::c_char =
...
static mut leap_tzname: *mut libc::c_char =
    0 as *const libc::c_char as *mut libc::c_char;
/* ================================================== */
...
static mut last_ref_update: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
...
unsafe extern "C" fn handle_slew(mut raw: *mut timespec,
    ...
    if UTI_IsZeroTimespec(&mut our_ref_time) == 0 {
        UTI_AdjustTimespec(&mut our_ref_time, cooked, &mut our_ref_time,
    ...
    if change_type as libc::c_uint ==
        ...
        UTI_AdjustTimespec(&mut last_ref_update, cooked, &mut last_ref_update,
                           &mut delta, dfreq, doffset);
    }
    ...
    if change_type as libc::c_uint !=
           ...
           our_leap_sec != 0 && leap_in_progress == 0 {
...
pub unsafe extern "C" fn REF_Initialise() {
    ...
    if !drift_file.is_null() {
        in_0 =
            UTI_OpenFile(0 as *const libc::c_char, drift_file,
                         0 as *const libc::c_char, 'r' as i32 as libc::c_char,
                         0 as libc::c_int as mode_t);
        if !in_0.is_null() {
            if fscanf(in_0, b"%lf%lf\x00" as *const u8 as *const libc::c_char,
                ...
                if our_skew < 1.0e-12f64 { our_skew = 1.0e-12f64 }
                LOG_Message(LOGS_INFO,
                            b"Frequency %.3f +/- %.3f ppm read from %s\x00" as
                                *const u8 as *const libc::c_char,
                            file_freq_ppm, file_skew_ppm, drift_file);
                LCL_SetAbsoluteFrequency(our_frequency_ppm);
            } else {
                LOG_Message(LOGS_WARN,
                            b"Could not read valid frequency and skew from driftfile %s\x00"
    ...
    if our_frequency_ppm == 0.0f64 {
        ...
        if our_frequency_ppm != 0.0f64 {
            LOG_Message(LOGS_INFO,
                        b"Initial frequency %.3f ppm\x00" as *const u8 as
                            *const libc::c_char, our_frequency_ppm);
        }
    }
    logfileid =
        if CNF_GetLogTracking() != 0 {
    ...
    enable_local_stratum =
        CNF_AllowLocalReference(&mut local_stratum, &mut local_orphan,
                                &mut local_distance);
    ...
    if leap_mode as libc::c_uint ==
           REF_LeapModeSystem as libc::c_int as libc::c_uint &&
           LCL_CanSystemLeap() == 0 {
    ...
    if !leap_tzname.is_null() {
        ...
        if get_tz_leap(1341014400 as libc::c_int as time_t, &mut tai_offset)
               as libc::c_uint ==
               LEAP_InsertSecond as libc::c_int as libc::c_uint &&
               tai_offset == 34 as libc::c_int &&
               get_tz_leap(1356912000 as libc::c_int as time_t,
                           &mut tai_offset) as libc::c_uint ==
                   LEAP_Normal as libc::c_int as libc::c_uint &&
               tai_offset == 35 as libc::c_int {
            LOG_Message(LOGS_INFO,
                        b"Using %s timezone to obtain leap second data\x00" as
                            *const u8 as *const libc::c_char, leap_tzname);
        } else {
            LOG_Message(LOGS_WARN,
                        b"Timezone %s failed leap second check, ignoring\x00"
                            as *const u8 as *const libc::c_char, leap_tzname);
            leap_tzname = 0 as *mut libc::c_char
        }
    }
    CNF_GetMakeStep(&mut make_step_limit, &mut make_step_threshold);
    CNF_GetMaxChange(&mut max_offset_delay, &mut max_offset_ignore,
                     &mut max_offset);
    CNF_GetMailOnChange(&mut do_mail_change, &mut mail_change_threshold,
    ...
    if fb_drift_max >= fb_drift_min && fb_drift_min > 0 as libc::c_int {
        fb_drifts =
            Malloc2((fb_drift_max - fb_drift_min + 1 as libc::c_int) as
                        size_t,
                    ::std::mem::size_of::<fb_drift>() as libc::c_ulong) as
                *mut fb_drift;
        memset(fb_drifts as *mut libc::c_void, 0 as libc::c_int,
               (::std::mem::size_of::<fb_drift>() as
                    libc::c_ulong).wrapping_mul((fb_drift_max - fb_drift_min +
                                                     1 as libc::c_int) as
                                                    libc::c_ulong));
...
pub unsafe extern "C" fn REF_Finalise() {
    update_leap_status(LEAP_Unsynchronised, 0 as libc::c_int as time_t,
                       0 as libc::c_int);
    if !drift_file.is_null() {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_GetMode() -> REF_Mode { return mode; }
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_SetModeEndHandler(mut handler:
                                                   REF_ModeEndHandler) {
...
unsafe extern "C" fn update_drift_file(mut freq_ppm: libc::c_double,
    ...
    fprintf(out, b"%20.6f %20.6f\n\x00" as *const u8 as *const libc::c_char,
            freq_ppm, 1.0e6f64 * skew);
    fclose(out);
    /* Rename the temporary file to the correct location */
    (UTI_RenameTempFile(0 as *const libc::c_char, drift_file,
                        b".tmp\x00" as *const u8 as *const libc::c_char,
                        0 as *const libc::c_char)) == 0;
}
/* ================================================== */
unsafe extern "C" fn update_fb_drifts(mut freq_ppm: libc::c_double,
                                      mut update_interval: libc::c_double) {
    let mut i: libc::c_int = 0;
    let mut secs: libc::c_int = 0;
    if are_we_synchronised != 0 {
    } else {
        __assert_fail(b"are_we_synchronised\x00" as *const u8 as
                          *const libc::c_char,
                      b"reference.c\x00" as *const u8 as *const libc::c_char,
                      362 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 38],
                                                &[libc::c_char; 38]>(b"void update_fb_drifts(double, double)\x00")).as_ptr());
    }
    if next_fb_drift > 0 as libc::c_int { next_fb_drift = 0 as libc::c_int }
    SCH_RemoveTimeout(fb_drift_timeout_id);
    fb_drift_timeout_id = 0 as libc::c_int as SCH_TimeoutID;
    if update_interval < 1.0f64 ||
           update_interval > last_ref_update_interval * 4.0f64 {
        return
    }
    i = 0 as libc::c_int;
    while i < fb_drift_max - fb_drift_min + 1 as libc::c_int {
        ...
        if 0 as libc::c_int != 0 &&
            ...
            LOG_Message(LOGS_DEBUG,
                        b"Fallback drift %d updated: %f ppm %f seconds\x00" as
                            *const u8 as *const libc::c_char,
                        i + fb_drift_min,
                        (*fb_drifts.offset(i as isize)).freq,
                        (*fb_drifts.offset(i as isize)).secs);
...
unsafe extern "C" fn fb_drift_timeout(mut arg: *mut libc::c_void) {
    if next_fb_drift >= fb_drift_min && next_fb_drift <= fb_drift_max {
        ...
        __assert_fail(b"next_fb_drift >= fb_drift_min && next_fb_drift <= fb_drift_max\x00"
                          as *const u8 as *const libc::c_char,
                      b"reference.c\x00" as *const u8 as *const libc::c_char,
                      405 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 30],
                                                &[libc::c_char; 30]>(b"void fb_drift_timeout(void *)\x00")).as_ptr());
    }
    fb_drift_timeout_id = 0 as libc::c_int as SCH_TimeoutID;
    if 0 as libc::c_int != 0 &&
           log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(LOGS_DEBUG,
                    b"Fallback drift %d active: %f ppm\x00" as *const u8 as
                        *const libc::c_char, next_fb_drift,
                    (*fb_drifts.offset((next_fb_drift - fb_drift_min) as
                                           isize)).freq);
    }
    LCL_SetAbsoluteFrequency((*fb_drifts.offset((next_fb_drift - fb_drift_min)
                                                    as isize)).freq);
    REF_SetUnsynchronised();
}
/* ================================================== */
unsafe extern "C" fn schedule_fb_drift(mut now: *mut timespec) {
    ...
    if fb_drift_timeout_id != 0 { return }
    ...
    while i <= fb_drift_max {
        ...
        if !((*fb_drifts.offset((i - fb_drift_min) as isize)).secs <
                 secs as libc::c_double) {
    ...
    if c > next_fb_drift {
        LCL_SetAbsoluteFrequency((*fb_drifts.offset((c - fb_drift_min) as
                                                        isize)).freq);
        next_fb_drift = c;
        if 0 as libc::c_int != 0 &&
               log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(LOGS_DEBUG,
                        b"Fallback drift %d set\x00" as *const u8 as
                            *const libc::c_char, c);
        }
    }
    if i <= fb_drift_max {
        next_fb_drift = i;
        UTI_AddDoubleToTimespec(now, secs as libc::c_double - unsynchronised,
                                &mut when);
        fb_drift_timeout_id =
            SCH_AddTimeout(&mut when,
                           Some(fb_drift_timeout as
                                    unsafe extern "C" fn(_: *mut libc::c_void)
                                        -> ()), 0 as *mut libc::c_void);
        if 0 as libc::c_int != 0 &&
               log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(LOGS_DEBUG,
                        b"Fallback drift %d scheduled\x00" as *const u8 as
                            *const libc::c_char, i);
        }
    };
}
...
/* ================================================== */
unsafe extern "C" fn maybe_log_offset(mut offset: libc::c_double,
                                      mut now: time_t) {
    ...
    if abs_offset > log_change_threshold {
        LOG_Message(LOGS_WARN,
                    b"System clock wrong by %.6f seconds, adjustment started\x00"
    ...
    if do_mail_change != 0 && abs_offset > mail_change_threshold {
        snprintf(buffer.as_mut_ptr(),
                 ...
                 b"/usr/lib/sendmail\x00" as *const u8 as
                     *const libc::c_char);
        p =
            popen(buffer.as_mut_ptr(),
                  b"w\x00" as *const u8 as *const libc::c_char);
        if !p.is_null() {
            if gethostname(host.as_mut_ptr(),
                           ::std::mem::size_of::<[libc::c_char; 255]>() as
                               libc::c_ulong) < 0 as libc::c_int {
                strcpy(host.as_mut_ptr(),
                       b"<UNKNOWN>\x00" as *const u8 as *const libc::c_char);
            }
            host[(::std::mem::size_of::<[libc::c_char; 255]>() as
            ...
            if !tm.is_null() {
                strftime(buffer.as_mut_ptr(),
                         ...
                         b"On %A, %d %B %Y\n  with the system clock reading %H:%M:%S (%Z)\x00"
                             as *const u8 as *const libc::c_char, tm);
...
/* ================================================== */
unsafe extern "C" fn is_step_limit_reached(mut offset: libc::c_double,
                                           mut offset_correction:
                                               libc::c_double)
 -> libc::c_int {
    if make_step_limit == 0 as libc::c_int {
        return 0 as libc::c_int
    } else { if make_step_limit > 0 as libc::c_int { make_step_limit -= 1 } }
    return (fabs(offset - offset_correction) > make_step_threshold) as
               libc::c_int;
}
/* ================================================== */
unsafe extern "C" fn is_offset_ok(mut offset: libc::c_double) -> libc::c_int {
    if max_offset_delay < 0 as libc::c_int { return 1 as libc::c_int }
...
unsafe extern "C" fn is_leap_second_day(mut when: time_t) -> libc::c_int {
    ...
    stm = gmtime(&mut when);
    if stm.is_null() { return 0 as libc::c_int }
    /* Allow leap second only on the last day of June and December */
    return ((*stm).tm_mon == 5 as libc::c_int &&
                (*stm).tm_mday == 30 as libc::c_int ||
                (*stm).tm_mon == 11 as libc::c_int &&
                    (*stm).tm_mday == 31 as libc::c_int) as libc::c_int;
}
/* ================================================== */
/* ================================================== */
unsafe extern "C" fn get_tz_leap(mut when: time_t,
                                 mut tai_offset: *mut libc::c_int)
 -> NTP_Leap {
    ...
    *tai_offset = tz_tai_offset;
    ...
    when =
        when / (12 as libc::c_int * 3600 as libc::c_int) as libc::c_long *
            (12 as libc::c_int * 3600 as libc::c_int) as libc::c_long;
    if last_tz_leap_check == when { return tz_leap }
    last_tz_leap_check = when;
    tz_leap = LEAP_Normal;
    tz_tai_offset = 0 as libc::c_int;
    tm = gmtime(&mut when);
    if tm.is_null() { return tz_leap }
    stm = *tm;
    ...
    setenv(b"TZ\x00" as *const u8 as *const libc::c_char, leap_tzname,
           1 as libc::c_int);
    tzset();
    ...
    if t != -(1 as libc::c_int) as libc::c_long {
        tz_tai_offset =
            (t - when + 10 as libc::c_int as libc::c_long) as libc::c_int
    }
    ...
    t = mktime(&mut stm);
    if !tz_env.is_null() {
        setenv(b"TZ\x00" as *const u8 as *const libc::c_char,
               tz_orig.as_mut_ptr(), 1 as libc::c_int);
    } else { unsetenv(b"TZ\x00" as *const u8 as *const libc::c_char); }
    tzset();
    if t == -(1 as libc::c_int) as libc::c_long { return tz_leap }
    if stm.tm_sec == 60 as libc::c_int {
        tz_leap = LEAP_InsertSecond
    } else if stm.tm_sec == 1 as libc::c_int { tz_leap = LEAP_DeleteSecond }
    *tai_offset = tz_tai_offset;
    return tz_leap;
}
/* ================================================== */
unsafe extern "C" fn leap_end_timeout(mut arg: *mut libc::c_void) {
    leap_timeout_id = 0 as libc::c_int as SCH_TimeoutID;
    leap_in_progress = 0 as libc::c_int;
    if our_tai_offset != 0 { our_tai_offset += our_leap_sec }
    our_leap_sec = 0 as libc::c_int;
    if leap_mode as libc::c_uint ==
           REF_LeapModeSystem as libc::c_int as libc::c_uint {
        LCL_SetSystemLeap(our_leap_sec, our_tai_offset);
    }
    if our_leap_status as libc::c_uint ==
           LEAP_InsertSecond as libc::c_int as libc::c_uint ||
    ...
    match leap_mode as libc::c_uint {
        0 => {
            if 0 as libc::c_int != 0 &&
                ...
                LOG_Message(LOGS_DEBUG,
                            b"Waiting for system clock leap second correction\x00"
                                as *const u8 as *const libc::c_char);
            }
        }
        1 => {
            ...
            LOG_Message(LOGS_WARN,
                        b"Adjusting system clock for leap second\x00" as
                            *const u8 as *const libc::c_char);
        }
        2 => {
            LCL_NotifyLeap(our_leap_sec);
            ...
            LOG_Message(LOGS_WARN,
                        b"System clock was stepped for leap second\x00" as
                            *const u8 as *const libc::c_char);
        }
        3 => {
            LOG_Message(LOGS_WARN,
                        b"Ignoring leap second\x00" as *const u8 as
                            *const libc::c_char);
        }
        _ => { }
    }
...
unsafe extern "C" fn set_leap_timeout(mut now: time_t) {
    ...
    leap_timeout_id =
        SCH_AddTimeout(&mut when,
                       Some(leap_start_timeout as
                                unsafe extern "C" fn(_: *mut libc::c_void)
                                    -> ()), 0 as *mut libc::c_void);
}
/* ================================================== */
unsafe extern "C" fn update_leap_status(mut leap: NTP_Leap, mut now: time_t,
    ...
    if (leap_sec != our_leap_sec || tai_offset != our_tai_offset) &&
        ...
        match leap_mode as libc::c_uint {
            ...
            1 | 2 | 3 => { current_block_22 = 3989310813288763114; }
            _ => {
                __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                              b"reference.c\x00" as *const u8 as
                                  *const libc::c_char,
                              779 as libc::c_int as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 47],
                                                        &[libc::c_char; 47]>(b"void update_leap_status(NTP_Leap, time_t, int)\x00")).as_ptr());
    ...
    } else if reset != 0 { set_leap_timeout(now); }
    our_leap_status = leap;
}
/* ================================================== */
unsafe extern "C" fn get_root_dispersion(mut ts: *mut timespec)
 -> libc::c_double {
    if UTI_IsZeroTimespec(&mut our_ref_time) != 0 { return 1.0f64 }
    return our_root_dispersion +
               fabs(UTI_DiffTimespecsToDouble(ts, &mut our_ref_time)) *
                   (our_skew + fabs(our_residual_freq) +
                        LCL_GetMaxClockError());
}
/* ================================================== */
unsafe extern "C" fn write_log(mut now: *mut timespec,
    ...
    if logfileid == -(1 as libc::c_int) { return }
    ...
    LOG_FileWrite(logfileid,
                  ...
                  } else { UTI_RefidToString(our_ref_id) }, our_stratum, freq,
                  1.0e6f64 * our_skew, offset,
                  leap_codes[our_leap_status as usize] as libc::c_int,
                  combined_sources, offset_sd, uncorrected_offset,
                  our_root_delay, root_dispersion, max_error);
}
/* ================================================== */
unsafe extern "C" fn special_mode_sync(mut valid: libc::c_int,
                                       mut offset: libc::c_double) {
    ...
    match mode as libc::c_uint {
        1 => {
            if valid == 0 {
                LOG_Message(LOGS_WARN,
                            b"No suitable source for initstepslew\x00" as
                                *const u8 as *const libc::c_char);
                end_ref_mode(0 as libc::c_int);
            } else {
                step =
                    (fabs(offset) >= CNF_GetInitStepThreshold()) as
                        libc::c_int;
                LOG_Message(LOGS_INFO,
                            b"System\'s initial offset : %.6f seconds %s of true (%s)\x00"
                                as *const u8 as *const libc::c_char,
                            fabs(offset),
                            ...
                            if step != 0 {
                                b"step\x00" as *const u8 as
                                    *const libc::c_char
                            } else {
                                b"slew\x00" as *const u8 as
                                    *const libc::c_char
                            });
                if step != 0 {
                    LCL_ApplyStepOffset(offset);
                } else { LCL_AccumulateOffset(offset, 0.0f64); }
        ...
        2 | 3 => {
            if valid == 0 {
                LOG_Message(LOGS_WARN,
                            b"No suitable source for synchronisation\x00" as
                                *const u8 as *const libc::c_char);
                end_ref_mode(0 as libc::c_int);
            } else {
                step =
                    (mode as libc::c_uint ==
                         REF_ModeUpdateOnce as libc::c_int as libc::c_uint) as
                        libc::c_int;
                LOG_Message(LOGS_INFO,
                            b"System clock wrong by %.6f seconds (%s)\x00" as
                                *const u8 as *const libc::c_char, -offset,
                            if step != 0 {
                                b"step\x00" as *const u8 as
                                    *const libc::c_char
                            } else {
                ...
                if step != 0 { LCL_ApplyStepOffset(offset); }
                end_ref_mode(1 as libc::c_int);
            }
        }
        4 => { }
        _ => {
            __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                          ...
                          (*::std::mem::transmute::<&[u8; 36],
                                                    &[libc::c_char; 36]>(b"void special_mode_sync(int, double)\x00")).as_ptr());
        }
    };
}
/* ================================================== */
unsafe extern "C" fn get_clock_estimates(mut manual: libc::c_int,
    ...
    if manual != 0 {
        ...
        if 0 as libc::c_int != 0 &&
               log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(LOGS_DEBUG,
                        b"Skew %f too large to track\x00" as *const u8 as
                            *const libc::c_char, measured_skew);
        }
        gain = 0.0f64
    } else {
        gain =
            3.0f64 * (expected_skew * expected_skew) /
                (3.0f64 * (expected_skew * expected_skew) +
                     measured_skew * measured_skew)
    }
    gain =
        if 0.0f64 > (if gain < 1.0f64 { gain } else { 1.0f64 }) {
            0.0f64
        } else if gain < 1.0f64 { gain } else { 1.0f64 };
    *estimated_freq = expected_freq + gain * (measured_freq - expected_freq);
    *residual_freq = measured_freq - *estimated_freq;
    extra_skew =
        sqrt((expected_freq - *estimated_freq) *
                 (expected_freq - *estimated_freq) * (1.0f64 - gain) +
                 (measured_freq - *estimated_freq) *
                     (measured_freq - *estimated_freq) * gain);
    *estimated_skew =
        expected_skew + gain * (measured_skew - expected_skew) + extra_skew;
}
/* ================================================== */
unsafe extern "C" fn fuzz_ref_time(mut ts: *mut timespec) {
    ...
    UTI_GetRandomBytes(&mut rnd as *mut uint32_t as *mut libc::c_void,
                       ::std::mem::size_of::<uint32_t>() as libc::c_ulong as
                           libc::c_uint);
    UTI_AddDoubleToTimespec(ts,
                            -(rnd as libc::c_double) /
                                -(1 as libc::c_int) as uint32_t as
                                    libc::c_double, ts);
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_SetReference(mut stratum: libc::c_int,
                                          mut leap: NTP_Leap,
                                          mut combined_sources: libc::c_int,
                                          mut ref_id: uint32_t,
    ...
    let mut now: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    let mut raw_now: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    ...
    manual =
        (leap as libc::c_uint ==
             LEAP_Unsynchronised as libc::c_int as libc::c_uint) as
            libc::c_int;
    LCL_ReadRawTime(&mut raw_now);
    LCL_GetOffsetCorrection(&mut raw_now, &mut uncorrected_offset,
    ...
    if last_ref_update.tv_sec != 0 {
        update_interval =
            UTI_DiffTimespecsToDouble(&mut now, &mut last_ref_update);
        update_interval =
            if update_interval > 0.0f64 { update_interval } else { 0.0f64 }
    } else { update_interval = 0.0f64 }
    /* Get new estimates of the frequency and skew including the new data */
    get_clock_estimates(manual, frequency, skew, &mut frequency, &mut skew,
                        &mut residual_frequency);
    if is_offset_ok(offset) == 0 { return }
    orig_root_distance =
    ...
    if !ref_ip.is_null() {
        our_ref_ip = *ref_ip
    } else { our_ref_ip.family = 0 as libc::c_int as uint16_t }
    ...
    correction_rate =
        correction_time_ratio * 0.5f64 * offset_sd * update_interval;
    ...
    } else { accumulate_offset = offset; step_offset = 0.0f64 }
    /* Adjust the clock */
    ...
    if step_offset != 0.0f64 {
        if LCL_ApplyStepOffset(step_offset) != 0 {
            LOG_Message(LOGS_WARN,
                        b"System clock was stepped by %.6f seconds\x00" as
                            *const u8 as *const libc::c_char, -step_offset);
        }
    }
    ...
    write_log(&mut now, combined_sources, local_abs_frequency, offset,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_SetManualReference(mut ref_time: *mut timespec,
                                                mut offset: libc::c_double,
                                                mut frequency: libc::c_double,
                                                mut skew: libc::c_double) {
    ...
    REF_SetReference(0 as libc::c_int, LEAP_Unsynchronised, 1 as libc::c_int,
                     0x4d414e55 as libc::c_ulong as uint32_t,
                     0 as *mut IPAddr, ref_time, offset, 0.0f64, frequency,
                     skew, skew, 0.0f64, 0.0f64);
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_SetUnsynchronised() {
    ...
    let mut now: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    let mut now_raw: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    let mut uncorrected_offset: libc::c_double = 0.;
    if initialised != 0 {
    } else {
        __assert_fail(b"initialised\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 33],
                                                &[libc::c_char; 33]>(b"void REF_SetUnsynchronised(void)\x00")).as_ptr());
    }
    /* Special modes are implemented elsewhere */
    if mode as libc::c_uint != REF_ModeNormal as libc::c_int as libc::c_uint {
    ...
    LCL_GetOffsetCorrection(&mut now_raw, &mut uncorrected_offset,
                            0 as *mut libc::c_double);
    UTI_AddDoubleToTimespec(&mut now_raw, uncorrected_offset, &mut now);
    if !fb_drifts.is_null() { schedule_fb_drift(&mut now); }
    update_leap_status(LEAP_Unsynchronised, 0 as libc::c_int as time_t,
                       0 as libc::c_int);
    ...
    write_log(&mut now, 0 as libc::c_int, LCL_ReadAbsoluteFrequency(), 0.0f64,
              0.0f64, uncorrected_offset,
              our_root_delay / 2.0f64 + get_root_dispersion(&mut now));
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_GetReferenceParams(mut local_time: *mut timespec,
                                                mut is_synchronised:
                                                    *mut libc::c_int,
                                                mut leap_status:
                                                    *mut NTP_Leap,
    ...
    if are_we_synchronised != 0 &&
           !(enable_local_stratum != 0 &&
                 our_root_delay / 2 as libc::c_int as libc::c_double +
                     dispersion > local_distance) {
        *is_synchronised = 1 as libc::c_int;
        *stratum = our_stratum;
        *leap_status =
            if leap_in_progress == 0 {
                our_leap_status as libc::c_uint
            } else { LEAP_Unsynchronised as libc::c_int as libc::c_uint } as
                NTP_Leap;
        *ref_id = our_ref_id;
...
pub unsafe extern "C" fn REF_GetOurStratum() -> libc::c_int {
    let mut now_cooked: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    ...
    let mut root_dispersion: libc::c_double = 0.;
    SCH_GetLastEventTime(&mut now_cooked, 0 as *mut libc::c_double,
                         0 as *mut timespec);
    REF_GetReferenceParams(&mut now_cooked, &mut synchronised,
                           &mut leap_status, &mut stratum, &mut ref_id,
                           &mut ref_time, &mut root_delay,
                           &mut root_dispersion);
    return stratum;
}
/* ================================================== */
...
pub unsafe extern "C" fn REF_GetOrphanStratum() -> libc::c_int {
    if enable_local_stratum == 0 || local_orphan == 0 ||
           mode as libc::c_uint !=
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_GetSkew() -> libc::c_double { return our_skew; }
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_ModifyMaxupdateskew(mut new_max_update_skew:
                                                     libc::c_double) {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_ModifyMakestep(mut limit: libc::c_int,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_EnableLocal(mut stratum: libc::c_int,
    ...
    local_stratum =
        if 1 as libc::c_int >
               (if stratum < 16 as libc::c_int - 1 as libc::c_int {
                    stratum
                } else { (16 as libc::c_int) - 1 as libc::c_int }) {
            1 as libc::c_int
...
pub unsafe extern "C" fn REF_IsLeapSecondClose() -> libc::c_int {
    ...
    let mut now_raw: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    let mut t: time_t = 0;
    if our_leap_sec == 0 { return 0 as libc::c_int }
    ...
    t =
        if now_raw.tv_sec > 0 as libc::c_int as libc::c_long {
            now_raw.tv_sec
        } else { -now_raw.tv_sec };
    if ((t + 5 as libc::c_int as libc::c_long) %
            (24 as libc::c_int * 3600 as libc::c_int) as libc::c_long) <
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_GetTaiOffset(mut ts: *mut timespec)
 -> libc::c_int {
    let mut tai_offset: libc::c_int = 0;
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn REF_GetTrackingReport(mut rep:
                                                   *mut RPT_TrackingReport) {
    let mut now_raw: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    let mut now_cooked: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    let mut correction: libc::c_double = 0.;
    let mut synchronised: libc::c_int = 0;
    LCL_ReadRawTime(&mut now_raw);
    LCL_GetOffsetCorrection(&mut now_raw, &mut correction,
                            0 as *mut libc::c_double);
    UTI_AddDoubleToTimespec(&mut now_raw, correction, &mut now_cooked);
    REF_GetReferenceParams(&mut now_cooked, &mut synchronised,
                           &mut (*rep).leap_status, &mut (*rep).stratum,
                           &mut (*rep).ref_id, &mut (*rep).ref_time,
                           &mut (*rep).root_delay,
