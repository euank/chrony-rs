...
pub unsafe extern "C" fn SYS_Initialise(mut clock_control: libc::c_int) {
    ...
    if null_driver != 0 { SYS_Null_Initialise(); return }
...
pub unsafe extern "C" fn SYS_Finalise() {
    if null_driver != 0 { SYS_Null_Finalise(); return }
    SYS_Linux_Finalise();
}
...
pub unsafe extern "C" fn SYS_EnableSystemCallFilter(mut level: libc::c_int) {
    LOG_Message(LOGS_FATAL,
                b"system call filter not supported\x00" as *const u8 as
                    *const libc::c_char);
    exit(1 as libc::c_int);
}
/* ================================================== */
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn SYS_LockMemory() { SYS_Posix_MemLockAll(); }
/* ================================================== */
