 ...
 */
#[no_mangle]
pub unsafe extern "C" fn RGR_WeightedRegression(
...
#[no_mangle]
pub unsafe extern "C" fn RGR_GetTCoef(mut dof: libc::c_int) -> libc::c_double {
    /* Assuming now the 99.95% quantile */
    static mut coefs: [libc::c_float; 40] = [
        636.6f64 as libc::c_float,
        31.6f64 as libc::c_float,
        12.92f64 as libc::c_float,
        8.61f64 as libc::c_float,
        6.869f64 as libc::c_float,
        5.959f64 as libc::c_float,
        5.408f64 as libc::c_float,
        5.041f64 as libc::c_float,
        4.781f64 as libc::c_float,
        4.587f64 as libc::c_float,
        4.437f64 as libc::c_float,
        4.318f64 as libc::c_float,
        4.221f64 as libc::c_float,
        4.140f64 as libc::c_float,
        4.073f64 as libc::c_float,
        4.015f64 as libc::c_float,
        3.965f64 as libc::c_float,
        3.922f64 as libc::c_float,
        3.883f64 as libc::c_float,
        3.850f64 as libc::c_float,
        3.819f64 as libc::c_float,
        3.792f64 as libc::c_float,
        3.768f64 as libc::c_float,
        3.745f64 as libc::c_float,
        3.725f64 as libc::c_float,
        3.707f64 as libc::c_float,
        3.690f64 as libc::c_float,
        3.674f64 as libc::c_float,
        3.659f64 as libc::c_float,
        3.646f64 as libc::c_float,
        3.633f64 as libc::c_float,
        3.622f64 as libc::c_float,
        3.611f64 as libc::c_float,
        3.601f64 as libc::c_float,
        3.591f64 as libc::c_float,
        3.582f64 as libc::c_float,
        3.574f64 as libc::c_float,
        3.566f64 as libc::c_float,
        3.558f64 as libc::c_float,
        3.551f64 as libc::c_float,
    ];
...
#[no_mangle]
pub unsafe extern "C" fn RGR_GetChi2Coef(mut dof: libc::c_int) -> libc::c_double {
    static mut coefs: [libc::c_float; 64] = [
        2.706f64 as libc::c_float,
        4.605f64 as libc::c_float,
        6.251f64 as libc::c_float,
        7.779f64 as libc::c_float,
        9.236f64 as libc::c_float,
        10.645f64 as libc::c_float,
        12.017f64 as libc::c_float,
        13.362f64 as libc::c_float,
        14.684f64 as libc::c_float,
        15.987f64 as libc::c_float,
        17.275f64 as libc::c_float,
        18.549f64 as libc::c_float,
        19.812f64 as libc::c_float,
        21.064f64 as libc::c_float,
        22.307f64 as libc::c_float,
        23.542f64 as libc::c_float,
        24.769f64 as libc::c_float,
        25.989f64 as libc::c_float,
        27.204f64 as libc::c_float,
        28.412f64 as libc::c_float,
        29.615f64 as libc::c_float,
        30.813f64 as libc::c_float,
        32.007f64 as libc::c_float,
        33.196f64 as libc::c_float,
        34.382f64 as libc::c_float,
        35.563f64 as libc::c_float,
        36.741f64 as libc::c_float,
        37.916f64 as libc::c_float,
        39.087f64 as libc::c_float,
        40.256f64 as libc::c_float,
        41.422f64 as libc::c_float,
        42.585f64 as libc::c_float,
        43.745f64 as libc::c_float,
        44.903f64 as libc::c_float,
        46.059f64 as libc::c_float,
        47.212f64 as libc::c_float,
        48.363f64 as libc::c_float,
        49.513f64 as libc::c_float,
        50.660f64 as libc::c_float,
        51.805f64 as libc::c_float,
        52.949f64 as libc::c_float,
        54.090f64 as libc::c_float,
        55.230f64 as libc::c_float,
        56.369f64 as libc::c_float,
        57.505f64 as libc::c_float,
        58.641f64 as libc::c_float,
        59.774f64 as libc::c_float,
        60.907f64 as libc::c_float,
        62.038f64 as libc::c_float,
        63.167f64 as libc::c_float,
        64.295f64 as libc::c_float,
        65.422f64 as libc::c_float,
        66.548f64 as libc::c_float,
        67.673f64 as libc::c_float,
        68.796f64 as libc::c_float,
        69.919f64 as libc::c_float,
        71.040f64 as libc::c_float,
        72.160f64 as libc::c_float,
        73.279f64 as libc::c_float,
        74.397f64 as libc::c_float,
        75.514f64 as libc::c_float,
        76.630f64 as libc::c_float,
        77.745f64 as libc::c_float,
        78.860f64 as libc::c_float,
    ];
...
/* ================================================== */
unsafe extern "C" fn n_runs_from_residuals(
...
regression */
#[no_mangle]
pub unsafe extern "C" fn RGR_FindBestRegression(
    mut x: *mut libc::c_double,
    mut y: *mut libc::c_double,
    mut w: *mut libc::c_double,
    mut n: libc::c_int,
...
/* degrees of freedom in statistics (needed
    ...
    loop {
        ...
        if nruns > critical_runs[(n - resid_start) as usize] as libc::c_int
            || n - start <= 3 as libc::c_int
            || n - start <= min_samples
        {
            if start != resid_start {
                /* Ignore extra samples in returned nruns */
                nruns = n_runs_from_residuals(
                    resid.as_mut_ptr().offset((start - resid_start) as isize),
                    n - start,
                )
            }
            break;
    ...
    *b0 = a;
    ...
    i = start;
    while i < n {
        ss += resid[(i - resid_start) as usize] * resid[(i - resid_start) as usize]
            / *w.offset(i as isize);
        i += 1
    }
    npoints = n - start;
...
0-521-43108-5). */
unsafe extern "C" fn find_ordered_entry_with_flags(
    mut x: *mut libc::c_double,
    mut n: libc::c_int,
    ...
    loop {
        if v - u < 2 as libc::c_int {
            ...
            *x.offset(pivind as isize) = temp;
            ...
            r = v;
            loop {
                while l < v && *x.offset(l as isize) < piv {
                    l += 1
                }
                while *x.offset(r as isize) > piv {
                    r -= 1
                }
                if r <= l {
                    break;
...
unsafe extern "C" fn find_median(mut x: *mut libc::c_double, mut n: libc::c_int) -> libc::c_double {
    ...
    if n & 1 as libc::c_int != 0 {
        ...
        return 0.5f64
            * (find_ordered_entry_with_flags(x, n, k, flags.as_mut_ptr())
                + find_ordered_entry_with_flags(x, n, k - 1 as libc::c_int, flags.as_mut_ptr()));
    };
}
/* Return the median value from an array */
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn RGR_FindMedian(
    mut x: *mut libc::c_double,
    mut n: libc::c_int,
) -> libc::c_double {
    ...
    if n > 0 as libc::c_int && n <= 64 as libc::c_int {
        ...
        __assert_fail(
            b"n > 0 && n <= MAX_POINTS\x00" as *const u8 as *const libc::c_char,
            b"regress.c\x00" as *const u8 as *const libc::c_char,
            439 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<&[u8; 37], &[libc::c_char; 37]>(
                b"double RGR_FindMedian(double *, int)\x00",
            ))
            .as_ptr(),
        );
    }
    memcpy(
        ...
        (n as libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_double>() as libc::c_ulong),
    );
...
unsafe extern "C" fn eval_robust_residual(
    mut x: *mut libc::c_double,
    mut y: *mut libc::c_double,
    mut n: libc::c_int,
    mut b: libc::c_double,
...
#[no_mangle]
pub unsafe extern "C" fn RGR_FindBestRobustRegression(
    mut x: *mut libc::c_double,
    mut y: *mut libc::c_double,
    mut n: libc::c_int,
...
/* The best starting index */ {
    ...
    if n < 2 as libc::c_int {
        ...
        if n == 2 as libc::c_int {
            ...
            *b1 = (*y.offset(1 as libc::c_int as isize) - *y.offset(0 as libc::c_int as isize))
                / (*x.offset(1 as libc::c_int as isize) - *x.offset(0 as libc::c_int as isize));
            *b0 = *y.offset(0 as libc::c_int as isize) - *b1 * *x.offset(0 as libc::c_int as isize);
    ...
    to fail the number of runs test */
    {
        ...
        on that. */
        sb = sqrt(s2 * W / V); /* fn vals have same sign or one is zero,
        ...
        loop {
            ...
            eval_robust_residual(
                x.offset(start as isize),
                y.offset(start as isize),
                n_points,
                blo,
                &mut a,
                &mut rlo,
        ...
        *b1 = bmid;
        ...
        if n_points == 3 as libc::c_int {
            break;
        }
        i = start;
        while i < n {
            resids[i as usize] = *y.offset(i as isize) - a - bmid * *x.offset(i as isize);
            i += 1
        }
        nruns = n_runs_from_residuals(resids.as_mut_ptr().offset(start as isize), n_points);
        if nruns > critical_runs[n_points as usize] as libc::c_int {
            break;
        }
        start += 1
    }
...
was a solution. */
#[no_mangle]
pub unsafe extern "C" fn RGR_MultipleRegress(
...
/* estimated second slope */
    ...
    U = n as libc::c_double * (Sx1x2 * Sx1y - Sx1x1 * Sx2y) + Sx1 * Sx1 * Sx2y - Sx1 * Sx2 * Sx1y
    ...
    if fabs(V) * 1.0e10f64 <= -V1 + V2 + fabs(V3) {
        return 0 as libc::c_int;
    }
    *b2 = U / V;
    return 1 as libc::c_int;
