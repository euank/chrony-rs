...
pub unsafe extern "C" fn Malloc(mut size: size_t) -> *mut libc::c_void {
    ...
    if r.is_null() && size != 0 {
        LOG_Message(LOGS_FATAL,
                    b"Could not allocate memory\x00" as *const u8 as
                        *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn Realloc(mut ptr: *mut libc::c_void, mut size: size_t)
 -> *mut libc::c_void {
    let mut r: *mut libc::c_void = 0 as *mut libc::c_void;
    r = realloc(ptr, size);
    if r.is_null() && size != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn Malloc2(mut nmemb: size_t, mut size: size_t)
 -> *mut libc::c_void {
    return Malloc(get_array_size(nmemb, size));
}
#[no_mangle]
pub unsafe extern "C" fn Realloc2(mut ptr: *mut libc::c_void,
                                  mut nmemb: size_t, mut size: size_t)
 -> *mut libc::c_void {
    return Realloc(ptr, get_array_size(nmemb, size));
}
#[no_mangle]
pub unsafe extern "C" fn Strdup(mut s: *const libc::c_char)
 -> *mut libc::c_char {
    let mut r: *mut libc::c_void = 0 as *mut libc::c_void;
