 ...
 **********************************************************************
  ...
  drivers etc */
   ...
   the selected reference make a difference. */
    ...
    #[no_mangle]
    fn SRC_ReportSource(index: libc::c_int, report: *mut RPT_SourceReport,
                        now: *mut timespec) -> libc::c_int;
   ...
   a flag indicating whether any hosts matched the address. */
    ...
    #[no_mangle]
    fn NSR_ModifyMaxdelaydevratio(address: *mut IPAddr,
                                  new_max_delay_ratio: libc::c_double)
     -> libc::c_int;
    #[no_mangle]
    fn NSR_ModifyMaxdelay(address: *mut IPAddr, new_max_delay: libc::c_double)
     -> libc::c_int;
    #[no_mangle]
    fn NSR_ModifyMaxpoll(address: *mut IPAddr, new_maxpoll: libc::c_int)
     -> libc::c_int;
    #[no_mangle]
    fn NSR_ModifyMinpoll(address: *mut IPAddr, new_minpoll: libc::c_int)
     -> libc::c_int;
    #[no_mangle]
    fn NSR_InitiateSampleBurst(n_good_samples: libc::c_int,
                               n_total_samples: libc::c_int,
                               mask: *mut IPAddr, address: *mut IPAddr)
     -> libc::c_int;
    #[no_mangle]
    fn SRC_DumpSources();
    #[no_mangle]
    ...
    #[no_mangle]
    fn NSR_ModifyPolltarget(address: *mut IPAddr,
                            new_poll_target: libc::c_int) -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn NSR_ModifyMinstratum(address: *mut IPAddr,
                            new_min_stratum: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn SRC_ReselectSource();
    #[no_mangle]
    fn SRC_SetReselectDistance(distance: libc::c_double);
    #[no_mangle]
    fn NSR_SetConnectivity(mask: *mut IPAddr, address: *mut IPAddr,
                           connectivity: SRC_Connectivity) -> libc::c_int;
    #[no_mangle]
    fn NSR_ModifyMaxdelayratio(address: *mut IPAddr,
                               new_max_delay_ratio: libc::c_double)
     -> libc::c_int;
    #[no_mangle]
    fn NSR_GetActivityReport(report: *mut RPT_ActivityReport);
    #[no_mangle]
    fn SRC_ReportSourcestats(index: libc::c_int,
    ...
    #[no_mangle]
    fn SMT_GetSmoothingReport(report: *mut RPT_SmoothingReport,
                              now: *mut timespec) -> libc::c_int;
   ...
   static buffers, which are valid until another call of these functions.  */
    #[no_mangle]
    fn SCK_ReceiveMessage(sock_fd: libc::c_int, message: *mut SCK_Message,
                          flags: libc::c_int) -> libc::c_int;
    /* Send a message */
    #[no_mangle]
    ...
    #[no_mangle]
    fn REF_EnableLocal(stratum: libc::c_int, distance: libc::c_double,
                       orphan: libc::c_int);
    #[no_mangle]
    fn REF_DisableLocal();
    #[no_mangle]
    ...
    #[no_mangle]
    fn MNL_AcceptTimestamp(ts: *mut timespec, reg_offset: *mut libc::c_double,
                           dfreq_ppm: *mut libc::c_double,
                           new_afreq_ppm: *mut libc::c_double) -> libc::c_int;
    #[no_mangle]
    fn MNL_Enable();
    #[no_mangle]
    fn MNL_Disable();
    ...
    #[no_mangle]
    fn MNL_ReportSamples(report: *mut RPT_ManualSamplesReport,
                         max: libc::c_int, n: *mut libc::c_int);
    #[no_mangle]
   ...
   a suggested correction rate (correction time * offset). */
    #[no_mangle]
    fn LCL_AccumulateOffset(offset: libc::c_double,
 ...
 **********************************************************************
  ...
  */
    ...
    #[no_mangle]
    fn CLG_LogCommandAccess(client: *mut IPAddr, now: *mut timespec)
     -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn CLG_GetClientAccessReportByIndex(index: libc::c_int,
                                        report:
...
static mut permissions: [libc::c_char; 66] =
    [0 as libc::c_int as libc::c_char, 2 as libc::c_int as libc::c_char,
...
unsafe extern "C" fn open_socket(mut family: libc::c_int) -> libc::c_int {
    ...
    match family {
        1 | 2 => {
            ...
            sock_fd =
                SCK_OpenUdpSocket(0 as *mut IPSockAddr, &mut local_addr,
                                  4 as libc::c_int);
            if sock_fd < 0 as libc::c_int {
                LOG_Message(LOGS_ERR,
                            b"Could not open command socket on %s\x00" as
        ...
        0 => {
            ...
            sock_fd =
                SCK_OpenUnixDatagramSocket(0 as *const libc::c_char,
                                           local_path, 0 as libc::c_int);
            if sock_fd < 0 as libc::c_int {
                LOG_Message(LOGS_ERR,
                            b"Could not open command socket on %s\x00" as
                                *const u8 as *const libc::c_char, local_path);
                return -(5 as libc::c_int)
            }
        }
        _ => {
            __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                          ...
                          (*::std::mem::transmute::<&[u8; 21],
                                                    &[libc::c_char; 21]>(b"int open_socket(int)\x00")).as_ptr());
        }
    }
    /* Register handler for read events on the socket */
    SCH_AddFileHandler(sock_fd, 1 as libc::c_int,
                       Some(read_from_cmd_socket as
...
unsafe extern "C" fn do_size_checks() {
    ...
    let mut request: CMD_Request =
        CMD_Request{version: 0,
                    ...
                    pad1: 0,
                    pad2: 0,
                    data: C2RustUnnamed_4{null: REQ_Null{EOR: 0,},},
                    padding: [0; 396],};
    let mut reply: CMD_Reply =
        CMD_Reply{version: 0,
                  ...
                  pad4: 0,
                  pad5: 0,
                  data: C2RustUnnamed_3{null: RPY_Null{EOR: 0,},},};
    if 20 as libc::c_ulong == 20 as libc::c_int as libc::c_ulong {
    } else {
        __assert_fail(b"offsetof(CMD_Request, data) == 20\x00" as *const u8 as
                          *const libc::c_char,
                      b"cmdmon.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 28 as libc::c_ulong == 28 as libc::c_int as libc::c_ulong {
        ...
        __assert_fail(b"offsetof(CMD_Reply, data) == 28\x00" as *const u8 as
                          *const libc::c_char,
                      b"cmdmon.c\x00" as *const u8 as *const libc::c_char,
    ...
    while i < 66 as libc::c_int {
        ...
        if padding_length > 396 as libc::c_int ||
               ...
               request_length != 0 &&
                   (request_length as libc::c_ulong) < 20 as libc::c_ulong {
            __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                          b"cmdmon.c\x00" as *const u8 as *const libc::c_char,
    ...
    while i < 20 as libc::c_int {
        ...
        if reply_length != 0 &&
               (reply_length as libc::c_ulong) < 28 as libc::c_ulong ||
               reply_length as libc::c_ulong >
    ...
    if initialised == 0 {
        ...
        __assert_fail(b"!initialised\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 25],
                                                &[libc::c_char; 25]>(b"void CAM_Initialise(int)\x00")).as_ptr());
    }
    if (::std::mem::size_of::<[libc::c_char; 66]>() as
            libc::c_ulong).wrapping_div(::std::mem::size_of::<libc::c_char>()
                                            as libc::c_ulong) ==
           66 as libc::c_int as libc::c_ulong {
    } else {
        __assert_fail(b"sizeof (permissions) / sizeof (permissions[0]) == N_REQUEST_TYPES\x00"
...
/* ================================================== */
unsafe extern "C" fn transmit_reply(mut sock_fd: libc::c_int,
                                    mut message: *mut SCK_Message) {
    (*message).length =
        PKL_ReplyLength((*message).data as *mut CMD_Reply) as libc::c_uint;
    if SCK_SendMessage(sock_fd, message, 0 as libc::c_int) == 0 { return };
}
/* ================================================== */
unsafe extern "C" fn handle_dump(mut rx_message: *mut CMD_Request,
                                 mut tx_message: *mut CMD_Reply) {
    SRC_DumpSources();
}
/* ================================================== */
unsafe extern "C" fn handle_online(mut rx_message: *mut CMD_Request,
                                   mut tx_message: *mut CMD_Reply) {
...
/* ================================================== */
unsafe extern "C" fn handle_offline(mut rx_message: *mut CMD_Request,
                                    mut tx_message: *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    let mut mask: IPAddr =
    ...
    UTI_IPNetworkToHost(&mut (*rx_message).data.offline.address,
                        &mut address);
...
/* ================================================== */
unsafe extern "C" fn handle_onoffline(mut rx_message: *mut CMD_Request,
                                      mut tx_message: *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    let mut mask: IPAddr =
...
/* ================================================== */
unsafe extern "C" fn handle_burst(mut rx_message: *mut CMD_Request,
                                  mut tx_message: *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    let mut mask: IPAddr =
    ...
    if NSR_InitiateSampleBurst(ntohl((*rx_message).data.burst.n_good_samples
                               ...
                               ntohl((*rx_message).data.burst.n_total_samples
                                         as uint32_t) as libc::c_int,
                               &mut mask, &mut address) == 0 {
        (*tx_message).status = htons(4 as libc::c_int as uint16_t)
    };
}
/* ================================================== */
unsafe extern "C" fn handle_modify_minpoll(mut rx_message: *mut CMD_Request,
                                           mut tx_message: *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    UTI_IPNetworkToHost(&mut (*rx_message).data.modify_minpoll.address,
                        &mut address);
    if NSR_ModifyMinpoll(&mut address,
                         ntohl((*rx_message).data.modify_minpoll.new_minpoll
                                   as uint32_t) as libc::c_int) == 0 {
        (*tx_message).status = htons(4 as libc::c_int as uint16_t)
    };
}
/* ================================================== */
unsafe extern "C" fn handle_modify_maxpoll(mut rx_message: *mut CMD_Request,
                                           mut tx_message: *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    UTI_IPNetworkToHost(&mut (*rx_message).data.modify_minpoll.address,
                        &mut address);
    if NSR_ModifyMaxpoll(&mut address,
                         ntohl((*rx_message).data.modify_minpoll.new_minpoll
                                   as uint32_t) as libc::c_int) == 0 {
        (*tx_message).status = htons(4 as libc::c_int as uint16_t)
    };
...
/* ================================================== */
unsafe extern "C" fn handle_modify_maxdelay(mut rx_message: *mut CMD_Request,
                                            mut tx_message: *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    UTI_IPNetworkToHost(&mut (*rx_message).data.modify_maxdelay.address,
                        &mut address);
    if NSR_ModifyMaxdelay(&mut address,
...
/* ================================================== */
unsafe extern "C" fn handle_modify_maxdelayratio(mut rx_message:
                                                     *mut CMD_Request,
                                                 mut tx_message:
                                                     *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    UTI_IPNetworkToHost(&mut (*rx_message).data.modify_maxdelayratio.address,
                        &mut address);
    if NSR_ModifyMaxdelayratio(&mut address,
...
/* ================================================== */
unsafe extern "C" fn handle_modify_maxdelaydevratio(mut rx_message:
                                                        *mut CMD_Request,
                                                    mut tx_message:
                                                        *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    UTI_IPNetworkToHost(&mut (*rx_message).data.modify_maxdelaydevratio.address,
                        &mut address);
    if NSR_ModifyMaxdelaydevratio(&mut address,
...
/* ================================================== */
unsafe extern "C" fn handle_modify_minstratum(mut rx_message:
                                                  *mut CMD_Request,
                                              mut tx_message:
                                                  *mut CMD_Reply) {
    let mut address: IPAddr =
    ...
    UTI_IPNetworkToHost(&mut (*rx_message).data.modify_minpoll.address,
                        &mut address);
    if NSR_ModifyMinstratum(&mut address,
...
/* ================================================== */
unsafe extern "C" fn handle_modify_polltarget(mut rx_message:
                                                  *mut CMD_Request,
                                              mut tx_message:
                                                  *mut CMD_Reply) {
    let mut address: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    UTI_IPNetworkToHost(&mut (*rx_message).data.modify_polltarget.address,
                        &mut address);
    if NSR_ModifyPolltarget(&mut address,
...
/* ================================================== */
unsafe extern "C" fn handle_modify_maxupdateskew(mut rx_message:
                                                     *mut CMD_Request,
                                                 mut tx_message:
                                                     *mut CMD_Reply) {
...
/* ================================================== */
unsafe extern "C" fn handle_modify_makestep(mut rx_message: *mut CMD_Request,
                                            mut tx_message: *mut CMD_Reply) {
    REF_ModifyMakestep(ntohl((*rx_message).data.modify_makestep.limit as
                                 uint32_t) as libc::c_int,
                       UTI_FloatNetworkToHost((*rx_message).data.modify_makestep.threshold));
}
/* ================================================== */
unsafe extern "C" fn handle_settime(mut rx_message: *mut CMD_Request,
                                    mut tx_message: *mut CMD_Reply) {
    ...
    } else if MNL_AcceptTimestamp(&mut ts, &mut offset, &mut dfreq_ppm,
                                  &mut new_afreq_ppm) != 0 {
        (*tx_message).reply = htons(17 as libc::c_int as uint16_t);
        (*tx_message).data.manual_timestamp.offset =
            UTI_FloatHostToNetwork(offset);
        (*tx_message).data.manual_timestamp.dfreq_ppm =
            UTI_FloatHostToNetwork(dfreq_ppm);
        (*tx_message).data.manual_timestamp.new_afreq_ppm =
            UTI_FloatHostToNetwork(new_afreq_ppm)
    } else { (*tx_message).status = htons(1 as libc::c_int as uint16_t) };
}
/* ================================================== */
unsafe extern "C" fn handle_local(mut rx_message: *mut CMD_Request,
                                  mut tx_message: *mut CMD_Reply) {
    if ntohl((*rx_message).data.local.on_off as uint32_t) != 0 {
        REF_EnableLocal(ntohl((*rx_message).data.local.stratum as uint32_t) as
                            libc::c_int,
                        UTI_FloatNetworkToHost((*rx_message).data.local.distance),
                        ntohl((*rx_message).data.local.orphan as uint32_t) as
                            libc::c_int);
    } else { REF_DisableLocal(); };
}
/* ================================================== */
unsafe extern "C" fn handle_manual(mut rx_message: *mut CMD_Request,
                                   mut tx_message: *mut CMD_Reply) {
    let mut option: libc::c_int = 0;
    option =
        ntohl((*rx_message).data.manual.option as uint32_t) as libc::c_int;
    match option {
        0 => { MNL_Disable(); }
        1 => { MNL_Enable(); }
        2 => { MNL_Reset(); }
...
/* ================================================== */
unsafe extern "C" fn handle_n_sources(mut rx_message: *mut CMD_Request,
                                      mut tx_message: *mut CMD_Reply) {
...
/* ================================================== */
unsafe extern "C" fn handle_source_data(mut rx_message: *mut CMD_Request,
                                        mut tx_message: *mut CMD_Reply) {
    let mut report: RPT_SourceReport =
        RPT_SourceReport{ip_addr:
                             IPAddr{addr: C2RustUnnamed{in4: 0,},
                                    family: 0,
                                    _pad: 0,},
                         stratum: 0,
                         ...
                         latest_meas: 0.,
                         latest_meas_err: 0.,};
    let mut now_corr: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    /* Get data */
    SCH_GetLastEventTime(&mut now_corr, 0 as *mut libc::c_double,
                         0 as *mut timespec);
    if SRC_ReportSource(ntohl((*rx_message).data.source_data.index as
                                  uint32_t) as libc::c_int, &mut report,
                        &mut now_corr) != 0 {
        match SRC_GetType(ntohl((*rx_message).data.source_data.index as
                                    uint32_t) as libc::c_int) as libc::c_uint
            {
            0 => { NSR_ReportSource(&mut report, &mut now_corr); }
            1 => { RCL_ReportSource(&mut report, &mut now_corr); }
            _ => { }
        }
        (*tx_message).reply = htons(3 as libc::c_int as uint16_t);
        UTI_IPHostToNetwork(&mut report.ip_addr,
                            &mut (*tx_message).data.source_data.ip_addr);
        (*tx_message).data.source_data.stratum =
            htons(report.stratum as uint16_t);
        (*tx_message).data.source_data.poll =
            htons(report.poll as uint16_t) as int16_t;
        match report.state as libc::c_uint {
            0 => {
                (*tx_message).data.source_data.state =
                    htons(0 as libc::c_int as uint16_t)
            }
            1 => {
                (*tx_message).data.source_data.state =
                    htons(1 as libc::c_int as uint16_t)
            }
            2 => {
                (*tx_message).data.source_data.state =
                    htons(2 as libc::c_int as uint16_t)
            }
            3 => {
                (*tx_message).data.source_data.state =
                    htons(3 as libc::c_int as uint16_t)
            }
            4 => {
                (*tx_message).data.source_data.state =
                    htons(4 as libc::c_int as uint16_t)
            }
            5 => {
                (*tx_message).data.source_data.state =
                    htons(5 as libc::c_int as uint16_t)
            }
            _ => { }
        }
        match report.mode as libc::c_uint {
            0 => {
                (*tx_message).data.source_data.mode =
                    htons(0 as libc::c_int as uint16_t)
            }
            1 => {
                (*tx_message).data.source_data.mode =
        ...
        (*tx_message).data.source_data.flags =
            htons(((if report.sel_options & 0x2 as libc::c_int != 0 {
                        0x2 as libc::c_int
        ...
        (*tx_message).data.source_data.reachability =
            htons(report.reachability as uint16_t);
        (*tx_message).data.source_data.since_sample =
            htonl(report.latest_meas_ago as uint32_t);
        (*tx_message).data.source_data.orig_latest_meas =
            UTI_FloatHostToNetwork(report.orig_latest_meas);
        (*tx_message).data.source_data.latest_meas =
            UTI_FloatHostToNetwork(report.latest_meas);
        (*tx_message).data.source_data.latest_meas_err =
            UTI_FloatHostToNetwork(report.latest_meas_err)
    } else { (*tx_message).status = htons(4 as libc::c_int as uint16_t) };
}
/* ================================================== */
unsafe extern "C" fn handle_rekey(mut rx_message: *mut CMD_Request,
                                  mut tx_message: *mut CMD_Reply) {
    KEY_Reload();
}
/* ================================================== */
unsafe extern "C" fn handle_allowdeny(mut rx_message: *mut CMD_Request,
                                      mut tx_message: *mut CMD_Reply,
    ...
    subnet_bits =
        ntohl((*rx_message).data.allow_deny.subnet_bits as uint32_t) as
            libc::c_int;
...
/* ================================================== */
unsafe extern "C" fn handle_cmdallowdeny(mut rx_message: *mut CMD_Request,
                                         mut tx_message: *mut CMD_Reply,
                                         mut allow: libc::c_int,
                                         mut all: libc::c_int) {
    let mut ip: IPAddr =
...
/* ================================================== */
unsafe extern "C" fn handle_accheck(mut rx_message: *mut CMD_Request,
                                    mut tx_message: *mut CMD_Reply) {
    let mut ip: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    ...
    } else { (*tx_message).status = htons(9 as libc::c_int as uint16_t) };
}
/* ================================================== */
unsafe extern "C" fn handle_cmdaccheck(mut rx_message: *mut CMD_Request,
                                       mut tx_message: *mut CMD_Reply) {
    let mut ip: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    UTI_IPNetworkToHost(&mut (*rx_message).data.ac_check.ip, &mut ip);
...
/* ================================================== */
unsafe extern "C" fn handle_add_source(mut rx_message: *mut CMD_Request,
                                       mut tx_message: *mut CMD_Reply) {
    let mut type_0: NTP_Source_Type = NTP_SERVER;
    let mut params: SourceParameters =
    ...
    match ntohl((*rx_message).data.ntp_source.type_0) {
        1 => { type_0 = NTP_SERVER; pool = 0 as libc::c_int }
        2 => { type_0 = NTP_PEER; pool = 0 as libc::c_int }
        3 => { type_0 = NTP_SERVER; pool = 1 as libc::c_int }
        _ => {
    ...
    name =
        (*rx_message).data.ntp_source.name.as_mut_ptr() as *mut libc::c_char;
    /* Make sure the name is terminated */
    if *name.offset((::std::mem::size_of::<[int8_t; 256]>() as
                         libc::c_ulong).wrapping_sub(1 as libc::c_int as
                                                         libc::c_ulong) as
                        isize) as libc::c_int != '\u{0}' as i32 {
        (*tx_message).status = htons(21 as libc::c_int as uint16_t);
        return
    }
    port =
        ntohl((*rx_message).data.ntp_source.port) as libc::c_ushort as
            libc::c_int;
    params.minpoll =
        ntohl((*rx_message).data.ntp_source.minpoll as uint32_t) as
            libc::c_int;
    params.maxpoll =
        ntohl((*rx_message).data.ntp_source.maxpoll as uint32_t) as
            libc::c_int;
    params.presend_minpoll =
        ntohl((*rx_message).data.ntp_source.presend_minpoll as uint32_t) as
            libc::c_int;
    params.min_stratum =
        ntohl((*rx_message).data.ntp_source.min_stratum) as libc::c_int;
    params.poll_target =
        ntohl((*rx_message).data.ntp_source.poll_target) as libc::c_int;
    params.version =
        ntohl((*rx_message).data.ntp_source.version) as libc::c_int;
    params.max_sources =
        ntohl((*rx_message).data.ntp_source.max_sources) as libc::c_int;
    params.min_samples =
        ntohl((*rx_message).data.ntp_source.min_samples as uint32_t) as
            libc::c_int;
    params.max_samples =
        ntohl((*rx_message).data.ntp_source.max_samples as uint32_t) as
            libc::c_int;
    params.filter_length =
        ntohl((*rx_message).data.ntp_source.filter_length as uint32_t) as
            libc::c_int;
    params.authkey = ntohl((*rx_message).data.ntp_source.authkey);
    params.max_delay =
        UTI_FloatNetworkToHost((*rx_message).data.ntp_source.max_delay);
    params.max_delay_ratio =
        UTI_FloatNetworkToHost((*rx_message).data.ntp_source.max_delay_ratio);
    params.max_delay_dev_ratio =
        UTI_FloatNetworkToHost((*rx_message).data.ntp_source.max_delay_dev_ratio);
    params.min_delay =
        UTI_FloatNetworkToHost((*rx_message).data.ntp_source.min_delay);
    params.asymmetry =
        UTI_FloatNetworkToHost((*rx_message).data.ntp_source.asymmetry);
    params.offset =
        UTI_FloatNetworkToHost((*rx_message).data.ntp_source.offset);
    params.connectivity =
        if ntohl((*rx_message).data.ntp_source.flags) &
        ...
        4 | 1 => {
            __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                          ...
                          (*::std::mem::transmute::<&[u8; 51],
                                                    &[libc::c_char; 51]>(b"void handle_add_source(CMD_Request *, CMD_Reply *)\x00")).as_ptr());
        }
        0 | _ => { }
    };
}
/* ================================================== */
unsafe extern "C" fn handle_del_source(mut rx_message: *mut CMD_Request,
                                       mut tx_message: *mut CMD_Reply) {
    let mut rem_addr: NTP_Remote_Address =
        IPSockAddr{ip_addr:
                   ...
                   port: 0,};
    let mut status: NSR_Status = NSR_Success;
    UTI_IPNetworkToHost(&mut (*rx_message).data.del_source.ip_addr,
    ...
    match status as libc::c_uint {
        ...
        3 | 2 | 4 | 5 | 6 => {
            __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                          ...
                          (*::std::mem::transmute::<&[u8; 51],
                                                    &[libc::c_char; 51]>(b"void handle_del_source(CMD_Request *, CMD_Reply *)\x00")).as_ptr());
        }
        0 | _ => { }
    };
}
/* ================================================== */
unsafe extern "C" fn handle_writertc(mut rx_message: *mut CMD_Request,
                                     mut tx_message: *mut CMD_Reply) {
...
/* ================================================== */
unsafe extern "C" fn handle_dfreq(mut rx_message: *mut CMD_Request,
                                  mut tx_message: *mut CMD_Reply) {
    ...
    LOG_Message(LOGS_INFO,
                b"Accumulated delta freq of %.3fppm\x00" as *const u8 as
                    *const libc::c_char, dfreq);
}
/* ================================================== */
unsafe extern "C" fn handle_doffset(mut rx_message: *mut CMD_Request,
                                    mut tx_message: *mut CMD_Reply) {
    let mut sec: libc::c_long = 0;
    let mut usec: libc::c_long = 0;
    let mut doffset: libc::c_double = 0.;
    sec =
        ntohl((*rx_message).data.doffset.sec as uint32_t) as int32_t as
            libc::c_long;
    usec =
        ntohl((*rx_message).data.doffset.usec as uint32_t) as int32_t as
            libc::c_long;
    doffset = sec as libc::c_double + 1.0e-6f64 * usec as libc::c_double;
    LOG_Message(LOGS_INFO,
                b"Accumulated delta offset of %.6f seconds\x00" as *const u8
                    as *const libc::c_char, doffset);
    LCL_AccumulateOffset(doffset, 0.0f64);
}
/* ================================================== */
unsafe extern "C" fn handle_tracking(mut rx_message: *mut CMD_Request,
                                     mut tx_message: *mut CMD_Reply) {
    let mut rpt: RPT_TrackingReport =
        RPT_TrackingReport{ref_id: 0,
                           ip_addr:
                               IPAddr{addr: C2RustUnnamed{in4: 0,},
                                      family: 0,
                                      _pad: 0,},
                           ...
                           ref_time: timespec{tv_sec: 0, tv_nsec: 0,},
    ...
    UTI_IPHostToNetwork(&mut rpt.ip_addr,
                        &mut (*tx_message).data.tracking.ip_addr);
    (*tx_message).data.tracking.stratum = htons(rpt.stratum as uint16_t);
    (*tx_message).data.tracking.leap_status =
        htons(rpt.leap_status as uint16_t);
    UTI_TimespecHostToNetwork(&mut rpt.ref_time,
                              &mut (*tx_message).data.tracking.ref_time);
    (*tx_message).data.tracking.current_correction =
        UTI_FloatHostToNetwork(rpt.current_correction);
    (*tx_message).data.tracking.last_offset =
        UTI_FloatHostToNetwork(rpt.last_offset);
    (*tx_message).data.tracking.rms_offset =
        UTI_FloatHostToNetwork(rpt.rms_offset);
    (*tx_message).data.tracking.freq_ppm =
        UTI_FloatHostToNetwork(rpt.freq_ppm);
    (*tx_message).data.tracking.resid_freq_ppm =
        UTI_FloatHostToNetwork(rpt.resid_freq_ppm);
    (*tx_message).data.tracking.skew_ppm =
        UTI_FloatHostToNetwork(rpt.skew_ppm);
    (*tx_message).data.tracking.root_delay =
        UTI_FloatHostToNetwork(rpt.root_delay);
    (*tx_message).data.tracking.root_dispersion =
        UTI_FloatHostToNetwork(rpt.root_dispersion);
    (*tx_message).data.tracking.last_update_interval =
        UTI_FloatHostToNetwork(rpt.last_update_interval);
}
/* ================================================== */
unsafe extern "C" fn handle_smoothing(mut rx_message: *mut CMD_Request,
                                      mut tx_message: *mut CMD_Reply) {
    let mut report: RPT_SmoothingReport =
        RPT_SmoothingReport{active: 0,
                            leap_only: 0,
                            offset: 0.,
                            freq_ppm: 0.,
                            wander_ppm: 0.,
    ...
    (*tx_message).data.smoothing.flags =
        htonl(((if report.active != 0 {
                    0x1 as libc::c_int
                } else { 0 as libc::c_int }) |
                   (if report.leap_only != 0 {
                        0x2 as libc::c_int
                    } else { 0 as libc::c_int })) as uint32_t);
    (*tx_message).data.smoothing.offset =
        UTI_FloatHostToNetwork(report.offset);
    (*tx_message).data.smoothing.freq_ppm =
        UTI_FloatHostToNetwork(report.freq_ppm);
    (*tx_message).data.smoothing.wander_ppm =
        UTI_FloatHostToNetwork(report.wander_ppm);
    (*tx_message).data.smoothing.last_update_ago =
        UTI_FloatHostToNetwork(report.last_update_ago);
    (*tx_message).data.smoothing.remaining_time =
        UTI_FloatHostToNetwork(report.remaining_time);
}
/* ================================================== */
unsafe extern "C" fn handle_smoothtime(mut rx_message: *mut CMD_Request,
                                       mut tx_message: *mut CMD_Reply) {
    let mut now: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    let mut option: libc::c_int = 0;
    if SMT_IsEnabled() == 0 {
    ...
    option =
        ntohl((*rx_message).data.smoothtime.option as uint32_t) as
            libc::c_int;
    SCH_GetLastEventTime(&mut now, 0 as *mut libc::c_double,
                         0 as *mut timespec);
    match option {
        0 => { SMT_Reset(&mut now); }
        1 => { SMT_Activate(&mut now); }
        _ => { (*tx_message).status = htons(3 as libc::c_int as uint16_t) }
    };
}
/* ================================================== */
unsafe extern "C" fn handle_sourcestats(mut rx_message: *mut CMD_Request,
                                        mut tx_message: *mut CMD_Reply) {
    let mut status: libc::c_int = 0;
    let mut report: RPT_SourcestatsReport =
        RPT_SourcestatsReport{ref_id: 0,
                              ip_addr:
                                  IPAddr{addr: C2RustUnnamed{in4: 0,},
                                         family: 0,
                                         _pad: 0,},
    ...
    SCH_GetLastEventTime(&mut now_corr, 0 as *mut libc::c_double,
                         0 as *mut timespec);
    status =
        SRC_ReportSourcestats(ntohl((*rx_message).data.sourcestats.index) as
                                  libc::c_int, &mut report, &mut now_corr);
    if status != 0 {
        ...
        (*tx_message).data.sourcestats.n_samples =
            htonl(report.n_samples as uint32_t);
        (*tx_message).data.sourcestats.n_runs =
            htonl(report.n_runs as uint32_t);
        (*tx_message).data.sourcestats.span_seconds =
            htonl(report.span_seconds as uint32_t);
        (*tx_message).data.sourcestats.resid_freq_ppm =
            UTI_FloatHostToNetwork(report.resid_freq_ppm);
        (*tx_message).data.sourcestats.skew_ppm =
            UTI_FloatHostToNetwork(report.skew_ppm);
        (*tx_message).data.sourcestats.sd = UTI_FloatHostToNetwork(report.sd);
        (*tx_message).data.sourcestats.est_offset =
            UTI_FloatHostToNetwork(report.est_offset);
        (*tx_message).data.sourcestats.est_offset_err =
            UTI_FloatHostToNetwork(report.est_offset_err)
    } else { (*tx_message).status = htons(4 as libc::c_int as uint16_t) };
}
/* ================================================== */
unsafe extern "C" fn handle_rtcreport(mut rx_message: *mut CMD_Request,
                                      mut tx_message: *mut CMD_Reply) {
    let mut status: libc::c_int = 0;
    let mut report: RPT_RTC_Report =
        RPT_RTC_Report{ref_time: timespec{tv_sec: 0, tv_nsec: 0,},
                       n_samples: 0,
                       n_runs: 0,
                       span_seconds: 0,
                       rtc_seconds_fast: 0.,
    ...
    if status != 0 {
        ...
        UTI_TimespecHostToNetwork(&mut report.ref_time,
                                  &mut (*tx_message).data.rtc.ref_time);
        (*tx_message).data.rtc.n_samples = htons(report.n_samples);
        (*tx_message).data.rtc.n_runs = htons(report.n_runs);
        (*tx_message).data.rtc.span_seconds =
            htonl(report.span_seconds as uint32_t);
        (*tx_message).data.rtc.rtc_seconds_fast =
            UTI_FloatHostToNetwork(report.rtc_seconds_fast);
        (*tx_message).data.rtc.rtc_gain_rate_ppm =
            UTI_FloatHostToNetwork(report.rtc_gain_rate_ppm)
    } else { (*tx_message).status = htons(13 as libc::c_int as uint16_t) };
}
/* ================================================== */
unsafe extern "C" fn handle_trimrtc(mut rx_message: *mut CMD_Request,
                                    mut tx_message: *mut CMD_Reply) {
    if RTC_Trim() == 0 {
...
/* ================================================== */
unsafe extern "C" fn handle_cyclelogs(mut rx_message: *mut CMD_Request,
                                      mut tx_message: *mut CMD_Reply) {
    LOG_CycleLogFiles();
}
/* ================================================== */
unsafe extern "C" fn handle_client_accesses_by_index(mut rx_message:
                                                         *mut CMD_Request,
                                                     mut tx_message:
                                                         *mut CMD_Reply) {
    let mut report: RPT_ClientAccessByIndex_Report =
        RPT_ClientAccessByIndex_Report{ip_addr:
                                           IPAddr{addr:
                                                      C2RustUnnamed{in4: 0,},
                                                  family: 0,
                                                  _pad: 0,},
    ...
    SCH_GetLastEventTime(&mut now, 0 as *mut libc::c_double,
                         0 as *mut timespec);
    req_first_index =
        ntohl((*rx_message).data.client_accesses_by_index.first_index);
    req_n_clients =
        ntohl((*rx_message).data.client_accesses_by_index.n_clients);
    ...
    (*tx_message).data.client_accesses_by_index.n_indices =
        htonl(n_indices as uint32_t);
    i = req_first_index;
    j = 0 as libc::c_int as uint32_t;
    while i < n_indices as uint32_t && j < req_n_clients {
        if !(CLG_GetClientAccessReportByIndex(i as libc::c_int, &mut report,
                                              &mut now) == 0) {
            let fresh0 = j;
            j = j.wrapping_add(1);
            client =
                &mut *(*tx_message).data.client_accesses_by_index.clients.as_mut_ptr().offset(fresh0
                                                                                                  as
                                                                                                  isize)
...
/* ================================================== */
unsafe extern "C" fn handle_manual_list(mut rx_message: *mut CMD_Request,
                                        mut tx_message: *mut CMD_Reply) {
    let mut n_samples: libc::c_int = 0;
    let mut i: libc::c_int = 0;
    let mut sample: *mut RPY_ManualListSample =
        0 as *mut RPY_ManualListSample;
    let mut report: [RPT_ManualSamplesReport; 16] =
        [RPT_ManualSamplesReport{when: timespec{tv_sec: 0, tv_nsec: 0,},
                                 slewed_offset: 0.,
                                 orig_offset: 0.,
                                 residual: 0.,}; 16];
    ...
    while i < n_samples {
        sample =
            &mut *(*tx_message).data.manual_list.samples.as_mut_ptr().offset(i
                                                                                 as
                                                                                 isize)
                as *mut RPY_ManualListSample;
        UTI_TimespecHostToNetwork(&mut (*report.as_mut_ptr().offset(i as
                                                                        isize)).when,
                                  &mut (*sample).when);
        (*sample).slewed_offset =
            UTI_FloatHostToNetwork(report[i as usize].slewed_offset);
        (*sample).orig_offset =
            UTI_FloatHostToNetwork(report[i as usize].orig_offset);
        (*sample).residual =
            UTI_FloatHostToNetwork(report[i as usize].residual);
        i += 1
    };
}
/* ================================================== */
unsafe extern "C" fn handle_manual_delete(mut rx_message: *mut CMD_Request,
                                          mut tx_message: *mut CMD_Reply) {
    let mut index: libc::c_int = 0;
    index =
        ntohl((*rx_message).data.manual_delete.index as uint32_t) as
            libc::c_int;
...
/* ================================================== */
unsafe extern "C" fn handle_make_step(mut rx_message: *mut CMD_Request,
                                      mut tx_message: *mut CMD_Reply) {
    if LCL_MakeStep() == 0 {
...
/* ================================================== */
unsafe extern "C" fn handle_activity(mut rx_message: *mut CMD_Request,
                                     mut tx_message: *mut CMD_Reply) {
    let mut report: RPT_ActivityReport =
        RPT_ActivityReport{online: 0,
                           offline: 0,
                           burst_online: 0,
                           burst_offline: 0,
                           unresolved: 0,};
    NSR_GetActivityReport(&mut report);
    (*tx_message).data.activity.online =
        htonl(report.online as uint32_t) as int32_t;
    (*tx_message).data.activity.offline =
        htonl(report.offline as uint32_t) as int32_t;
    (*tx_message).data.activity.burst_online =
        htonl(report.burst_online as uint32_t) as int32_t;
    (*tx_message).data.activity.burst_offline =
        htonl(report.burst_offline as uint32_t) as int32_t;
    (*tx_message).data.activity.unresolved =
        htonl(report.unresolved as uint32_t) as int32_t;
    (*tx_message).reply = htons(12 as libc::c_int as uint16_t);
}
/* ================================================== */
unsafe extern "C" fn handle_reselect_distance(mut rx_message:
                                                  *mut CMD_Request,
                                              mut tx_message:
                                                  *mut CMD_Reply) {
    let mut dist: libc::c_double = 0.;
    dist =
        UTI_FloatNetworkToHost((*rx_message).data.reselect_distance.distance);
    SRC_SetReselectDistance(dist);
}
/* ================================================== */
unsafe extern "C" fn handle_reselect(mut rx_message: *mut CMD_Request,
                                     mut tx_message: *mut CMD_Reply) {
    SRC_ReselectSource();
}
/* ================================================== */
unsafe extern "C" fn handle_refresh(mut rx_message: *mut CMD_Request,
                                    mut tx_message: *mut CMD_Reply) {
    NSR_RefreshAddresses();
}
/* ================================================== */
unsafe extern "C" fn handle_server_stats(mut rx_message: *mut CMD_Request,
                                         mut tx_message: *mut CMD_Reply) {
    let mut report: RPT_ServerStatsReport =
        RPT_ServerStatsReport{ntp_hits: 0,
                              cmd_hits: 0,
                              ntp_drops: 0,
                              cmd_drops: 0,
                              log_drops: 0,};
...
/* ================================================== */
unsafe extern "C" fn handle_ntp_data(mut rx_message: *mut CMD_Request,
                                     mut tx_message: *mut CMD_Reply) {
    let mut report: RPT_NTPReport =
        RPT_NTPReport{remote_addr:
                          IPAddr{addr: C2RustUnnamed{in4: 0,},
                                 family: 0,
                                 _pad: 0,},
                      local_addr:
                      ...
                      total_rx_count: 0,
                      total_valid_count: 0,};
    UTI_IPNetworkToHost(&mut (*rx_message).data.ntp_data.ip_addr,
    ...
    UTI_IPHostToNetwork(&mut report.remote_addr,
                        &mut (*tx_message).data.ntp_data.remote_addr);
    UTI_IPHostToNetwork(&mut report.local_addr,
    ...
    (*tx_message).data.ntp_data.root_delay =
        UTI_FloatHostToNetwork(report.root_delay);
    (*tx_message).data.ntp_data.root_dispersion =
        UTI_FloatHostToNetwork(report.root_dispersion);
    (*tx_message).data.ntp_data.ref_id = htonl(report.ref_id);
    UTI_TimespecHostToNetwork(&mut report.ref_time,
                              &mut (*tx_message).data.ntp_data.ref_time);
    (*tx_message).data.ntp_data.offset =
        UTI_FloatHostToNetwork(report.offset);
    (*tx_message).data.ntp_data.peer_delay =
        UTI_FloatHostToNetwork(report.peer_delay);
    (*tx_message).data.ntp_data.peer_dispersion =
        UTI_FloatHostToNetwork(report.peer_dispersion);
    (*tx_message).data.ntp_data.response_time =
        UTI_FloatHostToNetwork(report.response_time);
    (*tx_message).data.ntp_data.jitter_asymmetry =
        UTI_FloatHostToNetwork(report.jitter_asymmetry);
    (*tx_message).data.ntp_data.flags =
        htons((report.tests as libc::c_int & 0x3ff as libc::c_int |
    ...
    (*tx_message).data.ntp_data.total_valid_count =
        htonl(report.total_valid_count);
    memset((*tx_message).data.ntp_data.reserved.as_mut_ptr() as
               *mut libc::c_void, 0xff as libc::c_int,
           ::std::mem::size_of::<[uint32_t; 4]>() as libc::c_ulong);
}
/* ================================================== */
unsafe extern "C" fn handle_shutdown(mut rx_message: *mut CMD_Request,
                                     mut tx_message: *mut CMD_Reply) {
    LOG_Message(LOGS_INFO,
                b"Received shutdown command\x00" as *const u8 as
                    *const libc::c_char);
    SCH_QuitProgram();
}
/* ================================================== */
unsafe extern "C" fn handle_ntp_source_name(mut rx_message: *mut CMD_Request,
                                            mut tx_message: *mut CMD_Reply) {
    let mut addr: IPAddr =
        IPAddr{addr: C2RustUnnamed{in4: 0,}, family: 0, _pad: 0,};
    let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    if strlen(name) >= ::std::mem::size_of::<[int8_t; 256]>() as libc::c_ulong
       {
        memcpy((*tx_message).data.ntp_source_name.name.as_mut_ptr() as
                   *mut libc::c_void, name as *const libc::c_void,
               ::std::mem::size_of::<[int8_t; 256]>() as libc::c_ulong);
    } else {
        strncpy((*tx_message).data.ntp_source_name.name.as_mut_ptr() as
                    *mut libc::c_char, name,
                ::std::mem::size_of::<[int8_t; 256]>() as libc::c_ulong);
    };
}
/* ================================================== */
...
unsafe extern "C" fn read_from_cmd_socket(mut sock_fd: libc::c_int,
                                          mut event: libc::c_int,
                                          mut anything: *mut libc::c_void) {
    let mut sck_message: SCK_Message =
        SCK_Message{data: 0 as *mut libc::c_void,
                    ...
                    timestamp:
                        C2RustUnnamed_0{kernel:
                                        ...
                                        tx_flags: 0,},
                    descriptor: 0,};
    let mut rx_message: CMD_Request =
        CMD_Request{version: 0,
                    pkt_type: 0,
                    res1: 0,
                    res2: 0,
    ...
    let mut now: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    let mut cooked_now: timespec = timespec{tv_sec: 0, tv_nsec: 0,};
    ...
    match sck_message.addr_type as libc::c_uint {
        1 => {
            if sock_fd == sock_fd4 || sock_fd == sock_fd6 {
                ...
                __assert_fail(b"sock_fd == sock_fd4 || sock_fd == sock_fd6\x00"
                                  as *const u8 as *const libc::c_char,
                              b"cmdmon.c\x00" as *const u8 as
                                  *const libc::c_char,
                              1246 as libc::c_int as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
                                                        &[libc::c_char; 44]>(b"void read_from_cmd_socket(int, int, void *)\x00")).as_ptr());
            }
            remote_ip = sck_message.remote_addr.ip.ip_addr;
            SCK_GetLoopbackIPAddress(remote_ip.family as libc::c_int,
                                     &mut loopback_addr);
            localhost =
                (UTI_CompareIPs(&mut remote_ip, &mut loopback_addr,
                                0 as *mut IPAddr) == 0 as libc::c_int) as
                    libc::c_int;
            if localhost == 0 &&
                   ADF_IsAllowed(access_auth_table, &mut remote_ip) == 0 {
                if 0 as libc::c_int != 0 &&
                       log_min_severity as libc::c_int ==
                           LOGS_DEBUG as libc::c_int {
                    LOG_Message(LOGS_DEBUG,
                                b"Unauthorised host %s\x00" as *const u8 as
                                    *const libc::c_char,
            ...
            if remote_ip.family as libc::c_int != 0 as libc::c_int {
                ...
                __assert_fail(b"remote_ip.family != IPADDR_UNSPEC\x00" as
                                  *const u8 as *const libc::c_char,
                              b"cmdmon.c\x00" as *const u8 as
                                  *const libc::c_char,
        ...
        2 => {
            if sock_fd == sock_fdu {
                ...
                __assert_fail(b"sock_fd == sock_fdu\x00" as *const u8 as
                                  *const libc::c_char,
                              b"cmdmon.c\x00" as *const u8 as
                                  *const libc::c_char,
    ...
    memcpy(&mut rx_message as *mut CMD_Request as *mut libc::c_void,
           sck_message.data, read_length as libc::c_ulong);
    if rx_message.pkt_type as libc::c_int != 1 as libc::c_int ||
        ...
        if 0 as libc::c_int != 0 &&
               log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(LOGS_DEBUG,
                        b"Command packet dropped\x00" as *const u8 as
                            *const libc::c_char);
        }
        return
    }
    ...
    /* Don't reply to all requests from hosts other than localhost if the rate
     is excessive */
    if localhost == 0 && log_index >= 0 as libc::c_int &&
           CLG_LimitCommandResponseRate(log_index) != 0 {
        if 0 as libc::c_int != 0 &&
               log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(LOGS_DEBUG,
                        b"Command packet discarded to limit response rate\x00"
                            as *const u8 as *const libc::c_char);
        }
        return
    }
    ...
    memset(&mut tx_message as *mut CMD_Reply as *mut libc::c_void,
           0 as libc::c_int,
           ::std::mem::size_of::<CMD_Reply>() as libc::c_ulong);
    ...
    if rx_message.version as libc::c_int != 6 as libc::c_int {
        if 0 as libc::c_int != 0 &&
               log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(LOGS_DEBUG,
                        b"Command packet has invalid version (%d != %d)\x00"
                            as *const u8 as *const libc::c_char,
                        rx_message.version as libc::c_int, 6 as libc::c_int);
        }
    ...
    if rx_command as libc::c_int >= 66 as libc::c_int ||
        ...
        if 0 as libc::c_int != 0 &&
               log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(LOGS_DEBUG,
                        b"Command packet has invalid command %d\x00" as
                            *const u8 as *const libc::c_char,
    ...
    if read_length < expected_length {
        if 0 as libc::c_int != 0 &&
               log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
            LOG_Message(LOGS_DEBUG,
                        b"Command packet is too short (%d < %d)\x00" as
                            *const u8 as *const libc::c_char, read_length,
                        expected_length);
        }
       ...
       chrony user/group) are allowed. */
        ...
        if allowed != 0 {
            match rx_command as libc::c_int {
                0 => { }
                6 => { handle_dump(&mut rx_message, &mut tx_message); }
                1 => { handle_online(&mut rx_message, &mut tx_message); }
                2 => { handle_offline(&mut rx_message, &mut tx_message); }
                3 => { handle_burst(&mut rx_message, &mut tx_message); }
                4 => {
                ...
                8 => {
                    handle_modify_maxdelayratio(&mut rx_message,
                                                &mut tx_message);
                }
                47 => {
                    handle_modify_maxdelaydevratio(&mut rx_message,
                                                   &mut tx_message);
                }
                9 => {
                    handle_modify_maxupdateskew(&mut rx_message,
                                                &mut tx_message);
                }
                50 => {
                ...
                11 => { handle_settime(&mut rx_message, &mut tx_message); }
                56 => { handle_local(&mut rx_message, &mut tx_message); }
                13 => { handle_manual(&mut rx_message, &mut tx_message); }
                14 => { handle_n_sources(&mut rx_message, &mut tx_message); }
                15 => {
                    handle_source_data(&mut rx_message, &mut tx_message);
                }
                16 => { handle_rekey(&mut rx_message, &mut tx_message); }
                17 => {
                    handle_allowdeny(&mut rx_message, &mut tx_message,
                ...
                21 => {
                    handle_cmdallowdeny(&mut rx_message, &mut tx_message,
                                        1 as libc::c_int, 0 as libc::c_int);
                }
                22 => {
                    handle_cmdallowdeny(&mut rx_message, &mut tx_message,
                ...
                25 => { handle_accheck(&mut rx_message, &mut tx_message); }
                26 => { handle_cmdaccheck(&mut rx_message, &mut tx_message); }
                64 => { handle_add_source(&mut rx_message, &mut tx_message); }
                29 => { handle_del_source(&mut rx_message, &mut tx_message); }
                30 => { handle_writertc(&mut rx_message, &mut tx_message); }
                31 => { handle_dfreq(&mut rx_message, &mut tx_message); }
                32 => { handle_doffset(&mut rx_message, &mut tx_message); }
                33 => { handle_tracking(&mut rx_message, &mut tx_message); }
                51 => { handle_smoothing(&mut rx_message, &mut tx_message); }
                52 => { handle_smoothtime(&mut rx_message, &mut tx_message); }
                34 => {
                    handle_sourcestats(&mut rx_message, &mut tx_message);
                }
                35 => { handle_rtcreport(&mut rx_message, &mut tx_message); }
                36 => { handle_trimrtc(&mut rx_message, &mut tx_message); }
                37 => { handle_cyclelogs(&mut rx_message, &mut tx_message); }
                55 => {
                    handle_client_accesses_by_index(&mut rx_message,
                                                    &mut tx_message);
                }
                41 => {
                ...
                43 => { handle_make_step(&mut rx_message, &mut tx_message); }
                44 => { handle_activity(&mut rx_message, &mut tx_message); }
                49 => {
                    handle_reselect_distance(&mut rx_message,
                                             &mut tx_message);
                }
                48 => { handle_reselect(&mut rx_message, &mut tx_message); }
                45 => {
                    handle_modify_minstratum(&mut rx_message,
                                             &mut tx_message);
                }
                46 => {
                    handle_modify_polltarget(&mut rx_message,
                                             &mut tx_message);
                }
                53 => { handle_refresh(&mut rx_message, &mut tx_message); }
                54 => {
                    handle_server_stats(&mut rx_message, &mut tx_message);
                }
                57 => { handle_ntp_data(&mut rx_message, &mut tx_message); }
                62 => { handle_shutdown(&mut rx_message, &mut tx_message); }
                63 => { handle_onoffline(&mut rx_message, &mut tx_message); }
                65 => {
                ...
                _ => {
                    if 0 as libc::c_int != 0 &&
                           log_min_severity as libc::c_int ==
                               LOGS_DEBUG as libc::c_int {
                        LOG_Message(LOGS_DEBUG,
                                    b"Unhandled command %d\x00" as *const u8
        ...
        } else { tx_message.status = htons(2 as libc::c_int as uint16_t) }
    }
    /* Transmit the response */
    /* Include a simple way to lose one message in three to test resend */
    static mut do_it: libc::c_int = 1 as libc::c_int;
    if do_it != 0 { transmit_reply(sock_fd, &mut sck_message); };
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn CAM_AddAccessRestriction(mut ip_addr: *mut IPAddr,
                                                  mut subnet_bits:
                                                      libc::c_int,
                                                  mut allow: libc::c_int,
                                                  mut all: libc::c_int)
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn CAM_CheckAccessRestriction(mut ip_addr: *mut IPAddr)
 -> libc::c_int {
