...
static mut change_list: ChangeListEntry = ChangeListEntry {
    next: 0 as *const _ChangeListEntry as *mut _ChangeListEntry,
    prev: 0 as *const _ChangeListEntry as *mut _ChangeListEntry,
    handler: None,
    anything: 0 as *const libc::c_void as *mut libc::c_void,
};
static mut dispersion_notify_list: DispersionNotifyListEntry = DispersionNotifyListEntry {
    next: 0 as *const _DispersionNotifyListEntry as *mut _DispersionNotifyListEntry,
    prev: 0 as *const _DispersionNotifyListEntry as *mut _DispersionNotifyListEntry,
    handler: None,
    anything: 0 as *const libc::c_void as *mut libc::c_void,
};
/* ================================================== */
...
unsafe extern "C" fn calculate_sys_precision() {
    ...
    let mut old_ts: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    ...
    loop {
        ...
        diff = (1000000000 as libc::c_int as libc::c_long * (ts.tv_sec - old_ts.tv_sec)
            + (ts.tv_nsec - old_ts.tv_nsec)) as libc::c_int;
        old_ts = ts;
    ...
    if precision_log >= -(30 as libc::c_int) {
        ...
        __assert_fail(
            b"precision_log >= -30\x00" as *const u8 as *const libc::c_char,
            b"local.c\x00" as *const u8 as *const libc::c_char,
    ...
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"Clock precision %.9f (%d)\x00" as *const u8 as *const libc::c_char,
            precision_quantum,
            precision_log,
        );
    };
...
pub unsafe extern "C" fn LCL_Finalise() {
    while change_list.next != &mut change_list as *mut ChangeListEntry {
        LCL_RemoveParameterChangeHandler((*change_list.next).handler, (*change_list.next).anything);
    }
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_AddParameterChangeHandler(
    mut handler: LCL_ParameterChangeHandler,
        ...
        if !((*ptr).handler != handler || (*ptr).anything != anything) {
            __assert_fail(
                ...
                (*::std::mem::transmute::<&[u8; 71], &[libc::c_char; 71]>(
                    b"void LCL_AddParameterChangeHandler(LCL_ParameterChangeHandler, void *)\x00",
                ))
                .as_ptr(),
            );
        }
    ...
    new_entry =
        Malloc(::std::mem::size_of::<ChangeListEntry>() as libc::c_ulong) as *mut ChangeListEntry;
...
/* Remove a handler */
#[no_mangle]
pub unsafe extern "C" fn LCL_RemoveParameterChangeHandler(
    mut handler: LCL_ParameterChangeHandler,
    mut anything: *mut libc::c_void,
) {
    let mut ptr: *mut ChangeListEntry = 0 as *mut ChangeListEntry;
    ...
    if ok != 0 {
        ...
        __assert_fail(
            ...
            (*::std::mem::transmute::<&[u8; 74], &[libc::c_char; 74]>(
                b"void LCL_RemoveParameterChangeHandler(LCL_ParameterChangeHandler, void *)\x00",
            ))
            .as_ptr(),
        );
    }
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_IsFirstParameterChangeHandler(
    mut handler: LCL_ParameterChangeHandler,
) -> libc::c_int {
    return ((*change_list.next).handler == handler) as libc::c_int;
}
/* ================================================== */
unsafe extern "C" fn invoke_parameter_change_handlers(
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_AddDispersionNotifyHandler(
    mut handler: LCL_DispersionNotifyHandler,
    mut anything: *mut libc::c_void,
) {
    let mut ptr: *mut DispersionNotifyListEntry = 0 as *mut DispersionNotifyListEntry;
    let mut new_entry: *mut DispersionNotifyListEntry = 0 as *mut DispersionNotifyListEntry;
    /* Check that the handler is not already registered */
        ...
        if !((*ptr).handler != handler || (*ptr).anything != anything) {
            __assert_fail(
                ...
                (*::std::mem::transmute::<&[u8; 73], &[libc::c_char; 73]>(
                    b"void LCL_AddDispersionNotifyHandler(LCL_DispersionNotifyHandler, void *)\x00",
                ))
                .as_ptr(),
            );
        }
    ...
    new_entry = Malloc(::std::mem::size_of::<DispersionNotifyListEntry>() as libc::c_ulong)
        as *mut DispersionNotifyListEntry;
    (*new_entry).handler = handler;
    (*new_entry).anything = anything;
    /* Chain it into the list */
...
/* Remove a handler */
#[no_mangle]
pub unsafe extern "C" fn LCL_RemoveDispersionNotifyHandler(
    mut handler: LCL_DispersionNotifyHandler,
    mut anything: *mut libc::c_void,
) {
    let mut ptr: *mut DispersionNotifyListEntry = 0 as *mut DispersionNotifyListEntry;
    ...
    if ok != 0 {
        ...
        __assert_fail(
            ...
            (*::std::mem::transmute::<&[u8; 76], &[libc::c_char; 76]>(
                b"void LCL_RemoveDispersionNotifyHandler(LCL_DispersionNotifyHandler, void *)\x00",
            ))
            .as_ptr(),
        );
    }
...
pub unsafe extern "C" fn LCL_ReadRawTime(mut ts: *mut timespec) {
    if clock_gettime(0 as libc::c_int, ts) < 0 as libc::c_int {
        LOG_Message(
            LOGS_FATAL,
            b"clock_gettime() failed : %s\x00" as *const u8 as *const libc::c_char,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_ReadCookedTime(
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_CookTime(
    mut raw: *mut timespec,
    mut cooked: *mut timespec,
    mut err: *mut libc::c_double,
) {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_GetOffsetCorrection(
    mut raw: *mut timespec,
    mut correction: *mut libc::c_double,
    mut err: *mut libc::c_double,
) {
    /* Call system specific driver to get correction */
    Some(drv_offset_convert.expect("non-null function pointer"))
        .expect("non-null function pointer")(raw, correction, err);
}
...
unsafe extern "C" fn clamp_freq(mut freq: libc::c_double) -> libc::c_double {
    ...
    LOG_Message(
        LOGS_WARN,
        b"Frequency %.1f ppm exceeds allowed maximum\x00" as *const u8 as *const libc::c_char,
        freq,
    );
...
unsafe extern "C" fn check_offset(
    ...
    if UTI_IsTimeOffsetSane(now, -offset) != 0 {
        return 1 as libc::c_int;
    }
    LOG_Message(
        LOGS_WARN,
        b"Adjustment of %.1f seconds is invalid\x00" as *const u8 as *const libc::c_char,
        -offset,
    );
...
#[no_mangle]
pub unsafe extern "C" fn LCL_SetAbsoluteFrequency(mut afreq_ppm: libc::c_double) {
    let mut raw: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    ...
    if temp_comp_ppm != 0.0f64 {
        afreq_ppm = afreq_ppm * (1.0f64 - 1.0e-6f64 * temp_comp_ppm) - temp_comp_ppm
    }
    /* Call the system-specific driver for setting the frequency */
    afreq_ppm = Some(drv_set_freq.expect("non-null function pointer"))
        .expect("non-null function pointer")(afreq_ppm);
    dfreq = (afreq_ppm - current_freq_ppm) / (1.0e6f64 - current_freq_ppm);
    LCL_ReadRawTime(&mut raw);
    LCL_CookTime(&mut raw, &mut cooked, 0 as *mut libc::c_double);
    /* Dispatch to all handlers */
    invoke_parameter_change_handlers(&mut raw, &mut cooked, dfreq, 0.0f64, LCL_ChangeAdjust);
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_AccumulateDeltaFrequency(mut dfreq: libc::c_double) {
    let mut raw: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    ...
    /* Call the system-specific driver for setting the frequency */
    current_freq_ppm = Some(drv_set_freq.expect("non-null function pointer"))
        .expect("non-null function pointer")(current_freq_ppm);
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_AccumulateOffset(
    mut offset: libc::c_double,
    ...
    LCL_ReadRawTime(&mut raw);
    LCL_CookTime(&mut raw, &mut cooked, 0 as *mut libc::c_double);
    if check_offset(&mut cooked, offset) == 0 {
        return;
    }
    Some(drv_accrue_offset.expect("non-null function pointer")).expect("non-null function pointer")(
        offset, corr_rate,
    );
    /* Dispatch to all handlers */
    invoke_parameter_change_handlers(&mut raw, &mut cooked, 0.0f64, offset, LCL_ChangeAdjust);
}
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_ApplyStepOffset(mut offset: libc::c_double) -> libc::c_int {
    let mut raw: timespec = timespec {
        tv_sec: 0,
        tv_nsec: 0,
    };
    ...
    LCL_ReadRawTime(&mut raw);
    LCL_CookTime(&mut raw, &mut cooked, 0 as *mut libc::c_double);
    if check_offset(&mut raw, offset) == 0 {
        return 0 as libc::c_int;
    }
    if Some(drv_apply_step_offset.expect("non-null function pointer"))
        .expect("non-null function pointer")(offset)
        == 0
    {
        LOG_Message(
            LOGS_ERR,
            b"Could not step system clock\x00" as *const u8 as *const libc::c_char,
        );
        return 0 as libc::c_int;
    }
    ...
    /* Dispatch to all handlers */
    invoke_parameter_change_handlers(&mut raw, &mut cooked, 0.0f64, offset, LCL_ChangeStep);
    return 1 as libc::c_int;
}
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_NotifyExternalTimeStep(
    mut raw: *mut timespec,
    mut cooked: *mut timespec,
    mut offset: libc::c_double,
    ...
    /* Dispatch to all handlers */
    invoke_parameter_change_handlers(raw, cooked, 0.0f64, offset, LCL_ChangeUnknownStep);
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_AccumulateFrequencyAndOffset(
    mut dfreq: libc::c_double,
    mut doffset: libc::c_double,
    mut corr_rate: libc::c_double,
) {
    ...
    LCL_CookTime(&mut raw, &mut cooked, 0 as *mut libc::c_double);
    if check_offset(&mut cooked, doffset) == 0 {
        return;
    }
    old_freq_ppm = current_freq_ppm;
    /* Work out new absolute frequency.  Note that absolute frequencies
    ...
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"old_freq=%.3fppm new_freq=%.3fppm offset=%.6fsec\x00" as *const u8
    ...
    /* Dispatch to all handlers */
    invoke_parameter_change_handlers(&mut raw, &mut cooked, dfreq, doffset, LCL_ChangeAdjust);
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn lcl_InvokeDispersionNotifyHandlers(mut dispersion: libc::c_double) {
    let mut ptr: *mut DispersionNotifyListEntry = 0 as *mut DispersionNotifyListEntry;
    ptr = dispersion_notify_list.next;
    while ptr != &mut dispersion_notify_list as *mut DispersionNotifyListEntry {
        (*ptr).handler.expect("non-null function pointer")(dispersion, (*ptr).anything);
        ptr = (*ptr).next
    }
}
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn lcl_RegisterSystemDrivers(
    mut read_freq: lcl_ReadFrequencyDriver,
    mut set_freq: lcl_SetFrequencyDriver,
    mut accrue_offset: lcl_AccrueOffsetDriver,
    mut apply_step_offset: lcl_ApplyStepOffsetDriver,
    mut offset_convert: lcl_OffsetCorrectionDriver,
    mut set_leap: lcl_SetLeapDriver,
    mut set_sync_status: lcl_SetSyncStatusDriver,
) {
    ...
    current_freq_ppm = Some(drv_read_freq.expect("non-null function pointer"))
        .expect("non-null function pointer")();
    if 0 as libc::c_int != 0 && log_min_severity as libc::c_int == LOGS_DEBUG as libc::c_int {
        LOG_Message(
            LOGS_DEBUG,
            b"Local freq=%.3fppm\x00" as *const u8 as *const libc::c_char,
            current_freq_ppm,
        );
    };
}
...
pub unsafe extern "C" fn LCL_MakeStep() -> libc::c_int {
    ...
    let mut correction: libc::c_double = 0.;
    LCL_ReadRawTime(&mut raw);
    LCL_GetOffsetCorrection(&mut raw, &mut correction, 0 as *mut libc::c_double);
    if check_offset(&mut raw, -correction) == 0 {
        return 0 as libc::c_int;
    }
    /* Cancel remaining slew and make the step */
    LCL_AccumulateOffset(correction, 0.0f64);
    if LCL_ApplyStepOffset(-correction) == 0 {
        return 0 as libc::c_int;
    }
    LOG_Message(
        LOGS_WARN,
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_SetSystemLeap(mut leap: libc::c_int, mut tai_offset: libc::c_int) {
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_SetTempComp(mut comp: libc::c_double) -> libc::c_double {
    let mut uncomp_freq_ppm: libc::c_double = 0.;
    if temp_comp_ppm == comp {
        return comp;
    }
    /* Undo previous compensation */
    current_freq_ppm = (current_freq_ppm + temp_comp_ppm) / (1.0f64 - 1.0e-6f64 * temp_comp_ppm);
    ...
    current_freq_ppm = Some(drv_set_freq.expect("non-null function pointer"))
        .expect("non-null function pointer")(current_freq_ppm);
    temp_comp_ppm = (uncomp_freq_ppm - current_freq_ppm) / (1.0e-6f64 * uncomp_freq_ppm + 1.0f64);
...
/* ================================================== */
#[no_mangle]
pub unsafe extern "C" fn LCL_SetSyncStatus(
    mut synchronised: libc::c_int,
    mut est_error: libc::c_double,
    mut max_error: libc::c_double,
) {
    if drv_set_sync_status.is_some() {
        drv_set_sync_status.expect("non-null function pointer")(synchronised, est_error, max_error);
    };
}
/* ================================================== */
